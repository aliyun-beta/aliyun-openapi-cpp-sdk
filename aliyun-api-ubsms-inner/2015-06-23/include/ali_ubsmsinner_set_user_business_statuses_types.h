#ifndef ALI_UBSMSINNER_SET_USER_BUSINESS_STATUSES_TYPESH
#define ALI_UBSMSINNER_SET_USER_BUSINESS_STATUSES_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct UbsmsinnerSetUserBusinessStatusesRequestType {
  std::string uid;
...
struct UbsmsinnerSetUserBusinessStatusesResponseType {
  bool success;
};
} // end namespace
#endif
