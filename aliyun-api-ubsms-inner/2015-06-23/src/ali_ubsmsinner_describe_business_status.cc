...
void Json2Type(const Json::Value& value, UbsmsinnerDescribeBusinessStatusStatusType* item);
void Json2Type(const Json::Value& value, UbsmsinnerDescribeBusinessStatusUserBusinessStatusType* item);
void Json2Type(const Json::Value& value, UbsmsinnerDescribeBusinessStatusResponseType* item);
...
void Json2Type(const Json::Value& value, UbsmsinnerDescribeBusinessStatusUserBusinessStatusType* item) {
  ...
  if(value.isMember("Statuses") && value["Statuses"].isMember("Status")) {
    Json2Array<UbsmsinnerDescribeBusinessStatusStatusType>(value["Statuses"]["Status"], &item->statuses);
  }
}
void Json2Type(const Json::Value& value, UbsmsinnerDescribeBusinessStatusResponseType* item) {
  ...
  if(value.isMember("UserBusinessStatusList") && value["UserBusinessStatusList"].isMember("UserBusinessStatus")) {
    Json2Array<UbsmsinnerDescribeBusinessStatusUserBusinessStatusType>(value["UserBusinessStatusList"]["UserBusinessStatus"], &item->user_business_status_list);
  }
}
}

int Ubsmsinner::DescribeBusinessStatus(const UbsmsinnerDescribeBusinessStatusRequestType& req,
                      UbsmsinnerDescribeBusinessStatusResponseType* response,
