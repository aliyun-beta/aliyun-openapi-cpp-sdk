...
void Json2Type(const Json::Value& value, UbsmsinnerNotifyUserBusinessCommandResponseType* item);
...
int Ubsmsinner::NotifyUserBusinessCommand(const UbsmsinnerNotifyUserBusinessCommandRequestType& req,
                      UbsmsinnerNotifyUserBusinessCommandResponseType* response,
