...
void Json2Type(const Json::Value& value, SetUserBusinessStatusesResponseType* item);
...
int Ubsmsinner::SetUserBusinessStatuses(const SetUserBusinessStatusesRequestType& req,
                      SetUserBusinessStatusesResponseType* response,
