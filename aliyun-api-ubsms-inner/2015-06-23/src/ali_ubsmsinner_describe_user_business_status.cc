...
void Json2Type(const Json::Value& value, UbsmsinnerDescribeUserBusinessStatusStatusType* item);
void Json2Type(const Json::Value& value, UbsmsinnerDescribeUserBusinessStatusResponseType* item);
...
void Json2Type(const Json::Value& value, UbsmsinnerDescribeUserBusinessStatusResponseType* item) {
  ...
  if(value.isMember("Statuses") && value["Statuses"].isMember("Status")) {
    Json2Array<UbsmsinnerDescribeUserBusinessStatusStatusType>(value["Statuses"]["Status"], &item->statuses);
  }
}
}

int Ubsmsinner::DescribeUserBusinessStatus(const UbsmsinnerDescribeUserBusinessStatusRequestType& req,
                      UbsmsinnerDescribeUserBusinessStatusResponseType* response,
