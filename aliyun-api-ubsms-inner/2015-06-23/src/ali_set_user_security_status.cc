...
void Json2Type(const Json::Value& value, SetUserSecurityStatusResponseType* item);
...
int Ubsmsinner::SetUserSecurityStatus(const SetUserSecurityStatusRequestType& req,
                      SetUserSecurityStatusResponseType* response,
