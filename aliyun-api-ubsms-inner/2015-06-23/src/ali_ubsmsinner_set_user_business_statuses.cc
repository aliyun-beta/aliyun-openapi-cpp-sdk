...
void Json2Type(const Json::Value& value, UbsmsinnerSetUserBusinessStatusesResponseType* item);
...
int Ubsmsinner::SetUserBusinessStatuses(const UbsmsinnerSetUserBusinessStatusesRequestType& req,
                      UbsmsinnerSetUserBusinessStatusesResponseType* response,
