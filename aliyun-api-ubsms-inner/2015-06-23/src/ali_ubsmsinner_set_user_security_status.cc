...
void Json2Type(const Json::Value& value, UbsmsinnerSetUserSecurityStatusResponseType* item);
...
int Ubsmsinner::SetUserSecurityStatus(const UbsmsinnerSetUserSecurityStatusRequestType& req,
                      UbsmsinnerSetUserSecurityStatusResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","SetUserSecurityStatus");
  if(!req.uid.empty()) {
