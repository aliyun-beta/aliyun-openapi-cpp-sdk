...
void Json2Type(const Json::Value& value, OcsDescribeHistoryMonitorValuesResponseType* item);
...
int Ocs::DescribeHistoryMonitorValues(const OcsDescribeHistoryMonitorValuesRequestType& req,
                      OcsDescribeHistoryMonitorValuesResponseType* response,
