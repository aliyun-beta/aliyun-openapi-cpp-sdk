...
void Json2Type(const Json::Value& value, OcsDescribeMonitorValuesOcsMonitorKeyType* item);
void Json2Type(const Json::Value& value, OcsDescribeMonitorValuesOcsInstanceMonitorType* item);
void Json2Type(const Json::Value& value, OcsDescribeMonitorValuesResponseType* item);
...
void Json2Type(const Json::Value& value, OcsDescribeMonitorValuesOcsInstanceMonitorType* item) {
  ...
  if(value.isMember("MonitorKeys") && value["MonitorKeys"].isMember("OcsMonitorKey")) {
    Json2Array<OcsDescribeMonitorValuesOcsMonitorKeyType>(value["MonitorKeys"]["OcsMonitorKey"], &item->monitor_keys);
  }
}
void Json2Type(const Json::Value& value, OcsDescribeMonitorValuesResponseType* item) {
  ...
  if(value.isMember("InstanceIds") && value["InstanceIds"].isMember("OcsInstanceMonitor")) {
    Json2Array<OcsDescribeMonitorValuesOcsInstanceMonitorType>(value["InstanceIds"]["OcsInstanceMonitor"], &item->instance_ids);
  }
}
}

int Ocs::DescribeMonitorValues(const OcsDescribeMonitorValuesRequestType& req,
                      OcsDescribeMonitorValuesResponseType* response,
