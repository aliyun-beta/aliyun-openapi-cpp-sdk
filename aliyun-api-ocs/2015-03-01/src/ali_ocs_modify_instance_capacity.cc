...
void Json2Type(const Json::Value& value, OcsModifyInstanceCapacityResponseType* item);
...
int Ocs::ModifyInstanceCapacity(const OcsModifyInstanceCapacityRequestType& req,
                      OcsModifyInstanceCapacityResponseType* response,
