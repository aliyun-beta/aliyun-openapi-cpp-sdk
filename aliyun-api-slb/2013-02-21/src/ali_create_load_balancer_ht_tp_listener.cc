...
void Json2Type(const Json::Value& value, CreateLoadBalancerHTTPListenerResponseType* item);
...
int Slb::CreateLoadBalancerHTTPListener(const CreateLoadBalancerHTTPListenerRequestType& req,
                      CreateLoadBalancerHTTPListenerResponseType* response,
