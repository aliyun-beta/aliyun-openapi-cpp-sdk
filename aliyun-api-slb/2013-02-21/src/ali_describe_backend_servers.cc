...
void Json2Type(const Json::Value& value, DescribeBackendServersBackendServerType* item);
void Json2Type(const Json::Value& value, DescribeBackendServersListenerType* item);
void Json2Type(const Json::Value& value, DescribeBackendServersResponseType* item);
...
void Json2Type(const Json::Value& value, DescribeBackendServersListenerType* item) {
  ...
  if(value.isMember("BackendServers") && value["BackendServers"].isMember("BackendServer")) {
    Json2Array<DescribeBackendServersBackendServerType>(value["BackendServers"]["BackendServer"], &item->backend_servers);
  }
}
void Json2Type(const Json::Value& value, DescribeBackendServersResponseType* item) {
  if(value.isMember("Listeners") && value["Listeners"].isMember("Listener")) {
    Json2Array<DescribeBackendServersListenerType>(value["Listeners"]["Listener"], &item->listeners);
  }
}
}

int Slb::DescribeBackendServers(const DescribeBackendServersRequestType& req,
                      DescribeBackendServersResponseType* response,
