...
void Json2Type(const Json::Value& value, SlbDescribeLoadBalancersLoadBalancerType* item);
void Json2Type(const Json::Value& value, SlbDescribeLoadBalancersResponseType* item);
...
void Json2Type(const Json::Value& value, SlbDescribeLoadBalancersResponseType* item) {
  if(value.isMember("LoadBalancers") && value["LoadBalancers"].isMember("LoadBalancer")) {
    Json2Array<SlbDescribeLoadBalancersLoadBalancerType>(value["LoadBalancers"]["LoadBalancer"], &item->load_balancers);
  }
}
}
