...
void Json2Type(const Json::Value& value, SlbCreateLoadBalancerHTTPListenerResponseType* item);
...
int Slb::CreateLoadBalancerHTTPListener(const SlbCreateLoadBalancerHTTPListenerRequestType& req,
                      SlbCreateLoadBalancerHTTPListenerResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","CreateLoadBalancerHTTPListener");
