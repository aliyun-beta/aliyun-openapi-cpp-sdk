...
void Json2Type(const Json::Value& value, DescribeServerCertificatesServerCertificateType* item);
void Json2Type(const Json::Value& value, DescribeServerCertificatesResponseType* item);
...
void Json2Type(const Json::Value& value, DescribeServerCertificatesResponseType* item) {
  if(value.isMember("ServerCertificates") && value["ServerCertificates"].isMember("ServerCertificate")) {
    Json2Array<DescribeServerCertificatesServerCertificateType>(value["ServerCertificates"]["ServerCertificate"], &item->server_certificates);
  }
}
}

int Slb::DescribeServerCertificates(const DescribeServerCertificatesRequestType& req,
                      DescribeServerCertificatesResponseType* response,
