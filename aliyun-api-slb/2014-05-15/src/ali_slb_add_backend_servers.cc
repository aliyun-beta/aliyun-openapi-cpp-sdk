...
void Json2Type(const Json::Value& value, SlbAddBackendServersBackendServerType* item);
void Json2Type(const Json::Value& value, SlbAddBackendServersResponseType* item);
...
void Json2Type(const Json::Value& value, SlbAddBackendServersResponseType* item) {
  ...
  if(value.isMember("BackendServers") && value["BackendServers"].isMember("BackendServer")) {
    Json2Array<SlbAddBackendServersBackendServerType>(value["BackendServers"]["BackendServer"], &item->backend_servers);
  }
}
}
