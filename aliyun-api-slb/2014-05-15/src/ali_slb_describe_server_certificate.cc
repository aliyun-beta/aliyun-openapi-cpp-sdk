...
void Json2Type(const Json::Value& value, SlbDescribeServerCertificateResponseType* item);
...
int Slb::DescribeServerCertificate(const SlbDescribeServerCertificateRequestType& req,
                      SlbDescribeServerCertificateResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","DescribeServerCertificate");
