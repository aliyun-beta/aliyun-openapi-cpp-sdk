...
void Json2Type(const Json::Value& value, SlbDescribeZonesSlaveZoneType* item);
void Json2Type(const Json::Value& value, SlbDescribeZonesZoneType* item);
void Json2Type(const Json::Value& value, SlbDescribeZonesResponseType* item);
...
void Json2Type(const Json::Value& value, SlbDescribeZonesZoneType* item) {
  ...
  if(value.isMember("SlaveZones") && value["SlaveZones"].isMember("SlaveZone")) {
    Json2Array<SlbDescribeZonesSlaveZoneType>(value["SlaveZones"]["SlaveZone"], &item->slave_zones);
  }
}
void Json2Type(const Json::Value& value, SlbDescribeZonesResponseType* item) {
  if(value.isMember("Zones") && value["Zones"].isMember("Zone")) {
    Json2Array<SlbDescribeZonesZoneType>(value["Zones"]["Zone"], &item->zones);
  }
}
}
