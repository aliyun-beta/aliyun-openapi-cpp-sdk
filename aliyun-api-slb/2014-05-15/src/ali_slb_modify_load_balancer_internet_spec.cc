...
void Json2Type(const Json::Value& value, SlbModifyLoadBalancerInternetSpecResponseType* item);
...
int Slb::ModifyLoadBalancerInternetSpec(const SlbModifyLoadBalancerInternetSpecRequestType& req,
                      SlbModifyLoadBalancerInternetSpecResponseType* response,
