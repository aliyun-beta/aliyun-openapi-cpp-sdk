...
void Json2Type(const Json::Value& value, SetLoadBalancerUDPListenerAttributeResponseType* item);
...
int Slb::SetLoadBalancerUDPListenerAttribute(const SetLoadBalancerUDPListenerAttributeRequestType& req,
                      SetLoadBalancerUDPListenerAttributeResponseType* response,
