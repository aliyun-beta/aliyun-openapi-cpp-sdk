...
void Json2Type(const Json::Value& value, AddBackendServersBackendServerType* item);
void Json2Type(const Json::Value& value, AddBackendServersResponseType* item);
...
void Json2Type(const Json::Value& value, AddBackendServersResponseType* item) {
  ...
  if(value.isMember("BackendServers") && value["BackendServers"].isMember("BackendServer")) {
    Json2Array<AddBackendServersBackendServerType>(value["BackendServers"]["BackendServer"], &item->backend_servers);
  }
}
}

int Slb::AddBackendServers(const AddBackendServersRequestType& req,
                      AddBackendServersResponseType* response,
