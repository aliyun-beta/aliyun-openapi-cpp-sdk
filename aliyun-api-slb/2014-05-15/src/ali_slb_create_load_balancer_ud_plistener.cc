...
void Json2Type(const Json::Value& value, SlbCreateLoadBalancerUDPListenerResponseType* item);
...
int Slb::CreateLoadBalancerUDPListener(const SlbCreateLoadBalancerUDPListenerRequestType& req,
                      SlbCreateLoadBalancerUDPListenerResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","CreateLoadBalancerUDPListener");
