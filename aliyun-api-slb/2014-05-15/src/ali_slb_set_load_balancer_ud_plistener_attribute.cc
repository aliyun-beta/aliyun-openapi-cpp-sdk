...
void Json2Type(const Json::Value& value, SlbSetLoadBalancerUDPListenerAttributeResponseType* item);
...
int Slb::SetLoadBalancerUDPListenerAttribute(const SlbSetLoadBalancerUDPListenerAttributeRequestType& req,
                      SlbSetLoadBalancerUDPListenerAttributeResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","SetLoadBalancerUDPListenerAttribute");
