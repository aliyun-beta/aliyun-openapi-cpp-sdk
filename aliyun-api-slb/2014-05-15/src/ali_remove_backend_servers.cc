...
void Json2Type(const Json::Value& value, RemoveBackendServersBackendServerType* item);
void Json2Type(const Json::Value& value, RemoveBackendServersResponseType* item);
...
void Json2Type(const Json::Value& value, RemoveBackendServersResponseType* item) {
  ...
  if(value.isMember("BackendServers") && value["BackendServers"].isMember("BackendServer")) {
    Json2Array<RemoveBackendServersBackendServerType>(value["BackendServers"]["BackendServer"], &item->backend_servers);
  }
}
}

int Slb::RemoveBackendServers(const RemoveBackendServersRequestType& req,
                      RemoveBackendServersResponseType* response,
