...
void Json2Type(const Json::Value& value, SetBackendServersBackendServerType* item);
void Json2Type(const Json::Value& value, SetBackendServersResponseType* item);
...
void Json2Type(const Json::Value& value, SetBackendServersResponseType* item) {
  ...
  if(value.isMember("BackendServers") && value["BackendServers"].isMember("BackendServer")) {
    Json2Array<SetBackendServersBackendServerType>(value["BackendServers"]["BackendServer"], &item->backend_servers);
  }
}
}

int Slb::SetBackendServers(const SetBackendServersRequestType& req,
                      SetBackendServersResponseType* response,
