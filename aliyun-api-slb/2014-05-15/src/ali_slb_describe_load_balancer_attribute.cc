...
void Json2Type(const Json::Value& value, SlbDescribeLoadBalancerAttributeListenerPortAndProtocalType* item);
void Json2Type(const Json::Value& value, SlbDescribeLoadBalancerAttributeListenerPortAndProtocolType* item);
void Json2Type(const Json::Value& value, SlbDescribeLoadBalancerAttributeBackendServerType* item);
void Json2Type(const Json::Value& value, SlbDescribeLoadBalancerAttributeResponseType* item);
...
void Json2Type(const Json::Value& value, SlbDescribeLoadBalancerAttributeResponseType* item) {
  ...
  if(value.isMember("ListenerPortsAndProtocal") && value["ListenerPortsAndProtocal"].isMember("ListenerPortAndProtocal")) {
    Json2Array<SlbDescribeLoadBalancerAttributeListenerPortAndProtocalType>(value["ListenerPortsAndProtocal"]["ListenerPortAndProtocal"], &item->listener_ports_and_protocal);
  }
  if(value.isMember("ListenerPortsAndProtocol") && value["ListenerPortsAndProtocol"].isMember("ListenerPortAndProtocol")) {
    Json2Array<SlbDescribeLoadBalancerAttributeListenerPortAndProtocolType>(value["ListenerPortsAndProtocol"]["ListenerPortAndProtocol"], &item->listener_ports_and_protocol);
  }
  if(value.isMember("BackendServers") && value["BackendServers"].isMember("BackendServer")) {
    Json2Array<SlbDescribeLoadBalancerAttributeBackendServerType>(value["BackendServers"]["BackendServer"], &item->backend_servers);
  }
