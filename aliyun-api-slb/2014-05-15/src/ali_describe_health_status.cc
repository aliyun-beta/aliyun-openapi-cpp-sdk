...
void Json2Type(const Json::Value& value, DescribeHealthStatusBackendServerType* item);
void Json2Type(const Json::Value& value, DescribeHealthStatusResponseType* item);
...
void Json2Type(const Json::Value& value, DescribeHealthStatusResponseType* item) {
  if(value.isMember("BackendServers") && value["BackendServers"].isMember("BackendServer")) {
    Json2Array<DescribeHealthStatusBackendServerType>(value["BackendServers"]["BackendServer"], &item->backend_servers);
  }
}
}

int Slb::DescribeHealthStatus(const DescribeHealthStatusRequestType& req,
                      DescribeHealthStatusResponseType* response,
