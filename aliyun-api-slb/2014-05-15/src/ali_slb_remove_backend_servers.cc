...
void Json2Type(const Json::Value& value, SlbRemoveBackendServersBackendServerType* item);
void Json2Type(const Json::Value& value, SlbRemoveBackendServersResponseType* item);
...
void Json2Type(const Json::Value& value, SlbRemoveBackendServersResponseType* item) {
  ...
  if(value.isMember("BackendServers") && value["BackendServers"].isMember("BackendServer")) {
    Json2Array<SlbRemoveBackendServersBackendServerType>(value["BackendServers"]["BackendServer"], &item->backend_servers);
  }
}
}

int Slb::RemoveBackendServers(const SlbRemoveBackendServersRequestType& req,
                      SlbRemoveBackendServersResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","RemoveBackendServers");
