...
void Json2Type(const Json::Value& value, SetLoadBalancerHTTPListenerAttributeResponseType* item);
...
int Slb::SetLoadBalancerHTTPListenerAttribute(const SetLoadBalancerHTTPListenerAttributeRequestType& req,
                      SetLoadBalancerHTTPListenerAttributeResponseType* response,
