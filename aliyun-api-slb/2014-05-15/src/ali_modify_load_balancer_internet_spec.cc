...
void Json2Type(const Json::Value& value, ModifyLoadBalancerInternetSpecResponseType* item);
...
int Slb::ModifyLoadBalancerInternetSpec(const ModifyLoadBalancerInternetSpecRequestType& req,
                      ModifyLoadBalancerInternetSpecResponseType* response,
