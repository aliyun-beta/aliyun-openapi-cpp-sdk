...
void Json2Type(const Json::Value& value, SetLoadBalancerTCPListenerAttributeResponseType* item);
...
int Slb::SetLoadBalancerTCPListenerAttribute(const SetLoadBalancerTCPListenerAttributeRequestType& req,
                      SetLoadBalancerTCPListenerAttributeResponseType* response,
