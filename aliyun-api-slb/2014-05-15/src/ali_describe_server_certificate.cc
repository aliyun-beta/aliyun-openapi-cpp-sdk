...
void Json2Type(const Json::Value& value, DescribeServerCertificateResponseType* item);
...
int Slb::DescribeServerCertificate(const DescribeServerCertificateRequestType& req,
                      DescribeServerCertificateResponseType* response,
