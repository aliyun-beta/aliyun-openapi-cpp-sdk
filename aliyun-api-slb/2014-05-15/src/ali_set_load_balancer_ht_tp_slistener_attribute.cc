...
void Json2Type(const Json::Value& value, SetLoadBalancerHTTPSListenerAttributeResponseType* item);
...
int Slb::SetLoadBalancerHTTPSListenerAttribute(const SetLoadBalancerHTTPSListenerAttributeRequestType& req,
                      SetLoadBalancerHTTPSListenerAttributeResponseType* response,
