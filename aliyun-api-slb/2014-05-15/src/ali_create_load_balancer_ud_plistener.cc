...
void Json2Type(const Json::Value& value, CreateLoadBalancerUDPListenerResponseType* item);
...
int Slb::CreateLoadBalancerUDPListener(const CreateLoadBalancerUDPListenerRequestType& req,
                      CreateLoadBalancerUDPListenerResponseType* response,
