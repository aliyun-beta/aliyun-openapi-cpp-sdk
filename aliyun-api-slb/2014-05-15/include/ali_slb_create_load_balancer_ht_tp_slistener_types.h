#ifndef ALI_SLB_CREATE_LOAD_BALANCER_HT_TP_SLISTENER_TYPESH
#define ALI_SLB_CREATE_LOAD_BALANCER_HT_TP_SLISTENER_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct SlbCreateLoadBalancerHTTPSListenerRequestType {
  std::string owner_id;
...
struct SlbCreateLoadBalancerHTTPSListenerResponseType {
};
} // end namespace
#endif
