#ifndef ALI_DESCRIBE_LOAD_BALANCER_HT_TP_SLISTENER_ATTRIBUTE_TYPESH
#define ALI_DESCRIBE_LOAD_BALANCER_HT_TP_SLISTENER_ATTRIBUTE_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct DescribeLoadBalancerHTTPSListenerAttributeRequestType {
  std::string owner_id;
...
struct DescribeLoadBalancerHTTPSListenerAttributeResponseType {
  int listener_port;
