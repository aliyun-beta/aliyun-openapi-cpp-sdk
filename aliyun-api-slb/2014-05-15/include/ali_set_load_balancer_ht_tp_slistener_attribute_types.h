#ifndef ALI_SET_LOAD_BALANCER_HT_TP_SLISTENER_ATTRIBUTE_TYPESH
#define ALI_SET_LOAD_BALANCER_HT_TP_SLISTENER_ATTRIBUTE_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct SetLoadBalancerHTTPSListenerAttributeRequestType {
  std::string owner_id;
...
struct SetLoadBalancerHTTPSListenerAttributeResponseType {
};
} // end namespace
#endif
