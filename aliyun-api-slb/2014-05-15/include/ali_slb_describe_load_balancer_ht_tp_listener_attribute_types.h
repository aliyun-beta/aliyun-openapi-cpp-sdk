#ifndef ALI_SLB_DESCRIBE_LOAD_BALANCER_HT_TP_LISTENER_ATTRIBUTE_TYPESH
#define ALI_SLB_DESCRIBE_LOAD_BALANCER_HT_TP_LISTENER_ATTRIBUTE_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct SlbDescribeLoadBalancerHTTPListenerAttributeRequestType {
  std::string owner_id;
...
struct SlbDescribeLoadBalancerHTTPListenerAttributeResponseType {
  int listener_port;
