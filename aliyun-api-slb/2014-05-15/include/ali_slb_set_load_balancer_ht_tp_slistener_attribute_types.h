#ifndef ALI_SLB_SET_LOAD_BALANCER_HT_TP_SLISTENER_ATTRIBUTE_TYPESH
#define ALI_SLB_SET_LOAD_BALANCER_HT_TP_SLISTENER_ATTRIBUTE_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct SlbSetLoadBalancerHTTPSListenerAttributeRequestType {
  std::string owner_id;
...
struct SlbSetLoadBalancerHTTPSListenerAttributeResponseType {
};
} // end namespace
#endif
