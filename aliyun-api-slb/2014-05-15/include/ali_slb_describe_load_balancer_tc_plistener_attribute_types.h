#ifndef ALI_SLB_DESCRIBE_LOAD_BALANCER_TC_PLISTENER_ATTRIBUTE_TYPESH
#define ALI_SLB_DESCRIBE_LOAD_BALANCER_TC_PLISTENER_ATTRIBUTE_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct SlbDescribeLoadBalancerTCPListenerAttributeRequestType {
  std::string owner_id;
...
struct SlbDescribeLoadBalancerTCPListenerAttributeResponseType {
  int listener_port;
