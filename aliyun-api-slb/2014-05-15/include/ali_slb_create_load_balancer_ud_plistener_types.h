#ifndef ALI_SLB_CREATE_LOAD_BALANCER_UD_PLISTENER_TYPESH
#define ALI_SLB_CREATE_LOAD_BALANCER_UD_PLISTENER_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct SlbCreateLoadBalancerUDPListenerRequestType {
  std::string owner_id;
...
struct SlbCreateLoadBalancerUDPListenerResponseType {
};
} // end namespace
#endif
