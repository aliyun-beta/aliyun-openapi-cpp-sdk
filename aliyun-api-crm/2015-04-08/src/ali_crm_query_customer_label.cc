...
void Json2Type(const Json::Value& value, CrmQueryCustomerLabelCustomerLabelType* item);
...
int Crm::QueryCustomerLabel(const CrmQueryCustomerLabelRequestType& req,
                      CrmQueryCustomerLabelResponseType* response,
