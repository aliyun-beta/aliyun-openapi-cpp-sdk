#ifndef ALI_RDSREGION_DESCRIBE_BACKUPS_TYPESH
#define ALI_RDSREGION_DESCRIBE_BACKUPS_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct RdsRegionDescribeBackupsRequestType {
  std::string owner_id;
...
struct RdsRegionDescribeBackupsBackupType {
  std::string backup_id;
  std::string db_instance_id;
  std::string backup_status;
...
struct RdsRegionDescribeBackupsResponseType {
  std::vector<RdsRegionDescribeBackupsBackupType> items;
