#ifndef ALI_PRE_CHECK_BEFORE_IMPORT_DATA_TYPESH
#define ALI_PRE_CHECK_BEFORE_IMPORT_DATA_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct PreCheckBeforeImportDataRequestType {
  std::string owner_id;
...
struct PreCheckBeforeImportDataResponseType {
