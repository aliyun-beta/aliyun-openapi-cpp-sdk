...
void Json2Type(const Json::Value& value, CreatePostpaidDBInstanceResponseType* item);
...
int RdsRegion::CreatePostpaidDBInstance(const CreatePostpaidDBInstanceRequestType& req,
                      CreatePostpaidDBInstanceResponseType* response,
