...
void Json2Type(const Json::Value& value, DescribeOptimizeAdviceOnExcessIndexAdviceOnExcessIndexType* item);
void Json2Type(const Json::Value& value, DescribeOptimizeAdviceOnExcessIndexResponseType* item);
...
void Json2Type(const Json::Value& value, DescribeOptimizeAdviceOnExcessIndexResponseType* item) {
  ...
  if(value.isMember("Items") && value["Items"].isMember("AdviceOnExcessIndex")) {
    Json2Array<DescribeOptimizeAdviceOnExcessIndexAdviceOnExcessIndexType>(value["Items"]["AdviceOnExcessIndex"], &item->items);
  }
}
}

int RdsRegion::DescribeOptimizeAdviceOnExcessIndex(const DescribeOptimizeAdviceOnExcessIndexRequestType& req,
                      DescribeOptimizeAdviceOnExcessIndexResponseType* response,
