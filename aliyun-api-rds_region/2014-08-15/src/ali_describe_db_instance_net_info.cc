...
void Json2Type(const Json::Value& value, DescribeDBInstanceNetInfosecurityIPGroupsType* item);
void Json2Type(const Json::Value& value, DescribeDBInstanceNetInfoDBInstanceNetInfoType* item);
void Json2Type(const Json::Value& value, DescribeDBInstanceNetInfoResponseType* item);
...
void Json2Type(const Json::Value& value, DescribeDBInstanceNetInfoDBInstanceNetInfoType* item) {
  ...
  if(value.isMember("SecurityIPGroups") && value["SecurityIPGroups"].isMember("securityIPGroups")) {
    Json2Array<DescribeDBInstanceNetInfosecurityIPGroupsType>(value["SecurityIPGroups"]["securityIPGroups"], &item->security_ip_groups);
  }
}
void Json2Type(const Json::Value& value, DescribeDBInstanceNetInfoResponseType* item) {
  ...
  if(value.isMember("DBInstanceNetInfos") && value["DBInstanceNetInfos"].isMember("DBInstanceNetInfo")) {
    Json2Array<DescribeDBInstanceNetInfoDBInstanceNetInfoType>(value["DBInstanceNetInfos"]["DBInstanceNetInfo"], &item->db_instance_net_infos);
  }
}
}

int RdsRegion::DescribeDBInstanceNetInfo(const DescribeDBInstanceNetInfoRequestType& req,
                      DescribeDBInstanceNetInfoResponseType* response,
