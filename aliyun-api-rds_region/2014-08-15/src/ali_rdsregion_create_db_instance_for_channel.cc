...
void Json2Type(const Json::Value& value, RdsRegionCreateDBInstanceForChannelResponseType* item);
...
int RdsRegion::CreateDBInstanceForChannel(const RdsRegionCreateDBInstanceForChannelRequestType& req,
                      RdsRegionCreateDBInstanceForChannelResponseType* response,
