...
void Json2Type(const Json::Value& value, DescribeVpcZoneNosVpcZoneIdType* item);
void Json2Type(const Json::Value& value, DescribeVpcZoneNosResponseType* item);
...
void Json2Type(const Json::Value& value, DescribeVpcZoneNosResponseType* item) {
  if(value.isMember("Items") && value["Items"].isMember("VpcZoneId")) {
    Json2Array<DescribeVpcZoneNosVpcZoneIdType>(value["Items"]["VpcZoneId"], &item->items);
  }
}
}

int RdsRegion::DescribeVpcZoneNos(const DescribeVpcZoneNosRequestType& req,
                      DescribeVpcZoneNosResponseType* response,
