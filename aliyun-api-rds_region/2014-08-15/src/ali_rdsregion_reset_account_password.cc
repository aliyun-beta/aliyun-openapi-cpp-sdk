...
void Json2Type(const Json::Value& value, RdsRegionResetAccountPasswordResponseType* item);
...
int RdsRegion::ResetAccountPassword(const RdsRegionResetAccountPasswordRequestType& req,
                      RdsRegionResetAccountPasswordResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","ResetAccountPassword");
