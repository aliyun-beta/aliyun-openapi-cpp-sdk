...
void Json2Type(const Json::Value& value, UpgradeDBInstanceEngineVersionResponseType* item);
...
int RdsRegion::UpgradeDBInstanceEngineVersion(const UpgradeDBInstanceEngineVersionRequestType& req,
                      UpgradeDBInstanceEngineVersionResponseType* response,
