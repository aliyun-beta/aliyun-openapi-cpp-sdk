...
void Json2Type(const Json::Value& value, DescribeModifyParameterLogParameterChangeLogType* item);
void Json2Type(const Json::Value& value, DescribeModifyParameterLogResponseType* item);
...
void Json2Type(const Json::Value& value, DescribeModifyParameterLogResponseType* item) {
  ...
  if(value.isMember("Items") && value["Items"].isMember("ParameterChangeLog")) {
    Json2Array<DescribeModifyParameterLogParameterChangeLogType>(value["Items"]["ParameterChangeLog"], &item->items);
  }
}
}

int RdsRegion::DescribeModifyParameterLog(const DescribeModifyParameterLogRequestType& req,
                      DescribeModifyParameterLogResponseType* response,
