...
void Json2Type(const Json::Value& value, RdsRegionDescribeSlowLogsSQLSlowLogType* item);
void Json2Type(const Json::Value& value, RdsRegionDescribeSlowLogsResponseType* item);
...
void Json2Type(const Json::Value& value, RdsRegionDescribeSlowLogsResponseType* item) {
  ...
  if(value.isMember("Items") && value["Items"].isMember("SQLSlowLog")) {
    Json2Array<RdsRegionDescribeSlowLogsSQLSlowLogType>(value["Items"]["SQLSlowLog"], &item->items);
  }
}
}

int RdsRegion::DescribeSlowLogs(const RdsRegionDescribeSlowLogsRequestType& req,
                      RdsRegionDescribeSlowLogsResponseType* response,
