...
void Json2Type(const Json::Value& value, RdsRegionCreateDBInstanceResponseType* item);
...
int RdsRegion::CreateDBInstance(const RdsRegionCreateDBInstanceRequestType& req,
                      RdsRegionCreateDBInstanceResponseType* response,
