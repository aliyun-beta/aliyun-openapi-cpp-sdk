...
void Json2Type(const Json::Value& value, RdsRegionRemoveTagsFromResourceResponseType* item);
...
int RdsRegion::RemoveTagsFromResource(const RdsRegionRemoveTagsFromResourceRequestType& req,
                      RdsRegionRemoveTagsFromResourceResponseType* response,
