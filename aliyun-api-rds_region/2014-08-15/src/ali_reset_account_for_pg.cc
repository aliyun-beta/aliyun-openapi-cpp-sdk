...
void Json2Type(const Json::Value& value, ResetAccountForPGResponseType* item);
...
int RdsRegion::ResetAccountForPG(const ResetAccountForPGRequestType& req,
                      ResetAccountForPGResponseType* response,
