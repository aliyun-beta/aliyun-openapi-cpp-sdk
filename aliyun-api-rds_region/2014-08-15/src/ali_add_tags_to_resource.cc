...
void Json2Type(const Json::Value& value, AddTagsToResourceResponseType* item);
...
int RdsRegion::AddTagsToResource(const AddTagsToResourceRequestType& req,
                      AddTagsToResourceResponseType* response,
