...
void Json2Type(const Json::Value& value, RdsRegionCreatePostpaidDBInstanceForChannelResponseType* item);
...
int RdsRegion::CreatePostpaidDBInstanceForChannel(const RdsRegionCreatePostpaidDBInstanceForChannelRequestType& req,
                      RdsRegionCreatePostpaidDBInstanceForChannelResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","CreatePostpaidDBInstanceForChannel");
