...
void Json2Type(const Json::Value& value, RdsRegionAddTagsToResourceResponseType* item);
...
int RdsRegion::AddTagsToResource(const RdsRegionAddTagsToResourceRequestType& req,
                      RdsRegionAddTagsToResourceResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","AddTagsToResource");
