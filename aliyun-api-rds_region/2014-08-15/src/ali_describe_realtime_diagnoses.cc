...
void Json2Type(const Json::Value& value, DescribeRealtimeDiagnosesRealtimeDiagnoseTasksType* item);
void Json2Type(const Json::Value& value, DescribeRealtimeDiagnosesResponseType* item);
...
void Json2Type(const Json::Value& value, DescribeRealtimeDiagnosesResponseType* item) {
  ...
  if(value.isMember("Tasks") && value["Tasks"].isMember("RealtimeDiagnoseTasks")) {
    Json2Array<DescribeRealtimeDiagnosesRealtimeDiagnoseTasksType>(value["Tasks"]["RealtimeDiagnoseTasks"], &item->tasks);
  }
}
}

int RdsRegion::DescribeRealtimeDiagnoses(const DescribeRealtimeDiagnosesRequestType& req,
                      DescribeRealtimeDiagnosesResponseType* response,
