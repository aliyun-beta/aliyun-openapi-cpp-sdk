...
void Json2Type(const Json::Value& value, DescribeDBInstancesByPerformanceDBInstancePerformanceType* item);
void Json2Type(const Json::Value& value, DescribeDBInstancesByPerformanceResponseType* item);
...
void Json2Type(const Json::Value& value, DescribeDBInstancesByPerformanceResponseType* item) {
  ...
  if(value.isMember("Items") && value["Items"].isMember("DBInstancePerformance")) {
    Json2Array<DescribeDBInstancesByPerformanceDBInstancePerformanceType>(value["Items"]["DBInstancePerformance"], &item->items);
  }
}
}

int RdsRegion::DescribeDBInstancesByPerformance(const DescribeDBInstancesByPerformanceRequestType& req,
                      DescribeDBInstancesByPerformanceResponseType* response,
