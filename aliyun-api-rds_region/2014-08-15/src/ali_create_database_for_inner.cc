...
void Json2Type(const Json::Value& value, CreateDatabaseForInnerResponseType* item);
...
int RdsRegion::CreateDatabaseForInner(const CreateDatabaseForInnerRequestType& req,
                      CreateDatabaseForInnerResponseType* response,
