...
void Json2Type(const Json::Value& value, DescribeFilesForSQLServerSQLServerUploadFileType* item);
void Json2Type(const Json::Value& value, DescribeFilesForSQLServerResponseType* item);
...
void Json2Type(const Json::Value& value, DescribeFilesForSQLServerResponseType* item) {
  ...
  if(value.isMember("Items") && value["Items"].isMember("SQLServerUploadFile")) {
    Json2Array<DescribeFilesForSQLServerSQLServerUploadFileType>(value["Items"]["SQLServerUploadFile"], &item->items);
  }
}
}

int RdsRegion::DescribeFilesForSQLServer(const DescribeFilesForSQLServerRequestType& req,
                      DescribeFilesForSQLServerResponseType* response,
