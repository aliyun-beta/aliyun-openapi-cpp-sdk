...
void Json2Type(const Json::Value& value, RdsRegionCreateUploadPathForSQLServerResponseType* item);
...
int RdsRegion::CreateUploadPathForSQLServer(const RdsRegionCreateUploadPathForSQLServerRequestType& req,
                      RdsRegionCreateUploadPathForSQLServerResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","CreateUploadPathForSQLServer");
