...
void Json2Type(const Json::Value& value, StartDBInstanceDiagnoseResponseType* item);
...
int RdsRegion::StartDBInstanceDiagnose(const StartDBInstanceDiagnoseRequestType& req,
                      StartDBInstanceDiagnoseResponseType* response,
