...
void Json2Type(const Json::Value& value, RdsRegionReleaseInstancePublicConnectionResponseType* item);
...
int RdsRegion::ReleaseInstancePublicConnection(const RdsRegionReleaseInstancePublicConnectionRequestType& req,
                      RdsRegionReleaseInstancePublicConnectionResponseType* response,
