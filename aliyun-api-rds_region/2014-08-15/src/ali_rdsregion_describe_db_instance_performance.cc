...
void Json2Type(const Json::Value& value, RdsRegionDescribeDBInstancePerformancePerformanceValueType* item);
void Json2Type(const Json::Value& value, RdsRegionDescribeDBInstancePerformancePerformanceKeyType* item);
void Json2Type(const Json::Value& value, RdsRegionDescribeDBInstancePerformanceResponseType* item);
...
void Json2Type(const Json::Value& value, RdsRegionDescribeDBInstancePerformancePerformanceKeyType* item) {
  ...
  if(value.isMember("Values") && value["Values"].isMember("PerformanceValue")) {
    Json2Array<RdsRegionDescribeDBInstancePerformancePerformanceValueType>(value["Values"]["PerformanceValue"], &item->values);
  }
}
void Json2Type(const Json::Value& value, RdsRegionDescribeDBInstancePerformanceResponseType* item) {
  ...
  if(value.isMember("PerformanceKeys") && value["PerformanceKeys"].isMember("PerformanceKey")) {
    Json2Array<RdsRegionDescribeDBInstancePerformancePerformanceKeyType>(value["PerformanceKeys"]["PerformanceKey"], &item->performance_keys);
  }
}
}

int RdsRegion::DescribeDBInstancePerformance(const RdsRegionDescribeDBInstancePerformanceRequestType& req,
                      RdsRegionDescribeDBInstancePerformanceResponseType* response,
