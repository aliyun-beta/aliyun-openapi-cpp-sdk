...
void Json2Type(const Json::Value& value, RdsRegionDescribeOperationLogsOperationlogType* item);
void Json2Type(const Json::Value& value, RdsRegionDescribeOperationLogsResponseType* item);
...
void Json2Type(const Json::Value& value, RdsRegionDescribeOperationLogsResponseType* item) {
  ...
  if(value.isMember("Items") && value["Items"].isMember("Operationlog")) {
    Json2Array<RdsRegionDescribeOperationLogsOperationlogType>(value["Items"]["Operationlog"], &item->items);
  }
}
}

int RdsRegion::DescribeOperationLogs(const RdsRegionDescribeOperationLogsRequestType& req,
                      RdsRegionDescribeOperationLogsResponseType* response,
