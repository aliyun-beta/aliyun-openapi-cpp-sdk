...
void Json2Type(const Json::Value& value, RdsRegionDescribeDBInstanceAttributeReadOnlyDBInstanceIdType* item);
void Json2Type(const Json::Value& value, RdsRegionDescribeDBInstanceAttributeDBInstanceAttributeType* item);
void Json2Type(const Json::Value& value, RdsRegionDescribeDBInstanceAttributeResponseType* item);
...
void Json2Type(const Json::Value& value, RdsRegionDescribeDBInstanceAttributeDBInstanceAttributeType* item) {
  ...
  if(value.isMember("ReadOnlyDBInstanceIds") && value["ReadOnlyDBInstanceIds"].isMember("ReadOnlyDBInstanceId")) {
    Json2Array<RdsRegionDescribeDBInstanceAttributeReadOnlyDBInstanceIdType>(value["ReadOnlyDBInstanceIds"]["ReadOnlyDBInstanceId"], &item->read_only_db_instance_ids);
  }
}
void Json2Type(const Json::Value& value, RdsRegionDescribeDBInstanceAttributeResponseType* item) {
  if(value.isMember("Items") && value["Items"].isMember("DBInstanceAttribute")) {
    Json2Array<RdsRegionDescribeDBInstanceAttributeDBInstanceAttributeType>(value["Items"]["DBInstanceAttribute"], &item->items);
  }
}
}

int RdsRegion::DescribeDBInstanceAttribute(const RdsRegionDescribeDBInstanceAttributeRequestType& req,
                      RdsRegionDescribeDBInstanceAttributeResponseType* response,
