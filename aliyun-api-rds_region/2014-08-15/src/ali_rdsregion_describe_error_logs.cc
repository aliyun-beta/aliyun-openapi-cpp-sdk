...
void Json2Type(const Json::Value& value, RdsRegionDescribeErrorLogsErrorLogType* item);
void Json2Type(const Json::Value& value, RdsRegionDescribeErrorLogsResponseType* item);
...
void Json2Type(const Json::Value& value, RdsRegionDescribeErrorLogsErrorLogType* item) {
  if(value.isMember("ErrorInfo")) {
    item->error_info = value["ErrorInfo"].asString();
  }
...
void Json2Type(const Json::Value& value, RdsRegionDescribeErrorLogsResponseType* item) {
  ...
  if(value.isMember("Items") && value["Items"].isMember("ErrorLog")) {
    Json2Array<RdsRegionDescribeErrorLogsErrorLogType>(value["Items"]["ErrorLog"], &item->items);
  }
}
}

int RdsRegion::DescribeErrorLogs(const RdsRegionDescribeErrorLogsRequestType& req,
                      RdsRegionDescribeErrorLogsResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","DescribeErrorLogs");
