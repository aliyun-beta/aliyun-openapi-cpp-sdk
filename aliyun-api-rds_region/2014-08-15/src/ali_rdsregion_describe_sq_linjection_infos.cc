...
void Json2Type(const Json::Value& value, RdsRegionDescribeSQLInjectionInfosSQLInjectionInfoType* item);
void Json2Type(const Json::Value& value, RdsRegionDescribeSQLInjectionInfosResponseType* item);
...
void Json2Type(const Json::Value& value, RdsRegionDescribeSQLInjectionInfosResponseType* item) {
  ...
  if(value.isMember("Items") && value["Items"].isMember("SQLInjectionInfo")) {
    Json2Array<RdsRegionDescribeSQLInjectionInfosSQLInjectionInfoType>(value["Items"]["SQLInjectionInfo"], &item->items);
  }
}
}

int RdsRegion::DescribeSQLInjectionInfos(const RdsRegionDescribeSQLInjectionInfosRequestType& req,
                      RdsRegionDescribeSQLInjectionInfosResponseType* response,
