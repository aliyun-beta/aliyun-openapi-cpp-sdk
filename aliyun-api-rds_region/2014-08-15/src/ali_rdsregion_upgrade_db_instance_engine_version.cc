...
void Json2Type(const Json::Value& value, RdsRegionUpgradeDBInstanceEngineVersionResponseType* item);
...
int RdsRegion::UpgradeDBInstanceEngineVersion(const RdsRegionUpgradeDBInstanceEngineVersionRequestType& req,
                      RdsRegionUpgradeDBInstanceEngineVersionResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","UpgradeDBInstanceEngineVersion");
