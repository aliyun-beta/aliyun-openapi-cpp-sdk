...
void Json2Type(const Json::Value& value, DeleteDatabaseResponseType* item);
...
int RdsRegion::DeleteDatabase(const DeleteDatabaseRequestType& req,
                      DeleteDatabaseResponseType* response,
