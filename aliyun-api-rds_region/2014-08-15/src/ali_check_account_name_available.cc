...
void Json2Type(const Json::Value& value, CheckAccountNameAvailableResponseType* item);
...
int RdsRegion::CheckAccountNameAvailable(const CheckAccountNameAvailableRequestType& req,
                      CheckAccountNameAvailableResponseType* response,
