...
void Json2Type(const Json::Value& value, DescribeErrorLogsErrorLogType* item);
void Json2Type(const Json::Value& value, DescribeErrorLogsResponseType* item);
...
void Json2Type(const Json::Value& value, DescribeErrorLogsResponseType* item) {
  ...
  if(value.isMember("Items") && value["Items"].isMember("ErrorLog")) {
    Json2Array<DescribeErrorLogsErrorLogType>(value["Items"]["ErrorLog"], &item->items);
  }
}
}

int RdsRegion::DescribeErrorLogs(const DescribeErrorLogsRequestType& req,
                      DescribeErrorLogsResponseType* response,
