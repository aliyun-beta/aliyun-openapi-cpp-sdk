...
void Json2Type(const Json::Value& value, ModifyDBInstanceNetworkTypeResponseType* item);
...
int RdsRegion::ModifyDBInstanceNetworkType(const ModifyDBInstanceNetworkTypeRequestType& req,
                      ModifyDBInstanceNetworkTypeResponseType* response,
