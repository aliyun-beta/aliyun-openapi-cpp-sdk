...
void Json2Type(const Json::Value& value, RestartDBInstanceResponseType* item);
...
int RdsRegion::RestartDBInstance(const RestartDBInstanceRequestType& req,
                      RestartDBInstanceResponseType* response,
