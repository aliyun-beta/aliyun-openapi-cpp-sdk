...
void Json2Type(const Json::Value& value, RdsRegionDescribeOptimizeAdviceOnExcessIndexAdviceOnExcessIndexType* item);
void Json2Type(const Json::Value& value, RdsRegionDescribeOptimizeAdviceOnExcessIndexResponseType* item);
...
void Json2Type(const Json::Value& value, RdsRegionDescribeOptimizeAdviceOnExcessIndexResponseType* item) {
  ...
  if(value.isMember("Items") && value["Items"].isMember("AdviceOnExcessIndex")) {
    Json2Array<RdsRegionDescribeOptimizeAdviceOnExcessIndexAdviceOnExcessIndexType>(value["Items"]["AdviceOnExcessIndex"], &item->items);
  }
}
}

int RdsRegion::DescribeOptimizeAdviceOnExcessIndex(const RdsRegionDescribeOptimizeAdviceOnExcessIndexRequestType& req,
                      RdsRegionDescribeOptimizeAdviceOnExcessIndexResponseType* response,
