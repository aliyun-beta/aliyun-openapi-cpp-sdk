...
void Json2Type(const Json::Value& value, RdsRegionCreateDatabaseForInnerResponseType* item);
...
int RdsRegion::CreateDatabaseForInner(const RdsRegionCreateDatabaseForInnerRequestType& req,
                      RdsRegionCreateDatabaseForInnerResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","CreateDatabaseForInner");
  ...
  if(!req.db_description.empty()) {
    req_rpc->AddRequestQuery("DBDescription", req.db_description);
  }
