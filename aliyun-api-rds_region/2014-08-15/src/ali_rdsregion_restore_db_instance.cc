...
void Json2Type(const Json::Value& value, RdsRegionRestoreDBInstanceResponseType* item);
...
int RdsRegion::RestoreDBInstance(const RdsRegionRestoreDBInstanceRequestType& req,
                      RdsRegionRestoreDBInstanceResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","RestoreDBInstance");
