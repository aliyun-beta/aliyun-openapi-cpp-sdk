...
void Json2Type(const Json::Value& value, CheckDBNameAvailableResponseType* item);
...
int RdsRegion::CheckDBNameAvailable(const CheckDBNameAvailableRequestType& req,
                      CheckDBNameAvailableResponseType* response,
