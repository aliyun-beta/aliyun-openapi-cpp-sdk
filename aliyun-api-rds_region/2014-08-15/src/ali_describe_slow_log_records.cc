...
void Json2Type(const Json::Value& value, DescribeSlowLogRecordsSQLSlowRecordType* item);
void Json2Type(const Json::Value& value, DescribeSlowLogRecordsResponseType* item);
...
void Json2Type(const Json::Value& value, DescribeSlowLogRecordsResponseType* item) {
  ...
  if(value.isMember("Items") && value["Items"].isMember("SQLSlowRecord")) {
    Json2Array<DescribeSlowLogRecordsSQLSlowRecordType>(value["Items"]["SQLSlowRecord"], &item->items);
  }
}
}

int RdsRegion::DescribeSlowLogRecords(const DescribeSlowLogRecordsRequestType& req,
                      DescribeSlowLogRecordsResponseType* response,
