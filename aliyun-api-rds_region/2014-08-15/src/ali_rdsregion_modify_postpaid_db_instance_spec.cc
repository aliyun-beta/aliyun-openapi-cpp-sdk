...
void Json2Type(const Json::Value& value, RdsRegionModifyPostpaidDBInstanceSpecResponseType* item);
...
int RdsRegion::ModifyPostpaidDBInstanceSpec(const RdsRegionModifyPostpaidDBInstanceSpecRequestType& req,
                      RdsRegionModifyPostpaidDBInstanceSpecResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","ModifyPostpaidDBInstanceSpec");
