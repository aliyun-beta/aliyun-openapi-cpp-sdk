...
void Json2Type(const Json::Value& value, RdsRegionModifyDBInstanceSpecResponseType* item);
...
int RdsRegion::ModifyDBInstanceSpec(const RdsRegionModifyDBInstanceSpecRequestType& req,
                      RdsRegionModifyDBInstanceSpecResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","ModifyDBInstanceSpec");
