...
void Json2Type(const Json::Value& value, CreateDBInstanceforFirstPayResponseType* item);
...
int RdsRegion::CreateDBInstanceforFirstPay(const CreateDBInstanceforFirstPayRequestType& req,
                      CreateDBInstanceforFirstPayResponseType* response,
