...
void Json2Type(const Json::Value& value, DescribeBackupsBackupType* item);
void Json2Type(const Json::Value& value, DescribeBackupsResponseType* item);
...
void Json2Type(const Json::Value& value, DescribeBackupsResponseType* item) {
  ...
  if(value.isMember("Items") && value["Items"].isMember("Backup")) {
    Json2Array<DescribeBackupsBackupType>(value["Items"]["Backup"], &item->items);
  }
}
}

int RdsRegion::DescribeBackups(const DescribeBackupsRequestType& req,
                      DescribeBackupsResponseType* response,
