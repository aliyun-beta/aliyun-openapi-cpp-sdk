...
void Json2Type(const Json::Value& value, ModifyDBInstanceDescriptionResponseType* item);
...
int RdsRegion::ModifyDBInstanceDescription(const ModifyDBInstanceDescriptionRequestType& req,
                      ModifyDBInstanceDescriptionResponseType* response,
