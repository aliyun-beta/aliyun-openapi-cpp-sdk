...
void Json2Type(const Json::Value& value, RdsRegionDescribeSQLLogReportsSQLReportType* item);
void Json2Type(const Json::Value& value, RdsRegionDescribeSQLLogReportsResponseType* item);
...
void Json2Type(const Json::Value& value, RdsRegionDescribeSQLLogReportsResponseType* item) {
  ...
  if(value.isMember("Items") && value["Items"].isMember("SQLReport")) {
    Json2Array<RdsRegionDescribeSQLLogReportsSQLReportType>(value["Items"]["SQLReport"], &item->items);
  }
}
}

int RdsRegion::DescribeSQLLogReports(const RdsRegionDescribeSQLLogReportsRequestType& req,
                      RdsRegionDescribeSQLLogReportsResponseType* response,
