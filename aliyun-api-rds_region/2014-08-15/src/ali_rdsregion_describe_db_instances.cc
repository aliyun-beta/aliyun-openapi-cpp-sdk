...
void Json2Type(const Json::Value& value, RdsRegionDescribeDBInstancesReadOnlyDBInstanceIdType* item);
void Json2Type(const Json::Value& value, RdsRegionDescribeDBInstancesDBInstanceType* item);
void Json2Type(const Json::Value& value, RdsRegionDescribeDBInstancesResponseType* item);
...
void Json2Type(const Json::Value& value, RdsRegionDescribeDBInstancesDBInstanceType* item) {
  ...
  if(value.isMember("ReadOnlyDBInstanceIds") && value["ReadOnlyDBInstanceIds"].isMember("ReadOnlyDBInstanceId")) {
    Json2Array<RdsRegionDescribeDBInstancesReadOnlyDBInstanceIdType>(value["ReadOnlyDBInstanceIds"]["ReadOnlyDBInstanceId"], &item->read_only_db_instance_ids);
  }
}
void Json2Type(const Json::Value& value, RdsRegionDescribeDBInstancesResponseType* item) {
  ...
  if(value.isMember("Items") && value["Items"].isMember("DBInstance")) {
    Json2Array<RdsRegionDescribeDBInstancesDBInstanceType>(value["Items"]["DBInstance"], &item->items);
  }
}
}

int RdsRegion::DescribeDBInstances(const RdsRegionDescribeDBInstancesRequestType& req,
                      RdsRegionDescribeDBInstancesResponseType* response,
