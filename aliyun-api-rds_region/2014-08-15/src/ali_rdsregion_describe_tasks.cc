...
void Json2Type(const Json::Value& value, RdsRegionDescribeTasksTaskProgressInfoType* item);
void Json2Type(const Json::Value& value, RdsRegionDescribeTasksResponseType* item);
...
void Json2Type(const Json::Value& value, RdsRegionDescribeTasksResponseType* item) {
  ...
  if(value.isMember("Items") && value["Items"].isMember("TaskProgressInfo")) {
    Json2Array<RdsRegionDescribeTasksTaskProgressInfoType>(value["Items"]["TaskProgressInfo"], &item->items);
  }
}
}

int RdsRegion::DescribeTasks(const RdsRegionDescribeTasksRequestType& req,
                      RdsRegionDescribeTasksResponseType* response,
