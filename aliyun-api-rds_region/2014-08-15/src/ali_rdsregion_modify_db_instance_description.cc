...
void Json2Type(const Json::Value& value, RdsRegionModifyDBInstanceDescriptionResponseType* item);
...
int RdsRegion::ModifyDBInstanceDescription(const RdsRegionModifyDBInstanceDescriptionRequestType& req,
                      RdsRegionModifyDBInstanceDescriptionResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","ModifyDBInstanceDescription");
