...
void Json2Type(const Json::Value& value, ModifyDBInstanceSpecResponseType* item);
...
int RdsRegion::ModifyDBInstanceSpec(const ModifyDBInstanceSpecRequestType& req,
                      ModifyDBInstanceSpecResponseType* response,
