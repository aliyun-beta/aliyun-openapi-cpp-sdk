...
void Json2Type(const Json::Value& value, ReleaseInstancePublicConnectionResponseType* item);
...
int RdsRegion::ReleaseInstancePublicConnection(const ReleaseInstancePublicConnectionRequestType& req,
                      ReleaseInstancePublicConnectionResponseType* response,
