...
void Json2Type(const Json::Value& value, CreatePostpaidDBInstanceForChannelResponseType* item);
...
int RdsRegion::CreatePostpaidDBInstanceForChannel(const CreatePostpaidDBInstanceForChannelRequestType& req,
                      CreatePostpaidDBInstanceForChannelResponseType* response,
