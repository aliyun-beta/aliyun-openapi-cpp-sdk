...
void Json2Type(const Json::Value& value, CreateDBInstanceResponseType* item);
...
int RdsRegion::CreateDBInstance(const CreateDBInstanceRequestType& req,
                      CreateDBInstanceResponseType* response,
