...
void Json2Type(const Json::Value& value, RdsRegionResetAccountForPGResponseType* item);
...
int RdsRegion::ResetAccountForPG(const RdsRegionResetAccountForPGRequestType& req,
                      RdsRegionResetAccountForPGResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","ResetAccountForPG");
