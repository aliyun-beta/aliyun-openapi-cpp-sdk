...
void Json2Type(const Json::Value& value, DescribeOperationLogsOperationlogType* item);
void Json2Type(const Json::Value& value, DescribeOperationLogsResponseType* item);
...
void Json2Type(const Json::Value& value, DescribeOperationLogsResponseType* item) {
  ...
  if(value.isMember("Items") && value["Items"].isMember("Operationlog")) {
    Json2Array<DescribeOperationLogsOperationlogType>(value["Items"]["Operationlog"], &item->items);
  }
}
}

int RdsRegion::DescribeOperationLogs(const DescribeOperationLogsRequestType& req,
                      DescribeOperationLogsResponseType* response,
