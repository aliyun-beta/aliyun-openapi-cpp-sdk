...
void Json2Type(const Json::Value& value, RdsRegionCheckDBNameAvailableResponseType* item);
...
int RdsRegion::CheckDBNameAvailable(const RdsRegionCheckDBNameAvailableRequestType& req,
                      RdsRegionCheckDBNameAvailableResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","CheckDBNameAvailable");
