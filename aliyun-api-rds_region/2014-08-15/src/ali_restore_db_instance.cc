...
void Json2Type(const Json::Value& value, RestoreDBInstanceResponseType* item);
...
int RdsRegion::RestoreDBInstance(const RestoreDBInstanceRequestType& req,
                      RestoreDBInstanceResponseType* response,
