...
void Json2Type(const Json::Value& value, ResetAccountPasswordResponseType* item);
...
int RdsRegion::ResetAccountPassword(const ResetAccountPasswordRequestType& req,
                      ResetAccountPasswordResponseType* response,
