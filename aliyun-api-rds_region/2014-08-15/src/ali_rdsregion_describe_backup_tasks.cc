...
void Json2Type(const Json::Value& value, RdsRegionDescribeBackupTasksBackupJobType* item);
void Json2Type(const Json::Value& value, RdsRegionDescribeBackupTasksResponseType* item);
...
void Json2Type(const Json::Value& value, RdsRegionDescribeBackupTasksResponseType* item) {
  if(value.isMember("Items") && value["Items"].isMember("BackupJob")) {
    Json2Array<RdsRegionDescribeBackupTasksBackupJobType>(value["Items"]["BackupJob"], &item->items);
  }
}
}

int RdsRegion::DescribeBackupTasks(const RdsRegionDescribeBackupTasksRequestType& req,
                      RdsRegionDescribeBackupTasksResponseType* response,
