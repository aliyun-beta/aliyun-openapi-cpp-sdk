...
void Json2Type(const Json::Value& value, DescribeAbnormalDBInstancesAbnormalItemType* item);
void Json2Type(const Json::Value& value, DescribeAbnormalDBInstancesInstanceResultType* item);
void Json2Type(const Json::Value& value, DescribeAbnormalDBInstancesResponseType* item);
...
void Json2Type(const Json::Value& value, DescribeAbnormalDBInstancesInstanceResultType* item) {
  ...
  if(value.isMember("AbnormalItems") && value["AbnormalItems"].isMember("AbnormalItem")) {
    Json2Array<DescribeAbnormalDBInstancesAbnormalItemType>(value["AbnormalItems"]["AbnormalItem"], &item->abnormal_items);
  }
}
void Json2Type(const Json::Value& value, DescribeAbnormalDBInstancesResponseType* item) {
  ...
  if(value.isMember("Items") && value["Items"].isMember("InstanceResult")) {
    Json2Array<DescribeAbnormalDBInstancesInstanceResultType>(value["Items"]["InstanceResult"], &item->items);
  }
}
}

int RdsRegion::DescribeAbnormalDBInstances(const DescribeAbnormalDBInstancesRequestType& req,
                      DescribeAbnormalDBInstancesResponseType* response,
