...
void Json2Type(const Json::Value& value, RdsRegionDescribeSQLLogRecordsSQLRecordType* item);
void Json2Type(const Json::Value& value, RdsRegionDescribeSQLLogRecordsResponseType* item);
...
void Json2Type(const Json::Value& value, RdsRegionDescribeSQLLogRecordsResponseType* item) {
  ...
  if(value.isMember("Items") && value["Items"].isMember("SQLRecord")) {
    Json2Array<RdsRegionDescribeSQLLogRecordsSQLRecordType>(value["Items"]["SQLRecord"], &item->items);
  }
}
}

int RdsRegion::DescribeSQLLogRecords(const RdsRegionDescribeSQLLogRecordsRequestType& req,
                      RdsRegionDescribeSQLLogRecordsResponseType* response,
