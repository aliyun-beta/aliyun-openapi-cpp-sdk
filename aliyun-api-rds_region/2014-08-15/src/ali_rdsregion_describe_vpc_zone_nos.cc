...
void Json2Type(const Json::Value& value, RdsRegionDescribeVpcZoneNosVpcZoneIdType* item);
void Json2Type(const Json::Value& value, RdsRegionDescribeVpcZoneNosResponseType* item);
...
void Json2Type(const Json::Value& value, RdsRegionDescribeVpcZoneNosResponseType* item) {
  if(value.isMember("Items") && value["Items"].isMember("VpcZoneId")) {
    Json2Array<RdsRegionDescribeVpcZoneNosVpcZoneIdType>(value["Items"]["VpcZoneId"], &item->items);
  }
}
}

int RdsRegion::DescribeVpcZoneNos(const RdsRegionDescribeVpcZoneNosRequestType& req,
                      RdsRegionDescribeVpcZoneNosResponseType* response,
