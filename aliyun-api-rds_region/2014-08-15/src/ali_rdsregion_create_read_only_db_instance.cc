...
void Json2Type(const Json::Value& value, RdsRegionCreateReadOnlyDBInstanceResponseType* item);
...
int RdsRegion::CreateReadOnlyDBInstance(const RdsRegionCreateReadOnlyDBInstanceRequestType& req,
                      RdsRegionCreateReadOnlyDBInstanceResponseType* response,
