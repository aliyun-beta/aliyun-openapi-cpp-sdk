...
void Json2Type(const Json::Value& value, RdsRegionDescribePreCheckResultsPreCheckResultType* item);
void Json2Type(const Json::Value& value, RdsRegionDescribePreCheckResultsResponseType* item);
...
void Json2Type(const Json::Value& value, RdsRegionDescribePreCheckResultsResponseType* item) {
  ...
  if(value.isMember("Items") && value["Items"].isMember("PreCheckResult")) {
    Json2Array<RdsRegionDescribePreCheckResultsPreCheckResultType>(value["Items"]["PreCheckResult"], &item->items);
  }
}
}

int RdsRegion::DescribePreCheckResults(const RdsRegionDescribePreCheckResultsRequestType& req,
                      RdsRegionDescribePreCheckResultsResponseType* response,
