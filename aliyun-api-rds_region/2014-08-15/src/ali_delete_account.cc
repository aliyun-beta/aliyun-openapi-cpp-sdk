...
void Json2Type(const Json::Value& value, DeleteAccountResponseType* item);
...
int RdsRegion::DeleteAccount(const DeleteAccountRequestType& req,
                      DeleteAccountResponseType* response,
