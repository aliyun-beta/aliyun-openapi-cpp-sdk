...
void Json2Type(const Json::Value& value, RevokeAccountPrivilegeResponseType* item);
...
int RdsRegion::RevokeAccountPrivilege(const RevokeAccountPrivilegeRequestType& req,
                      RevokeAccountPrivilegeResponseType* response,
