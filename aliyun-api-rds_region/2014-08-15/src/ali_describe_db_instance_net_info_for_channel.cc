...
void Json2Type(const Json::Value& value, DescribeDBInstanceNetInfoForChannelsecurityIPGroupsType* item);
void Json2Type(const Json::Value& value, DescribeDBInstanceNetInfoForChannelDBInstanceNetInfoType* item);
void Json2Type(const Json::Value& value, DescribeDBInstanceNetInfoForChannelResponseType* item);
...
void Json2Type(const Json::Value& value, DescribeDBInstanceNetInfoForChannelDBInstanceNetInfoType* item) {
  ...
  if(value.isMember("SecurityIPGroups") && value["SecurityIPGroups"].isMember("securityIPGroups")) {
    Json2Array<DescribeDBInstanceNetInfoForChannelsecurityIPGroupsType>(value["SecurityIPGroups"]["securityIPGroups"], &item->security_ip_groups);
  }
}
void Json2Type(const Json::Value& value, DescribeDBInstanceNetInfoForChannelResponseType* item) {
  ...
  if(value.isMember("DBInstanceNetInfos") && value["DBInstanceNetInfos"].isMember("DBInstanceNetInfo")) {
    Json2Array<DescribeDBInstanceNetInfoForChannelDBInstanceNetInfoType>(value["DBInstanceNetInfos"]["DBInstanceNetInfo"], &item->db_instance_net_infos);
  }
}
}

int RdsRegion::DescribeDBInstanceNetInfoForChannel(const DescribeDBInstanceNetInfoForChannelRequestType& req,
                      DescribeDBInstanceNetInfoForChannelResponseType* response,
