...
void Json2Type(const Json::Value& value, CreateUploadPathForSQLServerResponseType* item);
...
int RdsRegion::CreateUploadPathForSQLServer(const CreateUploadPathForSQLServerRequestType& req,
                      CreateUploadPathForSQLServerResponseType* response,
