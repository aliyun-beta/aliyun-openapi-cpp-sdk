...
void Json2Type(const Json::Value& value, RdsRegionDescribeFilesForSQLServerSQLServerUploadFileType* item);
void Json2Type(const Json::Value& value, RdsRegionDescribeFilesForSQLServerResponseType* item);
...
void Json2Type(const Json::Value& value, RdsRegionDescribeFilesForSQLServerResponseType* item) {
  ...
  if(value.isMember("Items") && value["Items"].isMember("SQLServerUploadFile")) {
    Json2Array<RdsRegionDescribeFilesForSQLServerSQLServerUploadFileType>(value["Items"]["SQLServerUploadFile"], &item->items);
  }
}
}

int RdsRegion::DescribeFilesForSQLServer(const RdsRegionDescribeFilesForSQLServerRequestType& req,
                      RdsRegionDescribeFilesForSQLServerResponseType* response,
