...
void Json2Type(const Json::Value& value, CreateDBInstanceForChannelResponseType* item);
...
int RdsRegion::CreateDBInstanceForChannel(const CreateDBInstanceForChannelRequestType& req,
                      CreateDBInstanceForChannelResponseType* response,
