...
void Json2Type(const Json::Value& value, RdsRegionDescribeParameterTemplatesTemplateRecordType* item);
void Json2Type(const Json::Value& value, RdsRegionDescribeParameterTemplatesResponseType* item);
...
void Json2Type(const Json::Value& value, RdsRegionDescribeParameterTemplatesResponseType* item) {
  ...
  if(value.isMember("Parameters") && value["Parameters"].isMember("TemplateRecord")) {
    Json2Array<RdsRegionDescribeParameterTemplatesTemplateRecordType>(value["Parameters"]["TemplateRecord"], &item->parameters);
  }
}
}

int RdsRegion::DescribeParameterTemplates(const RdsRegionDescribeParameterTemplatesRequestType& req,
                      RdsRegionDescribeParameterTemplatesResponseType* response,
