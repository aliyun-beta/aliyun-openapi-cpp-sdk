...
void Json2Type(const Json::Value& value, ModifyPostpaidDBInstanceSpecResponseType* item);
...
int RdsRegion::ModifyPostpaidDBInstanceSpec(const ModifyPostpaidDBInstanceSpecRequestType& req,
                      ModifyPostpaidDBInstanceSpecResponseType* response,
