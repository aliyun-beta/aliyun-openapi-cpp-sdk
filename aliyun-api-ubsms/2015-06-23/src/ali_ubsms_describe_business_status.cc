...
void Json2Type(const Json::Value& value, UbsmsDescribeBusinessStatusStatusType* item);
void Json2Type(const Json::Value& value, UbsmsDescribeBusinessStatusUserBusinessStatusType* item);
void Json2Type(const Json::Value& value, UbsmsDescribeBusinessStatusResponseType* item);
...
void Json2Type(const Json::Value& value, UbsmsDescribeBusinessStatusUserBusinessStatusType* item) {
  ...
  if(value.isMember("Statuses") && value["Statuses"].isMember("Status")) {
    Json2Array<UbsmsDescribeBusinessStatusStatusType>(value["Statuses"]["Status"], &item->statuses);
  }
}
void Json2Type(const Json::Value& value, UbsmsDescribeBusinessStatusResponseType* item) {
  ...
  if(value.isMember("UserBusinessStatusList") && value["UserBusinessStatusList"].isMember("UserBusinessStatus")) {
    Json2Array<UbsmsDescribeBusinessStatusUserBusinessStatusType>(value["UserBusinessStatusList"]["UserBusinessStatus"], &item->user_business_status_list);
  }
}
}

int Ubsms::DescribeBusinessStatus(const UbsmsDescribeBusinessStatusRequestType& req,
                      UbsmsDescribeBusinessStatusResponseType* response,
