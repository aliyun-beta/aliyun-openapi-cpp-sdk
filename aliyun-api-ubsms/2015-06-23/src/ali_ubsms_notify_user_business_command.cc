...
void Json2Type(const Json::Value& value, UbsmsNotifyUserBusinessCommandResponseType* item);
...
int Ubsms::NotifyUserBusinessCommand(const UbsmsNotifyUserBusinessCommandRequestType& req,
                      UbsmsNotifyUserBusinessCommandResponseType* response,
