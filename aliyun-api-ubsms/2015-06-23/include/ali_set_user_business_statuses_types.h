#ifndef ALI_SET_USER_BUSINESS_STATUSES_TYPESH
#define ALI_SET_USER_BUSINESS_STATUSES_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct SetUserBusinessStatusesRequestType {
  std::string uid;
...
struct SetUserBusinessStatusesResponseType {
  bool success;
};
} // end namespace
#endif
