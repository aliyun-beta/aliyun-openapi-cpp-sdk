...
void Json2Type(const Json::Value& value, RiskValidateVerifyCodeResponseType* item);
...
int Risk::ValidateVerifyCode(const RiskValidateVerifyCodeRequestType& req,
                      RiskValidateVerifyCodeResponseType* response,
