...
void Json2Type(const Json::Value& value, RiskFindRiskDataType* item);
void Json2Type(const Json::Value& value, RiskFindRiskResponseType* item);
...
int Risk::FindRisk(const RiskFindRiskRequestType& req,
                      RiskFindRiskResponseType* response,
