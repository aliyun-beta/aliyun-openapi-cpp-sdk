...
void Json2Type(const Json::Value& value, QueryNameListRiskNameType* item);
void Json2Type(const Json::Value& value, QueryNameListResponseType* item);
...
void Json2Type(const Json::Value& value, QueryNameListResponseType* item) {
  ...
  if(value.isMember("RiskNameLists") && value["RiskNameLists"].isMember("RiskName")) {
    Json2Array<QueryNameListRiskNameType>(value["RiskNameLists"]["RiskName"], &item->risk_name_lists);
  }
}
}

int Risk::QueryNameList(const QueryNameListRequestType& req,
                      QueryNameListResponseType* response,
