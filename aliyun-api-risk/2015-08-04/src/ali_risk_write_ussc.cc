...
void Json2Type(const Json::Value& value, RiskWriteUsscResponseType* item);
...
int Risk::WriteUssc(const RiskWriteUsscRequestType& req,
                      RiskWriteUsscResponseType* response,
