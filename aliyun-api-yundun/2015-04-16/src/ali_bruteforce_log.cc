...
void Json2Type(const Json::Value& value, BruteforceLogBruteforceLogType* item);
void Json2Type(const Json::Value& value, BruteforceLogResponseType* item);
...
void Json2Type(const Json::Value& value, BruteforceLogResponseType* item) {
  ...
  if(value.isMember("LogList") && value["LogList"].isMember("BruteforceLog")) {
    Json2Array<BruteforceLogBruteforceLogType>(value["LogList"]["BruteforceLog"], &item->log_list);
  }
}
}

int Yundun::BruteforceLog(const BruteforceLogRequestType& req,
                      BruteforceLogResponseType* response,
