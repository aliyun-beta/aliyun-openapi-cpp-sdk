...
void Json2Type(const Json::Value& value, DeleteCNameWafWafInfoType* item);
void Json2Type(const Json::Value& value, DeleteCNameWafResponseType* item);
...
void Json2Type(const Json::Value& value, DeleteCNameWafResponseType* item) {
  if(value.isMember("WafInfoList") && value["WafInfoList"].isMember("WafInfo")) {
    Json2Array<DeleteCNameWafWafInfoType>(value["WafInfoList"]["WafInfo"], &item->waf_info_list);
  }
}
}

int Yundun::DeleteCNameWaf(const DeleteCNameWafRequestType& req,
                      DeleteCNameWafResponseType* response,
