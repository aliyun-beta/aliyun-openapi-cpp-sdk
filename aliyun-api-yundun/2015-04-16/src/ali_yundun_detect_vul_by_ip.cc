...
void Json2Type(const Json::Value& value, YundunDetectVulByIpResponseType* item);
...
int Yundun::DetectVulByIp(const YundunDetectVulByIpRequestType& req,
                      YundunDetectVulByIpResponseType* response,
