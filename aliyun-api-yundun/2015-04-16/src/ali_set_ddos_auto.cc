...
void Json2Type(const Json::Value& value, SetDdosAutoResponseType* item);
...
int Yundun::SetDdosAuto(const SetDdosAutoRequestType& req,
                      SetDdosAutoResponseType* response,
