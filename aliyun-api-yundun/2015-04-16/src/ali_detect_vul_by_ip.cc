...
void Json2Type(const Json::Value& value, DetectVulByIpResponseType* item);
...
int Yundun::DetectVulByIp(const DetectVulByIpRequestType& req,
                      DetectVulByIpResponseType* response,
