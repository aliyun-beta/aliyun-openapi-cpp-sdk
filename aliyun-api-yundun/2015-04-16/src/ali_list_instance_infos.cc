...
void Json2Type(const Json::Value& value, ListInstanceInfosInstanceInfoType* item);
void Json2Type(const Json::Value& value, ListInstanceInfosResponseType* item);
...
void Json2Type(const Json::Value& value, ListInstanceInfosResponseType* item) {
  ...
  if(value.isMember("InfosList") && value["InfosList"].isMember("InstanceInfo")) {
    Json2Array<ListInstanceInfosInstanceInfoType>(value["InfosList"]["InstanceInfo"], &item->infos_list);
  }
}
}

int Yundun::ListInstanceInfos(const ListInstanceInfosRequestType& req,
                      ListInstanceInfosResponseType* response,
