...
void Json2Type(const Json::Value& value, GetDdosConfigOptionsRequestThresholdOptionType* item);
void Json2Type(const Json::Value& value, GetDdosConfigOptionsConnectionThresholdOptionType* item);
void Json2Type(const Json::Value& value, GetDdosConfigOptionsResponseType* item);
...
void Json2Type(const Json::Value& value, GetDdosConfigOptionsResponseType* item) {
  if(value.isMember("RequestThresholdOptions1") && value["RequestThresholdOptions1"].isMember("RequestThresholdOption")) {
    Json2Array<GetDdosConfigOptionsRequestThresholdOptionType>(value["RequestThresholdOptions1"]["RequestThresholdOption"], &item->request_threshold_options1);
  }
  if(value.isMember("RequestThresholdOptions2") && value["RequestThresholdOptions2"].isMember("RequestThresholdOption")) {
    Json2Array<GetDdosConfigOptionsRequestThresholdOptionType>(value["RequestThresholdOptions2"]["RequestThresholdOption"], &item->request_threshold_options2);
  }
  if(value.isMember("ConnectionThresholdOptions") && value["ConnectionThresholdOptions"].isMember("ConnectionThresholdOption")) {
    Json2Array<GetDdosConfigOptionsConnectionThresholdOptionType>(value["ConnectionThresholdOptions"]["ConnectionThresholdOption"], &item->connection_threshold_options);
  }
...
int Yundun::GetDdosConfigOptions(const GetDdosConfigOptionsRequestType& req,
                      GetDdosConfigOptionsResponseType* response,
