...
void Json2Type(const Json::Value& value, YundunVulScanLogVulScanLogType* item);
void Json2Type(const Json::Value& value, YundunVulScanLogResponseType* item);
...
void Json2Type(const Json::Value& value, YundunVulScanLogResponseType* item) {
  ...
  if(value.isMember("LogList") && value["LogList"].isMember("VulScanLog")) {
    Json2Array<YundunVulScanLogVulScanLogType>(value["LogList"]["VulScanLog"], &item->log_list);
  }
}
}

int Yundun::VulScanLog(const YundunVulScanLogRequestType& req,
                      YundunVulScanLogResponseType* response,
