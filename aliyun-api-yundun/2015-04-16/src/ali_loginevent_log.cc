...
void Json2Type(const Json::Value& value, LogineventLogLoginEventLogType* item);
void Json2Type(const Json::Value& value, LogineventLogResponseType* item);
...
void Json2Type(const Json::Value& value, LogineventLogResponseType* item) {
  ...
  if(value.isMember("LogList") && value["LogList"].isMember("LoginEventLog")) {
    Json2Array<LogineventLogLoginEventLogType>(value["LogList"]["LoginEventLog"], &item->log_list);
  }
}
}

int Yundun::LogineventLog(const LogineventLogRequestType& req,
                      LogineventLogResponseType* response,
