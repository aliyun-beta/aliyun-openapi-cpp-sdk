...
void Json2Type(const Json::Value& value, YundunDeleteCNameWafWafInfoType* item);
void Json2Type(const Json::Value& value, YundunDeleteCNameWafResponseType* item);
...
void Json2Type(const Json::Value& value, YundunDeleteCNameWafResponseType* item) {
  if(value.isMember("WafInfoList") && value["WafInfoList"].isMember("WafInfo")) {
    Json2Array<YundunDeleteCNameWafWafInfoType>(value["WafInfoList"]["WafInfo"], &item->waf_info_list);
  }
}
}
