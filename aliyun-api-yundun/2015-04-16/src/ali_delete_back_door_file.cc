...
void Json2Type(const Json::Value& value, DeleteBackDoorFileResponseType* item);
...
int Yundun::DeleteBackDoorFile(const DeleteBackDoorFileRequestType& req,
                      DeleteBackDoorFileResponseType* response,
