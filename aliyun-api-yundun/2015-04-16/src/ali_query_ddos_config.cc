...
void Json2Type(const Json::Value& value, QueryDdosConfigResponseType* item);
...
int Yundun::QueryDdosConfig(const QueryDdosConfigRequestType& req,
                      QueryDdosConfigResponseType* response,
