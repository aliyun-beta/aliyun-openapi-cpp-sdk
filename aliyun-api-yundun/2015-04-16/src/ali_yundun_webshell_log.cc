...
void Json2Type(const Json::Value& value, YundunWebshellLogWebshellLogType* item);
void Json2Type(const Json::Value& value, YundunWebshellLogResponseType* item);
...
void Json2Type(const Json::Value& value, YundunWebshellLogResponseType* item) {
  ...
  if(value.isMember("LogList") && value["LogList"].isMember("WebshellLog")) {
    Json2Array<YundunWebshellLogWebshellLogType>(value["LogList"]["WebshellLog"], &item->log_list);
  }
}
}

int Yundun::WebshellLog(const YundunWebshellLogRequestType& req,
                      YundunWebshellLogResponseType* response,
