...
void Json2Type(const Json::Value& value, DescribeCouponListCouponType* item);
void Json2Type(const Json::Value& value, DescribeCouponListResponseType* item);
...
void Json2Type(const Json::Value& value, DescribeCouponListResponseType* item) {
  if(value.isMember("Coupons") && value["Coupons"].isMember("Coupon")) {
    Json2Array<DescribeCouponListCouponType>(value["Coupons"]["Coupon"], &item->coupons);
  }
}
}

int Bss::DescribeCouponList(const DescribeCouponListRequestType& req,
                      DescribeCouponListResponseType* response,
