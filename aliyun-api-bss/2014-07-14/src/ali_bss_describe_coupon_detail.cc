...
void Json2Type(const Json::Value& value, BssDescribeCouponDetailResponseType* item);
...
int Bss::DescribeCouponDetail(const BssDescribeCouponDetailRequestType& req,
                      BssDescribeCouponDetailResponseType* response,
