#ifndef ALI_BSS_DESCRIBE_COUPON_DETAIL_TYPESH
#define ALI_BSS_DESCRIBE_COUPON_DETAIL_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct BssDescribeCouponDetailRequestType {
  std::string coupon_number;
};
struct BssDescribeCouponDetailResponseType {
