#ifndef ALI_DESCRIBE_COUPON_LIST_TYPESH
#define ALI_DESCRIBE_COUPON_LIST_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct DescribeCouponListRequestType {
  std::string status;
...
struct DescribeCouponListCouponType {
...
struct DescribeCouponListResponseType {
  std::vector<DescribeCouponListCouponType> coupons;
};
} // end namespace
#endif
