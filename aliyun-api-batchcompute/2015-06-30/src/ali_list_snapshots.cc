...
void Json2Type(const Json::Value& value, ListSnapshotsResponseType* item);
...
int BatchCompute::ListSnapshots(const ListSnapshotsRequestType& req,
                      ListSnapshotsResponseType* response,
