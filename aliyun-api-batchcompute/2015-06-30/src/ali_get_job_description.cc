...
void Json2Type(const Json::Value& value, GetJobDescriptionResponseType* item);
...
int BatchCompute::GetJobDescription(const GetJobDescriptionRequestType& req,
                      GetJobDescriptionResponseType* response,
