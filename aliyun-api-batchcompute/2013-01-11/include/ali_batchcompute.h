...
#include "ali_batchcompute_get_snapshot_types.h"
...
#ifdef WIN32
 #ifdef aliyun_api_batchcompute_2013_01_11_EXPORTS
 #define ALIYUN_API_BATCHCOMPUTE_2013_01_11_DLL_EXPORT_IMPORT __declspec(dllexport)
 #else
 #define ALIYUN_API_BATCHCOMPUTE_2013_01_11_DLL_EXPORT_IMPORT 
 #endif
#else
#define ALIYUN_API_BATCHCOMPUTE_2013_01_11_DLL_EXPORT_IMPORT
#endif
...
class ALIYUN_API_BATCHCOMPUTE_2013_01_11_DLL_EXPORT_IMPORT BatchCompute {
public:
...
public:
  ...
  int GetSnapshot(const BatchComputeGetSnapshotRequestType& req,
