...
void Json2Type(const Json::Value& value, BatchComputeGetImageResponseType* item);
...
int BatchCompute::GetImage(const BatchComputeGetImageRequestType& req,
                      BatchComputeGetImageResponseType* response,
