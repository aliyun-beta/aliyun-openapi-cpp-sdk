...
void Json2Type(const Json::Value& value, BatchComputeStopJobResponseType* item);
...
int BatchCompute::StopJob(const BatchComputeStopJobRequestType& req,
  ...
  Json::Value val;
  Json::Reader reader;
  std::string url = "https://" + host_ + get_format_string("/jobs/%s?Action=Stop", req.resource_name.c_str());
