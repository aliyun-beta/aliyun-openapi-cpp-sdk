...
void Json2Type(const Json::Value& value, BatchComputeDeleteImageResponseType* item);
...
int BatchCompute::DeleteImage(const BatchComputeDeleteImageRequestType& req,
                      BatchComputeDeleteImageResponseType* response,
