...
void Json2Type(const Json::Value& value, OnsOnsPublishDeleteResponseType* item);
...
int Ons::OnsPublishDelete(const OnsOnsPublishDeleteRequestType& req,
                      OnsOnsPublishDeleteResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","OnsPublishDelete");
