...
void Json2Type(const Json::Value& value, OnsOnsPublishSearchPublishInfoDoType* item);
void Json2Type(const Json::Value& value, OnsOnsPublishSearchResponseType* item);
...
void Json2Type(const Json::Value& value, OnsOnsPublishSearchResponseType* item) {
  ...
  if(value.isMember("Data") && value["Data"].isMember("PublishInfoDo")) {
    Json2Array<OnsOnsPublishSearchPublishInfoDoType>(value["Data"]["PublishInfoDo"], &item->data);
  }
}
}

int Ons::OnsPublishSearch(const OnsOnsPublishSearchRequestType& req,
                      OnsOnsPublishSearchResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","OnsPublishSearch");
