...
void Json2Type(const Json::Value& value, OnsOnsTrendClusterOutputTpsStatsDataDoType* item);
void Json2Type(const Json::Value& value, OnsOnsTrendClusterOutputTpsDataType* item);
void Json2Type(const Json::Value& value, OnsOnsTrendClusterOutputTpsResponseType* item);
...
void Json2Type(const Json::Value& value, OnsOnsTrendClusterOutputTpsDataType* item) {
  ...
  if(value.isMember("Records") && value["Records"].isMember("StatsDataDo")) {
    Json2Array<OnsOnsTrendClusterOutputTpsStatsDataDoType>(value["Records"]["StatsDataDo"], &item->records);
  }
}
void Json2Type(const Json::Value& value, OnsOnsTrendClusterOutputTpsResponseType* item) {
...
int Ons::OnsTrendClusterOutputTps(const OnsOnsTrendClusterOutputTpsRequestType& req,
                      OnsOnsTrendClusterOutputTpsResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","OnsTrendClusterOutputTps");
