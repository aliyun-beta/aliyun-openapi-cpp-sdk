...
void Json2Type(const Json::Value& value, OnsConsumerStatusConnectionDoType* item);
void Json2Type(const Json::Value& value, OnsConsumerStatusConsumeQueueOffsetType* item);
void Json2Type(const Json::Value& value, OnsConsumerStatusDetailInTopicDoType* item);
void Json2Type(const Json::Value& value, OnsConsumerStatusSubscriptionDataType* item);
void Json2Type(const Json::Value& value, OnsConsumerStatusConsumerRunningDataDoType* item);
void Json2Type(const Json::Value& value, OnsConsumerStatusThreadTrackDoType* item);
void Json2Type(const Json::Value& value, OnsConsumerStatusWarnMapType* item);
void Json2Type(const Json::Value& value, OnsConsumerStatusProcessQueueInfoDoType* item);
void Json2Type(const Json::Value& value, OnsConsumerStatusConsumerConnectionInfoDoType* item);
void Json2Type(const Json::Value& value, OnsConsumerStatusDataType* item);
void Json2Type(const Json::Value& value, OnsConsumerStatusResponseType* item);
...
void Json2Type(const Json::Value& value, OnsConsumerStatusDetailInTopicDoType* item) {
  ...
  if(value.isMember("OffsetList") && value["OffsetList"].isMember("ConsumeQueueOffset")) {
    Json2Array<OnsConsumerStatusConsumeQueueOffsetType>(value["OffsetList"]["ConsumeQueueOffset"], &item->offset_list);
  }
}
void Json2Type(const Json::Value& value, OnsConsumerStatusSubscriptionDataType* item) {
...
void Json2Type(const Json::Value& value, OnsConsumerStatusConsumerConnectionInfoDoType* item) {
  ...
  if(value.isMember("SubscriptionSet") && value["SubscriptionSet"].isMember("SubscriptionData")) {
    Json2Array<OnsConsumerStatusSubscriptionDataType>(value["SubscriptionSet"]["SubscriptionData"], &item->subscription_set);
  }
  if(value.isMember("RunningDataList") && value["RunningDataList"].isMember("ConsumerRunningDataDo")) {
    Json2Array<OnsConsumerStatusConsumerRunningDataDoType>(value["RunningDataList"]["ConsumerRunningDataDo"], &item->running_data_list);
  }
  if(value.isMember("Jstack") && value["Jstack"].isMember("ThreadTrackDo")) {
    Json2Array<OnsConsumerStatusThreadTrackDoType>(value["Jstack"]["ThreadTrackDo"], &item->jstack);
  }
  if(value.isMember("ProcessQueueInfoDoList") && value["ProcessQueueInfoDoList"].isMember("ProcessQueueInfoDo")) {
    Json2Array<OnsConsumerStatusProcessQueueInfoDoType>(value["ProcessQueueInfoDoList"]["ProcessQueueInfoDo"], &item->process_queue_info_do_list);
  }
}
void Json2Type(const Json::Value& value, OnsConsumerStatusDataType* item) {
  ...
  if(value.isMember("ConnectionSet") && value["ConnectionSet"].isMember("ConnectionDo")) {
    Json2Array<OnsConsumerStatusConnectionDoType>(value["ConnectionSet"]["ConnectionDo"], &item->connection_set);
  }
  if(value.isMember("DetailInTopicList") && value["DetailInTopicList"].isMember("DetailInTopicDo")) {
    Json2Array<OnsConsumerStatusDetailInTopicDoType>(value["DetailInTopicList"]["DetailInTopicDo"], &item->detail_in_topic_list);
  }
  if(value.isMember("ConsumerConnectionInfoList") && value["ConsumerConnectionInfoList"].isMember("ConsumerConnectionInfoDo")) {
    Json2Array<OnsConsumerStatusConsumerConnectionInfoDoType>(value["ConsumerConnectionInfoList"]["ConsumerConnectionInfoDo"], &item->consumer_connection_info_list);
  }
}
void Json2Type(const Json::Value& value, OnsConsumerStatusResponseType* item) {
...
int Ons::OnsConsumerStatus(const OnsConsumerStatusRequestType& req,
                      OnsConsumerStatusResponseType* response,
