...
void Json2Type(const Json::Value& value, OnsWarnCreateResponseType* item);
...
int Ons::OnsWarnCreate(const OnsWarnCreateRequestType& req,
                      OnsWarnCreateResponseType* response,
