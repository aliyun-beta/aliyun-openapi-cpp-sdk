...
void Json2Type(const Json::Value& value, OnsOnsConsumerGetConnectionConnectionDoType* item);
void Json2Type(const Json::Value& value, OnsOnsConsumerGetConnectionDataType* item);
void Json2Type(const Json::Value& value, OnsOnsConsumerGetConnectionResponseType* item);
...
void Json2Type(const Json::Value& value, OnsOnsConsumerGetConnectionDataType* item) {
  if(value.isMember("ConnectionList") && value["ConnectionList"].isMember("ConnectionDo")) {
    Json2Array<OnsOnsConsumerGetConnectionConnectionDoType>(value["ConnectionList"]["ConnectionDo"], &item->connection_list);
  }
}
void Json2Type(const Json::Value& value, OnsOnsConsumerGetConnectionResponseType* item) {
...
int Ons::OnsConsumerGetConnection(const OnsOnsConsumerGetConnectionRequestType& req,
                      OnsOnsConsumerGetConnectionResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","OnsConsumerGetConnection");
