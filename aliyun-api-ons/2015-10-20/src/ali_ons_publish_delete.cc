...
void Json2Type(const Json::Value& value, OnsPublishDeleteResponseType* item);
...
int Ons::OnsPublishDelete(const OnsPublishDeleteRequestType& req,
                      OnsPublishDeleteResponseType* response,
