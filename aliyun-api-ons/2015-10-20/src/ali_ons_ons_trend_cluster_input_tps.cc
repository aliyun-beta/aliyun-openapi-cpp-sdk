...
void Json2Type(const Json::Value& value, OnsOnsTrendClusterInputTpsStatsDataDoType* item);
void Json2Type(const Json::Value& value, OnsOnsTrendClusterInputTpsDataType* item);
void Json2Type(const Json::Value& value, OnsOnsTrendClusterInputTpsResponseType* item);
...
void Json2Type(const Json::Value& value, OnsOnsTrendClusterInputTpsDataType* item) {
  ...
  if(value.isMember("Records") && value["Records"].isMember("StatsDataDo")) {
    Json2Array<OnsOnsTrendClusterInputTpsStatsDataDoType>(value["Records"]["StatsDataDo"], &item->records);
  }
}
void Json2Type(const Json::Value& value, OnsOnsTrendClusterInputTpsResponseType* item) {
