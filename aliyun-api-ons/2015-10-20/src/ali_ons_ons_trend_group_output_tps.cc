...
void Json2Type(const Json::Value& value, OnsOnsTrendGroupOutputTpsStatsDataDoType* item);
void Json2Type(const Json::Value& value, OnsOnsTrendGroupOutputTpsDataType* item);
void Json2Type(const Json::Value& value, OnsOnsTrendGroupOutputTpsResponseType* item);
...
void Json2Type(const Json::Value& value, OnsOnsTrendGroupOutputTpsDataType* item) {
  ...
  if(value.isMember("Records") && value["Records"].isMember("StatsDataDo")) {
    Json2Array<OnsOnsTrendGroupOutputTpsStatsDataDoType>(value["Records"]["StatsDataDo"], &item->records);
  }
}
void Json2Type(const Json::Value& value, OnsOnsTrendGroupOutputTpsResponseType* item) {
...
int Ons::OnsTrendGroupOutputTps(const OnsOnsTrendGroupOutputTpsRequestType& req,
                      OnsOnsTrendGroupOutputTpsResponseType* response,
