...
void Json2Type(const Json::Value& value, OnsWarnDisableResponseType* item);
...
int Ons::OnsWarnDisable(const OnsWarnDisableRequestType& req,
                      OnsWarnDisableResponseType* response,
