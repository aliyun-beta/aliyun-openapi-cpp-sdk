...
void Json2Type(const Json::Value& value, OnsOnsSubscriptionGetSubscribeInfoDoType* item);
void Json2Type(const Json::Value& value, OnsOnsSubscriptionGetResponseType* item);
...
void Json2Type(const Json::Value& value, OnsOnsSubscriptionGetResponseType* item) {
  ...
  if(value.isMember("Data") && value["Data"].isMember("SubscribeInfoDo")) {
    Json2Array<OnsOnsSubscriptionGetSubscribeInfoDoType>(value["Data"]["SubscribeInfoDo"], &item->data);
  }
}
}

int Ons::OnsSubscriptionGet(const OnsOnsSubscriptionGetRequestType& req,
                      OnsOnsSubscriptionGetResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","OnsSubscriptionGet");
