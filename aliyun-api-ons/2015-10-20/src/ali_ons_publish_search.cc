...
void Json2Type(const Json::Value& value, OnsPublishSearchPublishInfoDoType* item);
void Json2Type(const Json::Value& value, OnsPublishSearchResponseType* item);
...
void Json2Type(const Json::Value& value, OnsPublishSearchResponseType* item) {
  ...
  if(value.isMember("Data") && value["Data"].isMember("PublishInfoDo")) {
    Json2Array<OnsPublishSearchPublishInfoDoType>(value["Data"]["PublishInfoDo"], &item->data);
  }
}
}

int Ons::OnsPublishSearch(const OnsPublishSearchRequestType& req,
                      OnsPublishSearchResponseType* response,
