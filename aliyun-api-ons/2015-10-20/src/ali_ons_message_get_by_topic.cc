...
void Json2Type(const Json::Value& value, OnsMessageGetByTopicMessagePropertyType* item);
void Json2Type(const Json::Value& value, OnsMessageGetByTopicOnsRestMessageDoType* item);
void Json2Type(const Json::Value& value, OnsMessageGetByTopicResponseType* item);
...
void Json2Type(const Json::Value& value, OnsMessageGetByTopicOnsRestMessageDoType* item) {
  ...
  if(value.isMember("PropertyList") && value["PropertyList"].isMember("MessageProperty")) {
    Json2Array<OnsMessageGetByTopicMessagePropertyType>(value["PropertyList"]["MessageProperty"], &item->property_list);
  }
}
void Json2Type(const Json::Value& value, OnsMessageGetByTopicResponseType* item) {
  ...
  if(value.isMember("Data") && value["Data"].isMember("OnsRestMessageDo")) {
    Json2Array<OnsMessageGetByTopicOnsRestMessageDoType>(value["Data"]["OnsRestMessageDo"], &item->data);
  }
}
}

int Ons::OnsMessageGetByTopic(const OnsMessageGetByTopicRequestType& req,
                      OnsMessageGetByTopicResponseType* response,
