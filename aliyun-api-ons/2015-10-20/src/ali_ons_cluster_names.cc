...
void Json2Type(const Json::Value& value, OnsClusterNamesResponseType* item);
...
int Ons::OnsClusterNames(const OnsClusterNamesRequestType& req,
                      OnsClusterNamesResponseType* response,
