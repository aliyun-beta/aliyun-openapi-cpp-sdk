...
void Json2Type(const Json::Value& value, OnsWarnEnableResponseType* item);
...
int Ons::OnsWarnEnable(const OnsWarnEnableRequestType& req,
                      OnsWarnEnableResponseType* response,
