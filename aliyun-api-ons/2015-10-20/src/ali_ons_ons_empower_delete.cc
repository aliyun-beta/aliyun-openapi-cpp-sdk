...
void Json2Type(const Json::Value& value, OnsOnsEmpowerDeleteResponseType* item);
...
int Ons::OnsEmpowerDelete(const OnsOnsEmpowerDeleteRequestType& req,
                      OnsOnsEmpowerDeleteResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","OnsEmpowerDelete");
