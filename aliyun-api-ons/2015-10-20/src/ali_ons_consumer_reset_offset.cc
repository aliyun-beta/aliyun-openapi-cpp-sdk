...
void Json2Type(const Json::Value& value, OnsConsumerResetOffsetResponseType* item);
...
int Ons::OnsConsumerResetOffset(const OnsConsumerResetOffsetRequestType& req,
                      OnsConsumerResetOffsetResponseType* response,
