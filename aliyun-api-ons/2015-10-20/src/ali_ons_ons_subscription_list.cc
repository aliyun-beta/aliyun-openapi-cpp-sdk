...
void Json2Type(const Json::Value& value, OnsOnsSubscriptionListSubscribeInfoDoType* item);
void Json2Type(const Json::Value& value, OnsOnsSubscriptionListResponseType* item);
...
void Json2Type(const Json::Value& value, OnsOnsSubscriptionListResponseType* item) {
  ...
  if(value.isMember("Data") && value["Data"].isMember("SubscribeInfoDo")) {
    Json2Array<OnsOnsSubscriptionListSubscribeInfoDoType>(value["Data"]["SubscribeInfoDo"], &item->data);
  }
}
}

int Ons::OnsSubscriptionList(const OnsOnsSubscriptionListRequestType& req,
                      OnsOnsSubscriptionListResponseType* response,
