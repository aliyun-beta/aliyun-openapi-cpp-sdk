...
void Json2Type(const Json::Value& value, OnsOnsWarnDeleteResponseType* item);
...
int Ons::OnsWarnDelete(const OnsOnsWarnDeleteRequestType& req,
                      OnsOnsWarnDeleteResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","OnsWarnDelete");
