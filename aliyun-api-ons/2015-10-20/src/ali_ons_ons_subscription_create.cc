...
void Json2Type(const Json::Value& value, OnsOnsSubscriptionCreateResponseType* item);
...
int Ons::OnsSubscriptionCreate(const OnsOnsSubscriptionCreateRequestType& req,
                      OnsOnsSubscriptionCreateResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","OnsSubscriptionCreate");
