...
void Json2Type(const Json::Value& value, OnsOnsTopicDeleteResponseType* item);
...
int Ons::OnsTopicDelete(const OnsOnsTopicDeleteRequestType& req,
                      OnsOnsTopicDeleteResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","OnsTopicDelete");
