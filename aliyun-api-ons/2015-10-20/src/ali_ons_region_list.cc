...
void Json2Type(const Json::Value& value, OnsRegionListRegionDoType* item);
void Json2Type(const Json::Value& value, OnsRegionListResponseType* item);
...
void Json2Type(const Json::Value& value, OnsRegionListResponseType* item) {
  ...
  if(value.isMember("Data") && value["Data"].isMember("RegionDo")) {
    Json2Array<OnsRegionListRegionDoType>(value["Data"]["RegionDo"], &item->data);
  }
}
}

int Ons::OnsRegionList(const OnsRegionListRequestType& req,
                      OnsRegionListResponseType* response,
