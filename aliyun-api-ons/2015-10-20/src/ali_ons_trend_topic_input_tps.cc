...
void Json2Type(const Json::Value& value, OnsTrendTopicInputTpsStatsDataDoType* item);
void Json2Type(const Json::Value& value, OnsTrendTopicInputTpsDataType* item);
void Json2Type(const Json::Value& value, OnsTrendTopicInputTpsResponseType* item);
...
void Json2Type(const Json::Value& value, OnsTrendTopicInputTpsDataType* item) {
  ...
  if(value.isMember("Records") && value["Records"].isMember("StatsDataDo")) {
    Json2Array<OnsTrendTopicInputTpsStatsDataDoType>(value["Records"]["StatsDataDo"], &item->records);
  }
}
void Json2Type(const Json::Value& value, OnsTrendTopicInputTpsResponseType* item) {
...
int Ons::OnsTrendTopicInputTps(const OnsTrendTopicInputTpsRequestType& req,
                      OnsTrendTopicInputTpsResponseType* response,
