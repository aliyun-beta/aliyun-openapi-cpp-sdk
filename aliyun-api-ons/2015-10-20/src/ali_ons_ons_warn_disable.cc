...
void Json2Type(const Json::Value& value, OnsOnsWarnDisableResponseType* item);
...
int Ons::OnsWarnDisable(const OnsOnsWarnDisableRequestType& req,
                      OnsOnsWarnDisableResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","OnsWarnDisable");
