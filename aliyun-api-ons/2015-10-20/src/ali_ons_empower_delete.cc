...
void Json2Type(const Json::Value& value, OnsEmpowerDeleteResponseType* item);
...
int Ons::OnsEmpowerDelete(const OnsEmpowerDeleteRequestType& req,
                      OnsEmpowerDeleteResponseType* response,
