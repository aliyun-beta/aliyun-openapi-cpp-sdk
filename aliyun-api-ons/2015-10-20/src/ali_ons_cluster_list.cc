...
void Json2Type(const Json::Value& value, OnsClusterListBrokerInfoDataDoType* item);
void Json2Type(const Json::Value& value, OnsClusterListClusterInfoDataDoType* item);
void Json2Type(const Json::Value& value, OnsClusterListResponseType* item);
...
void Json2Type(const Json::Value& value, OnsClusterListClusterInfoDataDoType* item) {
  ...
  if(value.isMember("BrokerInfoList") && value["BrokerInfoList"].isMember("BrokerInfoDataDo")) {
    Json2Array<OnsClusterListBrokerInfoDataDoType>(value["BrokerInfoList"]["BrokerInfoDataDo"], &item->broker_info_list);
  }
}
void Json2Type(const Json::Value& value, OnsClusterListResponseType* item) {
  ...
  if(value.isMember("Data") && value["Data"].isMember("ClusterInfoDataDo")) {
    Json2Array<OnsClusterListClusterInfoDataDoType>(value["Data"]["ClusterInfoDataDo"], &item->data);
  }
}
}

int Ons::OnsClusterList(const OnsClusterListRequestType& req,
                      OnsClusterListResponseType* response,
