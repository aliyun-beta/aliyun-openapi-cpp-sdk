...
void Json2Type(const Json::Value& value, OnsOnsTopicSearchPublishInfoDoType* item);
void Json2Type(const Json::Value& value, OnsOnsTopicSearchResponseType* item);
...
void Json2Type(const Json::Value& value, OnsOnsTopicSearchResponseType* item) {
  ...
  if(value.isMember("Data") && value["Data"].isMember("PublishInfoDo")) {
    Json2Array<OnsOnsTopicSearchPublishInfoDoType>(value["Data"]["PublishInfoDo"], &item->data);
  }
}
}

int Ons::OnsTopicSearch(const OnsOnsTopicSearchRequestType& req,
                      OnsOnsTopicSearchResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","OnsTopicSearch");
