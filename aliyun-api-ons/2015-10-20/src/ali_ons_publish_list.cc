...
void Json2Type(const Json::Value& value, OnsPublishListPublishInfoDoType* item);
void Json2Type(const Json::Value& value, OnsPublishListResponseType* item);
...
void Json2Type(const Json::Value& value, OnsPublishListResponseType* item) {
  ...
  if(value.isMember("Data") && value["Data"].isMember("PublishInfoDo")) {
    Json2Array<OnsPublishListPublishInfoDoType>(value["Data"]["PublishInfoDo"], &item->data);
  }
}
}

int Ons::OnsPublishList(const OnsPublishListRequestType& req,
                      OnsPublishListResponseType* response,
