...
void Json2Type(const Json::Value& value, OnsOnsTrendGetMachineSarStatsDataDoType* item);
void Json2Type(const Json::Value& value, OnsOnsTrendGetMachineSarDataType* item);
void Json2Type(const Json::Value& value, OnsOnsTrendGetMachineSarResponseType* item);
...
void Json2Type(const Json::Value& value, OnsOnsTrendGetMachineSarDataType* item) {
  ...
  if(value.isMember("Records") && value["Records"].isMember("StatsDataDo")) {
    Json2Array<OnsOnsTrendGetMachineSarStatsDataDoType>(value["Records"]["StatsDataDo"], &item->records);
  }
}
void Json2Type(const Json::Value& value, OnsOnsTrendGetMachineSarResponseType* item) {
...
int Ons::OnsTrendGetMachineSar(const OnsOnsTrendGetMachineSarRequestType& req,
                      OnsOnsTrendGetMachineSarResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","OnsTrendGetMachineSar");
  ...
  if(!req.host_ip.empty()) {
    req_rpc->AddRequestQuery("HostIp", req.host_ip);
  }
  if(!req.app_id.empty()) {
