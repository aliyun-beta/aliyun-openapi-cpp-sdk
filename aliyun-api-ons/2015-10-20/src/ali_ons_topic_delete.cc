...
void Json2Type(const Json::Value& value, OnsTopicDeleteResponseType* item);
...
int Ons::OnsTopicDelete(const OnsTopicDeleteRequestType& req,
                      OnsTopicDeleteResponseType* response,
