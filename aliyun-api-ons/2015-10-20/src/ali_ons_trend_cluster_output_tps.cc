...
void Json2Type(const Json::Value& value, OnsTrendClusterOutputTpsStatsDataDoType* item);
void Json2Type(const Json::Value& value, OnsTrendClusterOutputTpsDataType* item);
void Json2Type(const Json::Value& value, OnsTrendClusterOutputTpsResponseType* item);
...
void Json2Type(const Json::Value& value, OnsTrendClusterOutputTpsDataType* item) {
  ...
  if(value.isMember("Records") && value["Records"].isMember("StatsDataDo")) {
    Json2Array<OnsTrendClusterOutputTpsStatsDataDoType>(value["Records"]["StatsDataDo"], &item->records);
  }
}
void Json2Type(const Json::Value& value, OnsTrendClusterOutputTpsResponseType* item) {
...
int Ons::OnsTrendClusterOutputTps(const OnsTrendClusterOutputTpsRequestType& req,
                      OnsTrendClusterOutputTpsResponseType* response,
