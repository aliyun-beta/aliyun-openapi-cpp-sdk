...
void Json2Type(const Json::Value& value, OnsOnsMessageGetByMsgIdMessagePropertyType* item);
void Json2Type(const Json::Value& value, OnsOnsMessageGetByMsgIdDataType* item);
void Json2Type(const Json::Value& value, OnsOnsMessageGetByMsgIdResponseType* item);
...
void Json2Type(const Json::Value& value, OnsOnsMessageGetByMsgIdDataType* item) {
  ...
  if(value.isMember("PropertyList") && value["PropertyList"].isMember("MessageProperty")) {
    Json2Array<OnsOnsMessageGetByMsgIdMessagePropertyType>(value["PropertyList"]["MessageProperty"], &item->property_list);
  }
}
void Json2Type(const Json::Value& value, OnsOnsMessageGetByMsgIdResponseType* item) {
...
int Ons::OnsMessageGetByMsgId(const OnsOnsMessageGetByMsgIdRequestType& req,
                      OnsOnsMessageGetByMsgIdResponseType* response,
