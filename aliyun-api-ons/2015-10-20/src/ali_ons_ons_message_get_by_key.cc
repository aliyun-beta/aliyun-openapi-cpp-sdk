...
void Json2Type(const Json::Value& value, OnsOnsMessageGetByKeyMessagePropertyType* item);
void Json2Type(const Json::Value& value, OnsOnsMessageGetByKeyOnsRestMessageDoType* item);
void Json2Type(const Json::Value& value, OnsOnsMessageGetByKeyResponseType* item);
...
void Json2Type(const Json::Value& value, OnsOnsMessageGetByKeyOnsRestMessageDoType* item) {
  ...
  if(value.isMember("PropertyList") && value["PropertyList"].isMember("MessageProperty")) {
    Json2Array<OnsOnsMessageGetByKeyMessagePropertyType>(value["PropertyList"]["MessageProperty"], &item->property_list);
  }
}
void Json2Type(const Json::Value& value, OnsOnsMessageGetByKeyResponseType* item) {
  ...
  if(value.isMember("Data") && value["Data"].isMember("OnsRestMessageDo")) {
    Json2Array<OnsOnsMessageGetByKeyOnsRestMessageDoType>(value["Data"]["OnsRestMessageDo"], &item->data);
  }
}
}

int Ons::OnsMessageGetByKey(const OnsOnsMessageGetByKeyRequestType& req,
                      OnsOnsMessageGetByKeyResponseType* response,
