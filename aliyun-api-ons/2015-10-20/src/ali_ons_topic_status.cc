...
void Json2Type(const Json::Value& value, OnsTopicStatusTopicQueueOffsetType* item);
void Json2Type(const Json::Value& value, OnsTopicStatusDataType* item);
void Json2Type(const Json::Value& value, OnsTopicStatusResponseType* item);
...
void Json2Type(const Json::Value& value, OnsTopicStatusDataType* item) {
  ...
  if(value.isMember("OffsetTable") && value["OffsetTable"].isMember("TopicQueueOffset")) {
    Json2Array<OnsTopicStatusTopicQueueOffsetType>(value["OffsetTable"]["TopicQueueOffset"], &item->offset_table);
  }
}
void Json2Type(const Json::Value& value, OnsTopicStatusResponseType* item) {
...
int Ons::OnsTopicStatus(const OnsTopicStatusRequestType& req,
                      OnsTopicStatusResponseType* response,
