...
void Json2Type(const Json::Value& value, OnsOnsWarnAdminResponseType* item);
...
int Ons::OnsWarnAdmin(const OnsOnsWarnAdminRequestType& req,
                      OnsOnsWarnAdminResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","OnsWarnAdmin");
