...
void Json2Type(const Json::Value& value, OnsTopicListPublishInfoDoType* item);
void Json2Type(const Json::Value& value, OnsTopicListResponseType* item);
...
void Json2Type(const Json::Value& value, OnsTopicListResponseType* item) {
  ...
  if(value.isMember("Data") && value["Data"].isMember("PublishInfoDo")) {
    Json2Array<OnsTopicListPublishInfoDoType>(value["Data"]["PublishInfoDo"], &item->data);
  }
}
}

int Ons::OnsTopicList(const OnsTopicListRequestType& req,
                      OnsTopicListResponseType* response,
