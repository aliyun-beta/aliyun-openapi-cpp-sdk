...
void Json2Type(const Json::Value& value, OnsOnsWarnCreateResponseType* item);
...
int Ons::OnsWarnCreate(const OnsOnsWarnCreateRequestType& req,
                      OnsOnsWarnCreateResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","OnsWarnCreate");
