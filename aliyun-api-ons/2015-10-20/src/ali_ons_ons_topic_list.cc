...
void Json2Type(const Json::Value& value, OnsOnsTopicListPublishInfoDoType* item);
void Json2Type(const Json::Value& value, OnsOnsTopicListResponseType* item);
...
void Json2Type(const Json::Value& value, OnsOnsTopicListResponseType* item) {
  ...
  if(value.isMember("Data") && value["Data"].isMember("PublishInfoDo")) {
    Json2Array<OnsOnsTopicListPublishInfoDoType>(value["Data"]["PublishInfoDo"], &item->data);
  }
}
}

int Ons::OnsTopicList(const OnsOnsTopicListRequestType& req,
                      OnsOnsTopicListResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","OnsTopicList");
