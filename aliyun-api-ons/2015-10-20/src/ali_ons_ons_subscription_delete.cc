...
void Json2Type(const Json::Value& value, OnsOnsSubscriptionDeleteResponseType* item);
...
int Ons::OnsSubscriptionDelete(const OnsOnsSubscriptionDeleteRequestType& req,
                      OnsOnsSubscriptionDeleteResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","OnsSubscriptionDelete");
