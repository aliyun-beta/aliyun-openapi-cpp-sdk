...
void Json2Type(const Json::Value& value, OnsSubscriptionListSubscribeInfoDoType* item);
void Json2Type(const Json::Value& value, OnsSubscriptionListResponseType* item);
...
void Json2Type(const Json::Value& value, OnsSubscriptionListResponseType* item) {
  ...
  if(value.isMember("Data") && value["Data"].isMember("SubscribeInfoDo")) {
    Json2Array<OnsSubscriptionListSubscribeInfoDoType>(value["Data"]["SubscribeInfoDo"], &item->data);
  }
}
}

int Ons::OnsSubscriptionList(const OnsSubscriptionListRequestType& req,
                      OnsSubscriptionListResponseType* response,
