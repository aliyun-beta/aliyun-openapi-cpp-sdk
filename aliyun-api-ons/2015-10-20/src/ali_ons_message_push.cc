...
void Json2Type(const Json::Value& value, OnsMessagePushResponseType* item);
...
int Ons::OnsMessagePush(const OnsMessagePushRequestType& req,
                      OnsMessagePushResponseType* response,
