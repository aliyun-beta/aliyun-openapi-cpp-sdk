...
void Json2Type(const Json::Value& value, OnsWarnAdminResponseType* item);
...
int Ons::OnsWarnAdmin(const OnsWarnAdminRequestType& req,
                      OnsWarnAdminResponseType* response,
