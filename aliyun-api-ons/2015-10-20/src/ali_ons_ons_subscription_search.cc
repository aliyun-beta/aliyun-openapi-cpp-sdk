...
void Json2Type(const Json::Value& value, OnsOnsSubscriptionSearchSubscribeInfoDoType* item);
void Json2Type(const Json::Value& value, OnsOnsSubscriptionSearchResponseType* item);
...
void Json2Type(const Json::Value& value, OnsOnsSubscriptionSearchResponseType* item) {
  ...
  if(value.isMember("Data") && value["Data"].isMember("SubscribeInfoDo")) {
    Json2Array<OnsOnsSubscriptionSearchSubscribeInfoDoType>(value["Data"]["SubscribeInfoDo"], &item->data);
  }
}
}

int Ons::OnsSubscriptionSearch(const OnsOnsSubscriptionSearchRequestType& req,
                      OnsOnsSubscriptionSearchResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","OnsSubscriptionSearch");
  ...
  if(!req.search.empty()) {
    req_rpc->AddRequestQuery("Search", req.search);
  }
