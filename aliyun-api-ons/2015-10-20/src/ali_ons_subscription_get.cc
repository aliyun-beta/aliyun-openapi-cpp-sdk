...
void Json2Type(const Json::Value& value, OnsSubscriptionGetSubscribeInfoDoType* item);
void Json2Type(const Json::Value& value, OnsSubscriptionGetResponseType* item);
...
void Json2Type(const Json::Value& value, OnsSubscriptionGetResponseType* item) {
  ...
  if(value.isMember("Data") && value["Data"].isMember("SubscribeInfoDo")) {
    Json2Array<OnsSubscriptionGetSubscribeInfoDoType>(value["Data"]["SubscribeInfoDo"], &item->data);
  }
}
}

int Ons::OnsSubscriptionGet(const OnsSubscriptionGetRequestType& req,
                      OnsSubscriptionGetResponseType* response,
