...
void Json2Type(const Json::Value& value, OnsSubscriptionSearchSubscribeInfoDoType* item);
void Json2Type(const Json::Value& value, OnsSubscriptionSearchResponseType* item);
...
void Json2Type(const Json::Value& value, OnsSubscriptionSearchResponseType* item) {
  ...
  if(value.isMember("Data") && value["Data"].isMember("SubscribeInfoDo")) {
    Json2Array<OnsSubscriptionSearchSubscribeInfoDoType>(value["Data"]["SubscribeInfoDo"], &item->data);
  }
}
}

int Ons::OnsSubscriptionSearch(const OnsSubscriptionSearchRequestType& req,
                      OnsSubscriptionSearchResponseType* response,
