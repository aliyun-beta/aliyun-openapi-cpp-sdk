...
void Json2Type(const Json::Value& value, OnsOnsTopicGetPublishInfoDoType* item);
void Json2Type(const Json::Value& value, OnsOnsTopicGetResponseType* item);
...
void Json2Type(const Json::Value& value, OnsOnsTopicGetResponseType* item) {
  ...
  if(value.isMember("Data") && value["Data"].isMember("PublishInfoDo")) {
    Json2Array<OnsOnsTopicGetPublishInfoDoType>(value["Data"]["PublishInfoDo"], &item->data);
  }
}
}

int Ons::OnsTopicGet(const OnsOnsTopicGetRequestType& req,
                      OnsOnsTopicGetResponseType* response,
