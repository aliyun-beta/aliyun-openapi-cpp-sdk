...
void Json2Type(const Json::Value& value, OnsOnsConsumerAccumulateConsumeQueueOffsetType* item);
void Json2Type(const Json::Value& value, OnsOnsConsumerAccumulateDetailInTopicDoType* item);
void Json2Type(const Json::Value& value, OnsOnsConsumerAccumulateDataType* item);
void Json2Type(const Json::Value& value, OnsOnsConsumerAccumulateResponseType* item);
...
void Json2Type(const Json::Value& value, OnsOnsConsumerAccumulateDetailInTopicDoType* item) {
  ...
  if(value.isMember("OffsetList") && value["OffsetList"].isMember("ConsumeQueueOffset")) {
    Json2Array<OnsOnsConsumerAccumulateConsumeQueueOffsetType>(value["OffsetList"]["ConsumeQueueOffset"], &item->offset_list);
  }
}
void Json2Type(const Json::Value& value, OnsOnsConsumerAccumulateDataType* item) {
  ...
  if(value.isMember("DetailInTopicList") && value["DetailInTopicList"].isMember("DetailInTopicDo")) {
    Json2Array<OnsOnsConsumerAccumulateDetailInTopicDoType>(value["DetailInTopicList"]["DetailInTopicDo"], &item->detail_in_topic_list);
  }
}
void Json2Type(const Json::Value& value, OnsOnsConsumerAccumulateResponseType* item) {
...
int Ons::OnsConsumerAccumulate(const OnsOnsConsumerAccumulateRequestType& req,
                      OnsOnsConsumerAccumulateResponseType* response,
