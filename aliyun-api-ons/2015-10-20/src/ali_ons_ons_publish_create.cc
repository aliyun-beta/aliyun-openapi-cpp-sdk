...
void Json2Type(const Json::Value& value, OnsOnsPublishCreateResponseType* item);
...
int Ons::OnsPublishCreate(const OnsOnsPublishCreateRequestType& req,
                      OnsOnsPublishCreateResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","OnsPublishCreate");
