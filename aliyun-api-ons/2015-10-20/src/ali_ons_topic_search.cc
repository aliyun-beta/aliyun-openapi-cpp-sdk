...
void Json2Type(const Json::Value& value, OnsTopicSearchPublishInfoDoType* item);
void Json2Type(const Json::Value& value, OnsTopicSearchResponseType* item);
...
void Json2Type(const Json::Value& value, OnsTopicSearchResponseType* item) {
  ...
  if(value.isMember("Data") && value["Data"].isMember("PublishInfoDo")) {
    Json2Array<OnsTopicSearchPublishInfoDoType>(value["Data"]["PublishInfoDo"], &item->data);
  }
}
}

int Ons::OnsTopicSearch(const OnsTopicSearchRequestType& req,
                      OnsTopicSearchResponseType* response,
