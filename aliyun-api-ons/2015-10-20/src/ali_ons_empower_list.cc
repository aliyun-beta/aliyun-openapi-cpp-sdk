...
void Json2Type(const Json::Value& value, OnsEmpowerListAuthOwnerInfoDoType* item);
void Json2Type(const Json::Value& value, OnsEmpowerListResponseType* item);
...
void Json2Type(const Json::Value& value, OnsEmpowerListResponseType* item) {
  ...
  if(value.isMember("Data") && value["Data"].isMember("AuthOwnerInfoDo")) {
    Json2Array<OnsEmpowerListAuthOwnerInfoDoType>(value["Data"]["AuthOwnerInfoDo"], &item->data);
  }
}
}

int Ons::OnsEmpowerList(const OnsEmpowerListRequestType& req,
                      OnsEmpowerListResponseType* response,
