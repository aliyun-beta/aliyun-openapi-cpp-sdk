...
void Json2Type(const Json::Value& value, OnsEmpowerCreateResponseType* item);
...
int Ons::OnsEmpowerCreate(const OnsEmpowerCreateRequestType& req,
                      OnsEmpowerCreateResponseType* response,
