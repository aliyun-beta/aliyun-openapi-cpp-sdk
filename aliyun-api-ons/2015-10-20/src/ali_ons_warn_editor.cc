...
void Json2Type(const Json::Value& value, OnsWarnEditorResponseType* item);
...
int Ons::OnsWarnEditor(const OnsWarnEditorRequestType& req,
                      OnsWarnEditorResponseType* response,
