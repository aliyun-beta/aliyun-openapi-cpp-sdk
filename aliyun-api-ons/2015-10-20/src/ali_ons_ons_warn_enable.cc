...
void Json2Type(const Json::Value& value, OnsOnsWarnEnableResponseType* item);
...
int Ons::OnsWarnEnable(const OnsOnsWarnEnableRequestType& req,
                      OnsOnsWarnEnableResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","OnsWarnEnable");
