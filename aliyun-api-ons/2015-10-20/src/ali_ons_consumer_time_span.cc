...
void Json2Type(const Json::Value& value, OnsConsumerTimeSpanMessageQueueType* item);
void Json2Type(const Json::Value& value, OnsConsumerTimeSpanQueueTimeSpanType* item);
void Json2Type(const Json::Value& value, OnsConsumerTimeSpanDataType* item);
void Json2Type(const Json::Value& value, OnsConsumerTimeSpanResponseType* item);
...
void Json2Type(const Json::Value& value, OnsConsumerTimeSpanDataType* item) {
  ...
  if(value.isMember("QueueTimeSpans") && value["QueueTimeSpans"].isMember("QueueTimeSpan")) {
    Json2Array<OnsConsumerTimeSpanQueueTimeSpanType>(value["QueueTimeSpans"]["QueueTimeSpan"], &item->queue_time_spans);
  }
}
void Json2Type(const Json::Value& value, OnsConsumerTimeSpanResponseType* item) {
...
int Ons::OnsConsumerTimeSpan(const OnsConsumerTimeSpanRequestType& req,
                      OnsConsumerTimeSpanResponseType* response,
