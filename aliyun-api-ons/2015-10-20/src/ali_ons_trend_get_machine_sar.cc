...
void Json2Type(const Json::Value& value, OnsTrendGetMachineSarStatsDataDoType* item);
void Json2Type(const Json::Value& value, OnsTrendGetMachineSarDataType* item);
void Json2Type(const Json::Value& value, OnsTrendGetMachineSarResponseType* item);
...
void Json2Type(const Json::Value& value, OnsTrendGetMachineSarDataType* item) {
  ...
  if(value.isMember("Records") && value["Records"].isMember("StatsDataDo")) {
    Json2Array<OnsTrendGetMachineSarStatsDataDoType>(value["Records"]["StatsDataDo"], &item->records);
  }
}
void Json2Type(const Json::Value& value, OnsTrendGetMachineSarResponseType* item) {
...
int Ons::OnsTrendGetMachineSar(const OnsTrendGetMachineSarRequestType& req,
                      OnsTrendGetMachineSarResponseType* response,
