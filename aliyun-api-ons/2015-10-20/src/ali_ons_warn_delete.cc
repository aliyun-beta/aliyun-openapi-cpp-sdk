...
void Json2Type(const Json::Value& value, OnsWarnDeleteResponseType* item);
...
int Ons::OnsWarnDelete(const OnsWarnDeleteRequestType& req,
                      OnsWarnDeleteResponseType* response,
