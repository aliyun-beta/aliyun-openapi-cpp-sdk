...
void Json2Type(const Json::Value& value, OnsMessageSendResponseType* item);
...
int Ons::OnsMessageSend(const OnsMessageSendRequestType& req,
                      OnsMessageSendResponseType* response,
