...
void Json2Type(const Json::Value& value, OnsConsumerGetConnectionConnectionDoType* item);
void Json2Type(const Json::Value& value, OnsConsumerGetConnectionDataType* item);
void Json2Type(const Json::Value& value, OnsConsumerGetConnectionResponseType* item);
...
void Json2Type(const Json::Value& value, OnsConsumerGetConnectionDataType* item) {
  if(value.isMember("ConnectionList") && value["ConnectionList"].isMember("ConnectionDo")) {
    Json2Array<OnsConsumerGetConnectionConnectionDoType>(value["ConnectionList"]["ConnectionDo"], &item->connection_list);
  }
}
void Json2Type(const Json::Value& value, OnsConsumerGetConnectionResponseType* item) {
...
int Ons::OnsConsumerGetConnection(const OnsConsumerGetConnectionRequestType& req,
                      OnsConsumerGetConnectionResponseType* response,
