...
void Json2Type(const Json::Value& value, OnsOnsTrendTopicInputTpsStatsDataDoType* item);
void Json2Type(const Json::Value& value, OnsOnsTrendTopicInputTpsDataType* item);
void Json2Type(const Json::Value& value, OnsOnsTrendTopicInputTpsResponseType* item);
...
void Json2Type(const Json::Value& value, OnsOnsTrendTopicInputTpsDataType* item) {
  ...
  if(value.isMember("Records") && value["Records"].isMember("StatsDataDo")) {
    Json2Array<OnsOnsTrendTopicInputTpsStatsDataDoType>(value["Records"]["StatsDataDo"], &item->records);
  }
}
void Json2Type(const Json::Value& value, OnsOnsTrendTopicInputTpsResponseType* item) {
