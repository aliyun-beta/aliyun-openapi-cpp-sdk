...
void Json2Type(const Json::Value& value, OnsOnsWarnListYunContactType* item);
void Json2Type(const Json::Value& value, OnsOnsWarnListWarnViewDOType* item);
void Json2Type(const Json::Value& value, OnsOnsWarnListResponseType* item);
...
void Json2Type(const Json::Value& value, OnsOnsWarnListWarnViewDOType* item) {
  ...
  if(value.isMember("contacts") && value["contacts"].isMember("YunContact")) {
    Json2Array<OnsOnsWarnListYunContactType>(value["contacts"]["YunContact"], &item->contacts);
  }
}
void Json2Type(const Json::Value& value, OnsOnsWarnListResponseType* item) {
  ...
  if(value.isMember("Data") && value["Data"].isMember("WarnViewDO")) {
    Json2Array<OnsOnsWarnListWarnViewDOType>(value["Data"]["WarnViewDO"], &item->data);
  }
}
}

int Ons::OnsWarnList(const OnsOnsWarnListRequestType& req,
                      OnsOnsWarnListResponseType* response,
