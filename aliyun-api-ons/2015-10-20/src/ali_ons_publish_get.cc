...
void Json2Type(const Json::Value& value, OnsPublishGetPublishInfoDoType* item);
void Json2Type(const Json::Value& value, OnsPublishGetResponseType* item);
...
void Json2Type(const Json::Value& value, OnsPublishGetResponseType* item) {
  ...
  if(value.isMember("Data") && value["Data"].isMember("PublishInfoDo")) {
    Json2Array<OnsPublishGetPublishInfoDoType>(value["Data"]["PublishInfoDo"], &item->data);
  }
}
}

int Ons::OnsPublishGet(const OnsPublishGetRequestType& req,
                      OnsPublishGetResponseType* response,
