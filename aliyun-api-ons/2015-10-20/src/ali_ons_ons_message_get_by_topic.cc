...
void Json2Type(const Json::Value& value, OnsOnsMessageGetByTopicMessagePropertyType* item);
void Json2Type(const Json::Value& value, OnsOnsMessageGetByTopicOnsRestMessageDoType* item);
void Json2Type(const Json::Value& value, OnsOnsMessageGetByTopicResponseType* item);
...
void Json2Type(const Json::Value& value, OnsOnsMessageGetByTopicOnsRestMessageDoType* item) {
  ...
  if(value.isMember("PropertyList") && value["PropertyList"].isMember("MessageProperty")) {
    Json2Array<OnsOnsMessageGetByTopicMessagePropertyType>(value["PropertyList"]["MessageProperty"], &item->property_list);
  }
}
void Json2Type(const Json::Value& value, OnsOnsMessageGetByTopicResponseType* item) {
  ...
  if(value.isMember("Data") && value["Data"].isMember("OnsRestMessageDo")) {
    Json2Array<OnsOnsMessageGetByTopicOnsRestMessageDoType>(value["Data"]["OnsRestMessageDo"], &item->data);
  }
}
}

int Ons::OnsMessageGetByTopic(const OnsOnsMessageGetByTopicRequestType& req,
                      OnsOnsMessageGetByTopicResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","OnsMessageGetByTopic");
