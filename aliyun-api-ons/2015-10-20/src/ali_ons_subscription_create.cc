...
void Json2Type(const Json::Value& value, OnsSubscriptionCreateResponseType* item);
...
int Ons::OnsSubscriptionCreate(const OnsSubscriptionCreateRequestType& req,
                      OnsSubscriptionCreateResponseType* response,
