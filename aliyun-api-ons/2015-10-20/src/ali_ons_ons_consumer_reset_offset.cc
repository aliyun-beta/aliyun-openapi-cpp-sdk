...
void Json2Type(const Json::Value& value, OnsOnsConsumerResetOffsetResponseType* item);
...
int Ons::OnsConsumerResetOffset(const OnsOnsConsumerResetOffsetRequestType& req,
                      OnsOnsConsumerResetOffsetResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","OnsConsumerResetOffset");
  ...
  if(!req.reset_timestamp.empty()) {
    req_rpc->AddRequestQuery("ResetTimestamp", req.reset_timestamp);
  }
