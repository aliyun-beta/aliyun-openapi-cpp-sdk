...
void Json2Type(const Json::Value& value, OnsTopicCreateResponseType* item);
...
int Ons::OnsTopicCreate(const OnsTopicCreateRequestType& req,
                      OnsTopicCreateResponseType* response,
