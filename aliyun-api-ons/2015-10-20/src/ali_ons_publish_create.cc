...
void Json2Type(const Json::Value& value, OnsPublishCreateResponseType* item);
...
int Ons::OnsPublishCreate(const OnsPublishCreateRequestType& req,
                      OnsPublishCreateResponseType* response,
