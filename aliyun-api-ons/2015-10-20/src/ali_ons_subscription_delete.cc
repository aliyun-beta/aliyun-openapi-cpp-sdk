...
void Json2Type(const Json::Value& value, OnsSubscriptionDeleteResponseType* item);
...
int Ons::OnsSubscriptionDelete(const OnsSubscriptionDeleteRequestType& req,
                      OnsSubscriptionDeleteResponseType* response,
