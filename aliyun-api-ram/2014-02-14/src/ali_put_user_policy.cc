...
void Json2Type(const Json::Value& value, PutUserPolicyResponseType* item);
...
int Ram::PutUserPolicy(const PutUserPolicyRequestType& req,
                      PutUserPolicyResponseType* response,
