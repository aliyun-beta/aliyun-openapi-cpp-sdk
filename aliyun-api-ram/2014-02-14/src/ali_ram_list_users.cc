...
void Json2Type(const Json::Value& value, RamListUsersUserType* item);
void Json2Type(const Json::Value& value, RamListUsersResponseType* item);
...
void Json2Type(const Json::Value& value, RamListUsersResponseType* item) {
  if(value.isMember("Users") && value["Users"].isMember("User")) {
    Json2Array<RamListUsersUserType>(value["Users"]["User"], &item->users);
  }
}
}
