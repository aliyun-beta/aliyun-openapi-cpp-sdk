...
void Json2Type(const Json::Value& value, GetUserPolicyResponseType* item);
...
int Ram::GetUserPolicy(const GetUserPolicyRequestType& req,
                      GetUserPolicyResponseType* response,
