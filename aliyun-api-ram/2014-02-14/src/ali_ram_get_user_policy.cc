...
void Json2Type(const Json::Value& value, RamGetUserPolicyResponseType* item);
...
int Ram::GetUserPolicy(const RamGetUserPolicyRequestType& req,
                      RamGetUserPolicyResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","GetUserPolicy");
