...
void Json2Type(const Json::Value& value, RamPutUserPolicyResponseType* item);
...
int Ram::PutUserPolicy(const RamPutUserPolicyRequestType& req,
                      RamPutUserPolicyResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","PutUserPolicy");
