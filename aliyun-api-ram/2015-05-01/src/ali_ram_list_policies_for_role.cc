...
void Json2Type(const Json::Value& value, RamListPoliciesForRolePolicyType* item);
void Json2Type(const Json::Value& value, RamListPoliciesForRoleResponseType* item);
...
void Json2Type(const Json::Value& value, RamListPoliciesForRoleResponseType* item) {
  if(value.isMember("Policies") && value["Policies"].isMember("Policy")) {
    Json2Array<RamListPoliciesForRolePolicyType>(value["Policies"]["Policy"], &item->policies);
  }
}
}

int Ram::ListPoliciesForRole(const RamListPoliciesForRoleRequestType& req,
                      RamListPoliciesForRoleResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","ListPoliciesForRole");
