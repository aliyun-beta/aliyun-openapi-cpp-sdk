...
void Json2Type(const Json::Value& value, RamCreatePolicyPolicyType* item);
void Json2Type(const Json::Value& value, RamCreatePolicyResponseType* item);
...
int Ram::CreatePolicy(const RamCreatePolicyRequestType& req,
                      RamCreatePolicyResponseType* response,
