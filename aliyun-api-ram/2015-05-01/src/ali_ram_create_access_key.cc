...
void Json2Type(const Json::Value& value, RamCreateAccessKeyAccessKeyType* item);
void Json2Type(const Json::Value& value, RamCreateAccessKeyResponseType* item);
...
int Ram::CreateAccessKey(const RamCreateAccessKeyRequestType& req,
                      RamCreateAccessKeyResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","CreateAccessKey");
