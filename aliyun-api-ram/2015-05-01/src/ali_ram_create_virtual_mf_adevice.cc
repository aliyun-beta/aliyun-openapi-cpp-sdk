...
void Json2Type(const Json::Value& value, RamCreateVirtualMFADeviceVirtualMFADeviceType* item);
void Json2Type(const Json::Value& value, RamCreateVirtualMFADeviceResponseType* item);
...
int Ram::CreateVirtualMFADevice(const RamCreateVirtualMFADeviceRequestType& req,
                      RamCreateVirtualMFADeviceResponseType* response,
