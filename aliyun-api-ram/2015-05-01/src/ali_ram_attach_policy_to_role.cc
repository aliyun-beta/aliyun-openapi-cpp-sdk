...
void Json2Type(const Json::Value& value, RamAttachPolicyToRoleResponseType* item);
...
int Ram::AttachPolicyToRole(const RamAttachPolicyToRoleRequestType& req,
                      RamAttachPolicyToRoleResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","AttachPolicyToRole");
