...
void Json2Type(const Json::Value& value, ListPoliciesPolicyType* item);
void Json2Type(const Json::Value& value, ListPoliciesResponseType* item);
...
void Json2Type(const Json::Value& value, ListPoliciesResponseType* item) {
  ...
  if(value.isMember("Policies") && value["Policies"].isMember("Policy")) {
    Json2Array<ListPoliciesPolicyType>(value["Policies"]["Policy"], &item->policies);
  }
}
}

int Ram::ListPolicies(const ListPoliciesRequestType& req,
                      ListPoliciesResponseType* response,
