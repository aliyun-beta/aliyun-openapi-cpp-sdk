...
void Json2Type(const Json::Value& value, CreateGroupGroupType* item);
void Json2Type(const Json::Value& value, CreateGroupResponseType* item);
...
int Ram::CreateGroup(const CreateGroupRequestType& req,
                      CreateGroupResponseType* response,
