...
void Json2Type(const Json::Value& value, DetachPolicyFromRoleResponseType* item);
...
int Ram::DetachPolicyFromRole(const DetachPolicyFromRoleRequestType& req,
                      DetachPolicyFromRoleResponseType* response,
