...
void Json2Type(const Json::Value& value, RamListPoliciesForGroupPolicyType* item);
void Json2Type(const Json::Value& value, RamListPoliciesForGroupResponseType* item);
...
void Json2Type(const Json::Value& value, RamListPoliciesForGroupResponseType* item) {
  if(value.isMember("Policies") && value["Policies"].isMember("Policy")) {
    Json2Array<RamListPoliciesForGroupPolicyType>(value["Policies"]["Policy"], &item->policies);
  }
}
}

int Ram::ListPoliciesForGroup(const RamListPoliciesForGroupRequestType& req,
                      RamListPoliciesForGroupResponseType* response,
