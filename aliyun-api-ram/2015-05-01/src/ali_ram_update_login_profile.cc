...
void Json2Type(const Json::Value& value, RamUpdateLoginProfileResponseType* item);
...
int Ram::UpdateLoginProfile(const RamUpdateLoginProfileRequestType& req,
                      RamUpdateLoginProfileResponseType* response,
