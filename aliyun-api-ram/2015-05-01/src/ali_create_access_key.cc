...
void Json2Type(const Json::Value& value, CreateAccessKeyAccessKeyType* item);
void Json2Type(const Json::Value& value, CreateAccessKeyResponseType* item);
...
int Ram::CreateAccessKey(const CreateAccessKeyRequestType& req,
                      CreateAccessKeyResponseType* response,
