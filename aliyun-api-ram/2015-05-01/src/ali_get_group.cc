...
void Json2Type(const Json::Value& value, GetGroupGroupType* item);
void Json2Type(const Json::Value& value, GetGroupResponseType* item);
...
int Ram::GetGroup(const GetGroupRequestType& req,
                      GetGroupResponseType* response,
