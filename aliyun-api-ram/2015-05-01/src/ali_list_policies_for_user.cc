...
void Json2Type(const Json::Value& value, ListPoliciesForUserPolicyType* item);
void Json2Type(const Json::Value& value, ListPoliciesForUserResponseType* item);
...
void Json2Type(const Json::Value& value, ListPoliciesForUserResponseType* item) {
  if(value.isMember("Policies") && value["Policies"].isMember("Policy")) {
    Json2Array<ListPoliciesForUserPolicyType>(value["Policies"]["Policy"], &item->policies);
  }
}
}

int Ram::ListPoliciesForUser(const ListPoliciesForUserRequestType& req,
                      ListPoliciesForUserResponseType* response,
