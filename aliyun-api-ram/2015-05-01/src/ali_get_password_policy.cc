...
void Json2Type(const Json::Value& value, GetPasswordPolicyPasswordPolicyType* item);
void Json2Type(const Json::Value& value, GetPasswordPolicyResponseType* item);
...
int Ram::GetPasswordPolicy(const GetPasswordPolicyRequestType& req,
                      GetPasswordPolicyResponseType* response,
