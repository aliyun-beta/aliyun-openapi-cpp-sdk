...
void Json2Type(const Json::Value& value, RamListPoliciesForUserPolicyType* item);
void Json2Type(const Json::Value& value, RamListPoliciesForUserResponseType* item);
...
void Json2Type(const Json::Value& value, RamListPoliciesForUserResponseType* item) {
  if(value.isMember("Policies") && value["Policies"].isMember("Policy")) {
    Json2Array<RamListPoliciesForUserPolicyType>(value["Policies"]["Policy"], &item->policies);
  }
}
}

int Ram::ListPoliciesForUser(const RamListPoliciesForUserRequestType& req,
                      RamListPoliciesForUserResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","ListPoliciesForUser");
