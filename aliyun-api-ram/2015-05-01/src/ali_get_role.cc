...
void Json2Type(const Json::Value& value, GetRoleRoleType* item);
void Json2Type(const Json::Value& value, GetRoleResponseType* item);
...
int Ram::GetRole(const GetRoleRequestType& req,
                      GetRoleResponseType* response,
