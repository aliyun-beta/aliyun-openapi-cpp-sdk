...
void Json2Type(const Json::Value& value, AttachPolicyToUserResponseType* item);
...
int Ram::AttachPolicyToUser(const AttachPolicyToUserRequestType& req,
                      AttachPolicyToUserResponseType* response,
