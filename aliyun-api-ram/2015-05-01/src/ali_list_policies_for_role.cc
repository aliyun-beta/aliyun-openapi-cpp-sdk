...
void Json2Type(const Json::Value& value, ListPoliciesForRolePolicyType* item);
void Json2Type(const Json::Value& value, ListPoliciesForRoleResponseType* item);
...
void Json2Type(const Json::Value& value, ListPoliciesForRoleResponseType* item) {
  if(value.isMember("Policies") && value["Policies"].isMember("Policy")) {
    Json2Array<ListPoliciesForRolePolicyType>(value["Policies"]["Policy"], &item->policies);
  }
}
}

int Ram::ListPoliciesForRole(const ListPoliciesForRoleRequestType& req,
                      ListPoliciesForRoleResponseType* response,
