...
void Json2Type(const Json::Value& value, CreateRoleRoleType* item);
void Json2Type(const Json::Value& value, CreateRoleResponseType* item);
...
int Ram::CreateRole(const CreateRoleRequestType& req,
                      CreateRoleResponseType* response,
