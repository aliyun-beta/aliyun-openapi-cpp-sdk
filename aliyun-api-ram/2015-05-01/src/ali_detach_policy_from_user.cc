...
void Json2Type(const Json::Value& value, DetachPolicyFromUserResponseType* item);
...
int Ram::DetachPolicyFromUser(const DetachPolicyFromUserRequestType& req,
                      DetachPolicyFromUserResponseType* response,
