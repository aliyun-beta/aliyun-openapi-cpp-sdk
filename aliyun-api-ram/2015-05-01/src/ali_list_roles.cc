...
void Json2Type(const Json::Value& value, ListRolesRoleType* item);
void Json2Type(const Json::Value& value, ListRolesResponseType* item);
...
void Json2Type(const Json::Value& value, ListRolesResponseType* item) {
  ...
  if(value.isMember("Roles") && value["Roles"].isMember("Role")) {
    Json2Array<ListRolesRoleType>(value["Roles"]["Role"], &item->roles);
  }
}
}

int Ram::ListRoles(const ListRolesRequestType& req,
                      ListRolesResponseType* response,
