...
void Json2Type(const Json::Value& value, RamAttachPolicyToUserResponseType* item);
...
int Ram::AttachPolicyToUser(const RamAttachPolicyToUserRequestType& req,
                      RamAttachPolicyToUserResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","AttachPolicyToUser");
