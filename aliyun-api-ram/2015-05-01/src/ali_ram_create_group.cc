...
void Json2Type(const Json::Value& value, RamCreateGroupGroupType* item);
void Json2Type(const Json::Value& value, RamCreateGroupResponseType* item);
...
int Ram::CreateGroup(const RamCreateGroupRequestType& req,
                      RamCreateGroupResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","CreateGroup");
