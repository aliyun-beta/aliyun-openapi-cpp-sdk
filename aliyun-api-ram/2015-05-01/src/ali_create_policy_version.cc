...
void Json2Type(const Json::Value& value, CreatePolicyVersionPolicyVersionType* item);
void Json2Type(const Json::Value& value, CreatePolicyVersionResponseType* item);
...
int Ram::CreatePolicyVersion(const CreatePolicyVersionRequestType& req,
                      CreatePolicyVersionResponseType* response,
