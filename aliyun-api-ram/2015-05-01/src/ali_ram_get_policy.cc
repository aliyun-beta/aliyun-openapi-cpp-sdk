...
void Json2Type(const Json::Value& value, RamGetPolicyPolicyType* item);
void Json2Type(const Json::Value& value, RamGetPolicyResponseType* item);
...
int Ram::GetPolicy(const RamGetPolicyRequestType& req,
                      RamGetPolicyResponseType* response,
