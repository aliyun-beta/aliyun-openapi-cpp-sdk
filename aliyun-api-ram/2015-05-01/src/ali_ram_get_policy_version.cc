...
void Json2Type(const Json::Value& value, RamGetPolicyVersionPolicyVersionType* item);
void Json2Type(const Json::Value& value, RamGetPolicyVersionResponseType* item);
...
int Ram::GetPolicyVersion(const RamGetPolicyVersionRequestType& req,
                      RamGetPolicyVersionResponseType* response,
