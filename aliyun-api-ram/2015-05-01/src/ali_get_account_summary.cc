...
void Json2Type(const Json::Value& value, GetAccountSummarySummaryMapType* item);
void Json2Type(const Json::Value& value, GetAccountSummaryResponseType* item);
...
int Ram::GetAccountSummary(const GetAccountSummaryRequestType& req,
                      GetAccountSummaryResponseType* response,
