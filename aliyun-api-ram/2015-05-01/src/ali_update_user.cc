...
void Json2Type(const Json::Value& value, UpdateUserUserType* item);
void Json2Type(const Json::Value& value, UpdateUserResponseType* item);
...
int Ram::UpdateUser(const UpdateUserRequestType& req,
                      UpdateUserResponseType* response,
