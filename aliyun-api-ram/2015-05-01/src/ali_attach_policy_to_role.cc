...
void Json2Type(const Json::Value& value, AttachPolicyToRoleResponseType* item);
...
int Ram::AttachPolicyToRole(const AttachPolicyToRoleRequestType& req,
                      AttachPolicyToRoleResponseType* response,
