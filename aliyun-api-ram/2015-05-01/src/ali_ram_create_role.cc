...
void Json2Type(const Json::Value& value, RamCreateRoleRoleType* item);
void Json2Type(const Json::Value& value, RamCreateRoleResponseType* item);
...
int Ram::CreateRole(const RamCreateRoleRequestType& req,
                      RamCreateRoleResponseType* response,
