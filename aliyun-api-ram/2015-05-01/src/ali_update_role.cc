...
void Json2Type(const Json::Value& value, UpdateRoleRoleType* item);
void Json2Type(const Json::Value& value, UpdateRoleResponseType* item);
...
int Ram::UpdateRole(const UpdateRoleRequestType& req,
                      UpdateRoleResponseType* response,
