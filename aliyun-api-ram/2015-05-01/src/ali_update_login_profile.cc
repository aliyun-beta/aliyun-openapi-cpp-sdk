...
void Json2Type(const Json::Value& value, UpdateLoginProfileResponseType* item);
...
int Ram::UpdateLoginProfile(const UpdateLoginProfileRequestType& req,
                      UpdateLoginProfileResponseType* response,
