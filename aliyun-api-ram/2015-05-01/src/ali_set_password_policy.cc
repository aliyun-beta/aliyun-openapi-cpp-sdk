...
void Json2Type(const Json::Value& value, SetPasswordPolicyPasswordPolicyType* item);
void Json2Type(const Json::Value& value, SetPasswordPolicyResponseType* item);
...
int Ram::SetPasswordPolicy(const SetPasswordPolicyRequestType& req,
                      SetPasswordPolicyResponseType* response,
