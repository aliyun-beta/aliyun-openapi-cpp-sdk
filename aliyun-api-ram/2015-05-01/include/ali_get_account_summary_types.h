#ifndef ALI_GET_ACCOUNT_SUMMARY_TYPESH
#define ALI_GET_ACCOUNT_SUMMARY_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct GetAccountSummaryRequestType {
};
struct GetAccountSummarySummaryMapType {
  int users_quota;
  int users;
...
struct GetAccountSummaryResponseType {
  GetAccountSummarySummaryMapType summary_map;
};
} // end namespace
#endif
