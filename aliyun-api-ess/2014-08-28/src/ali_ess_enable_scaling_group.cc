...
void Json2Type(const Json::Value& value, EssEnableScalingGroupResponseType* item);
...
int Ess::EnableScalingGroup(const EssEnableScalingGroupRequestType& req,
                      EssEnableScalingGroupResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","EnableScalingGroup");
  ...
  if(!req.active_scaling_configuration_id.empty()) {
    req_rpc->AddRequestQuery("ActiveScalingConfigurationId", req.active_scaling_configuration_id);
  }
