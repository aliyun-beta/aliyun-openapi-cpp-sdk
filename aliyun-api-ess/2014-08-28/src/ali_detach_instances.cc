...
void Json2Type(const Json::Value& value, DetachInstancesResponseType* item);
...
int Ess::DetachInstances(const DetachInstancesRequestType& req,
                      DetachInstancesResponseType* response,
