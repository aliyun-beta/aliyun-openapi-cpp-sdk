...
void Json2Type(const Json::Value& value, DescribeScalingInstancesScalingInstanceType* item);
void Json2Type(const Json::Value& value, DescribeScalingInstancesResponseType* item);
...
void Json2Type(const Json::Value& value, DescribeScalingInstancesResponseType* item) {
  ...
  if(value.isMember("ScalingInstances") && value["ScalingInstances"].isMember("ScalingInstance")) {
    Json2Array<DescribeScalingInstancesScalingInstanceType>(value["ScalingInstances"]["ScalingInstance"], &item->scaling_instances);
  }
}
}

int Ess::DescribeScalingInstances(const DescribeScalingInstancesRequestType& req,
                      DescribeScalingInstancesResponseType* response,
