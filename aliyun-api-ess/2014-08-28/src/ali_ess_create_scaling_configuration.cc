...
void Json2Type(const Json::Value& value, EssCreateScalingConfigurationResponseType* item);
...
int Ess::CreateScalingConfiguration(const EssCreateScalingConfigurationRequestType& req,
                      EssCreateScalingConfigurationResponseType* response,
