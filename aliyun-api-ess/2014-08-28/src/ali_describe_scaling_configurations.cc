...
void Json2Type(const Json::Value& value, DescribeScalingConfigurationsDataDiskType* item);
void Json2Type(const Json::Value& value, DescribeScalingConfigurationsScalingConfigurationType* item);
void Json2Type(const Json::Value& value, DescribeScalingConfigurationsResponseType* item);
...
void Json2Type(const Json::Value& value, DescribeScalingConfigurationsScalingConfigurationType* item) {
  ...
  if(value.isMember("DataDisks") && value["DataDisks"].isMember("DataDisk")) {
    Json2Array<DescribeScalingConfigurationsDataDiskType>(value["DataDisks"]["DataDisk"], &item->data_disks);
  }
}
void Json2Type(const Json::Value& value, DescribeScalingConfigurationsResponseType* item) {
  ...
  if(value.isMember("ScalingConfigurations") && value["ScalingConfigurations"].isMember("ScalingConfiguration")) {
    Json2Array<DescribeScalingConfigurationsScalingConfigurationType>(value["ScalingConfigurations"]["ScalingConfiguration"], &item->scaling_configurations);
  }
}
}

int Ess::DescribeScalingConfigurations(const DescribeScalingConfigurationsRequestType& req,
                      DescribeScalingConfigurationsResponseType* response,
