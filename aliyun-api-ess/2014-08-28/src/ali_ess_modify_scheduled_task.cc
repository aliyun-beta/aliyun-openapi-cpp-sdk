...
void Json2Type(const Json::Value& value, EssModifyScheduledTaskResponseType* item);
...
int Ess::ModifyScheduledTask(const EssModifyScheduledTaskRequestType& req,
                      EssModifyScheduledTaskResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","ModifyScheduledTask");
  ...
  if(!req.scheduled_task_id.empty()) {
    req_rpc->AddRequestQuery("ScheduledTaskId", req.scheduled_task_id);
  }
