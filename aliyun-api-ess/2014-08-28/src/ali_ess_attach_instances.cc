...
void Json2Type(const Json::Value& value, EssAttachInstancesResponseType* item);
...
int Ess::AttachInstances(const EssAttachInstancesRequestType& req,
                      EssAttachInstancesResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","AttachInstances");
