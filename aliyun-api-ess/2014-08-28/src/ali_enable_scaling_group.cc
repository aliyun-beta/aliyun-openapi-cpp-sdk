...
void Json2Type(const Json::Value& value, EnableScalingGroupResponseType* item);
...
int Ess::EnableScalingGroup(const EnableScalingGroupRequestType& req,
                      EnableScalingGroupResponseType* response,
