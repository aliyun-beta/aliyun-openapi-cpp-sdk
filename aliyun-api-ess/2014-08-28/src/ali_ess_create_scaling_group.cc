...
void Json2Type(const Json::Value& value, EssCreateScalingGroupResponseType* item);
...
int Ess::CreateScalingGroup(const EssCreateScalingGroupRequestType& req,
                      EssCreateScalingGroupResponseType* response,
