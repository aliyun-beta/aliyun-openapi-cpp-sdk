...
void Json2Type(const Json::Value& value, EssDescribeScalingGroupsScalingGroupType* item);
void Json2Type(const Json::Value& value, EssDescribeScalingGroupsResponseType* item);
...
void Json2Type(const Json::Value& value, EssDescribeScalingGroupsResponseType* item) {
  ...
  if(value.isMember("ScalingGroups") && value["ScalingGroups"].isMember("ScalingGroup")) {
    Json2Array<EssDescribeScalingGroupsScalingGroupType>(value["ScalingGroups"]["ScalingGroup"], &item->scaling_groups);
  }
}
}

int Ess::DescribeScalingGroups(const EssDescribeScalingGroupsRequestType& req,
                      EssDescribeScalingGroupsResponseType* response,
