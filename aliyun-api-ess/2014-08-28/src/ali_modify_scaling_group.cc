...
void Json2Type(const Json::Value& value, ModifyScalingGroupResponseType* item);
...
int Ess::ModifyScalingGroup(const ModifyScalingGroupRequestType& req,
                      ModifyScalingGroupResponseType* response,
