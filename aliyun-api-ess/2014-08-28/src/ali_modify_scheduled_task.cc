...
void Json2Type(const Json::Value& value, ModifyScheduledTaskResponseType* item);
...
int Ess::ModifyScheduledTask(const ModifyScheduledTaskRequestType& req,
                      ModifyScheduledTaskResponseType* response,
