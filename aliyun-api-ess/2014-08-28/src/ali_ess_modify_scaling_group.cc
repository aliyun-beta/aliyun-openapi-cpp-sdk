...
void Json2Type(const Json::Value& value, EssModifyScalingGroupResponseType* item);
...
int Ess::ModifyScalingGroup(const EssModifyScalingGroupRequestType& req,
                      EssModifyScalingGroupResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","ModifyScalingGroup");
