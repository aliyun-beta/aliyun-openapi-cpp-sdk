...
void Json2Type(const Json::Value& value, EssDescribeScalingRulesScalingRuleType* item);
void Json2Type(const Json::Value& value, EssDescribeScalingRulesResponseType* item);
...
void Json2Type(const Json::Value& value, EssDescribeScalingRulesResponseType* item) {
  ...
  if(value.isMember("ScalingRules") && value["ScalingRules"].isMember("ScalingRule")) {
    Json2Array<EssDescribeScalingRulesScalingRuleType>(value["ScalingRules"]["ScalingRule"], &item->scaling_rules);
  }
}
}
