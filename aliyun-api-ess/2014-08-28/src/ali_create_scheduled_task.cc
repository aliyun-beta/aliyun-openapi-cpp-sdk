...
void Json2Type(const Json::Value& value, CreateScheduledTaskResponseType* item);
...
int Ess::CreateScheduledTask(const CreateScheduledTaskRequestType& req,
                      CreateScheduledTaskResponseType* response,
