...
void Json2Type(const Json::Value& value, AttachInstancesResponseType* item);
...
int Ess::AttachInstances(const AttachInstancesRequestType& req,
                      AttachInstancesResponseType* response,
