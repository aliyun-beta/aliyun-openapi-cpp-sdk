...
void Json2Type(const Json::Value& value, EssDescribeScalingActivitiesScalingActivityType* item);
...
int Ess::DescribeScalingActivities(const EssDescribeScalingActivitiesRequestType& req,
                      EssDescribeScalingActivitiesResponseType* response,
