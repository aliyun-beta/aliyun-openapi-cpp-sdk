#ifndef ALI_CREATE_SCHEDULED_TASK_TYPESH
#define ALI_CREATE_SCHEDULED_TASK_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct CreateScheduledTaskRequestType {
  std::string owner_id;
...
struct CreateScheduledTaskResponseType {
