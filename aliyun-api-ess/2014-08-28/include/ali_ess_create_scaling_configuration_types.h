#ifndef ALI_ESS_CREATE_SCALING_CONFIGURATION_TYPESH
#define ALI_ESS_CREATE_SCALING_CONFIGURATION_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct EssCreateScalingConfigurationRequestType {
  std::string owner_id;
...
struct EssCreateScalingConfigurationResponseType {
