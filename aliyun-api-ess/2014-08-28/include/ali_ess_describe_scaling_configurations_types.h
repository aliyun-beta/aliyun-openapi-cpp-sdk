#ifndef ALI_ESS_DESCRIBE_SCALING_CONFIGURATIONS_TYPESH
#define ALI_ESS_DESCRIBE_SCALING_CONFIGURATIONS_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct EssDescribeScalingConfigurationsRequestType {
  std::string owner_id;
...
struct EssDescribeScalingConfigurationsDataDiskType {
  int size;
  std::string category;
  std::string snapshot_id;
  std::string device;
};
struct EssDescribeScalingConfigurationsScalingConfigurationType {
  std::vector<EssDescribeScalingConfigurationsDataDiskType> data_disks;
...
struct EssDescribeScalingConfigurationsResponseType {
  std::vector<EssDescribeScalingConfigurationsScalingConfigurationType> scaling_configurations;
  int total_count;
  int page_number;
  int page_size;
};
