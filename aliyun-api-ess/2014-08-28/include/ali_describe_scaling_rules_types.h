#ifndef ALI_DESCRIBE_SCALING_RULES_TYPESH
#define ALI_DESCRIBE_SCALING_RULES_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct DescribeScalingRulesRequestType {
  std::string owner_id;
...
struct DescribeScalingRulesScalingRuleType {
...
struct DescribeScalingRulesResponseType {
  std::vector<DescribeScalingRulesScalingRuleType> scaling_rules;
  int total_count;
  int page_number;
  int page_size;
};
