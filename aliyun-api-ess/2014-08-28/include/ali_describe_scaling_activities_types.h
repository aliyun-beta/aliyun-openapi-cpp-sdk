#ifndef ALI_DESCRIBE_SCALING_ACTIVITIES_TYPESH
#define ALI_DESCRIBE_SCALING_ACTIVITIES_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct DescribeScalingActivitiesRequestType {
  std::string owner_id;
...
struct DescribeScalingActivitiesScalingActivityType {
...
struct DescribeScalingActivitiesResponseType {
  std::vector<DescribeScalingActivitiesScalingActivityType> scaling_activities;
  int total_count;
  int page_number;
  int page_size;
};
