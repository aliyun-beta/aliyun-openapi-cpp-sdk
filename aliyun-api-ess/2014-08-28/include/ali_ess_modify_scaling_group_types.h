#ifndef ALI_ESS_MODIFY_SCALING_GROUP_TYPESH
#define ALI_ESS_MODIFY_SCALING_GROUP_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct EssModifyScalingGroupRequestType {
  std::string owner_id;
...
struct EssModifyScalingGroupResponseType {
};
} // end namespace
#endif
