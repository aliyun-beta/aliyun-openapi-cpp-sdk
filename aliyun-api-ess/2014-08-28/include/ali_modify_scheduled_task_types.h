#ifndef ALI_MODIFY_SCHEDULED_TASK_TYPESH
#define ALI_MODIFY_SCHEDULED_TASK_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct ModifyScheduledTaskRequestType {
  std::string owner_id;
...
struct ModifyScheduledTaskResponseType {
};
} // end namespace
#endif
