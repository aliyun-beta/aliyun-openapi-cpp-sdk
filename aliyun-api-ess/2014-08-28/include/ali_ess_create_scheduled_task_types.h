#ifndef ALI_ESS_CREATE_SCHEDULED_TASK_TYPESH
#define ALI_ESS_CREATE_SCHEDULED_TASK_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct EssCreateScheduledTaskRequestType {
  std::string owner_id;
...
struct EssCreateScheduledTaskResponseType {
