#ifndef ALI_ESS_DESCRIBE_SCHEDULED_TASKS_TYPESH
#define ALI_ESS_DESCRIBE_SCHEDULED_TASKS_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct EssDescribeScheduledTasksRequestType {
  std::string owner_id;
...
struct EssDescribeScheduledTasksScheduledTaskType {
...
struct EssDescribeScheduledTasksResponseType {
  std::vector<EssDescribeScheduledTasksScheduledTaskType> scheduled_tasks;
  int total_count;
  int page_number;
  int page_size;
};
