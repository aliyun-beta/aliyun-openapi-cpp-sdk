#ifndef ALI_ESS_DESCRIBE_SCALING_GROUPS_TYPESH
#define ALI_ESS_DESCRIBE_SCALING_GROUPS_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct EssDescribeScalingGroupsRequestType {
  std::string owner_id;
...
struct EssDescribeScalingGroupsScalingGroupType {
...
struct EssDescribeScalingGroupsResponseType {
  std::vector<EssDescribeScalingGroupsScalingGroupType> scaling_groups;
  int total_count;
  int page_number;
  int page_size;
};
