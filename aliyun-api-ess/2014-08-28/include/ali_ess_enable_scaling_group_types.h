#ifndef ALI_ESS_ENABLE_SCALING_GROUP_TYPESH
#define ALI_ESS_ENABLE_SCALING_GROUP_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct EssEnableScalingGroupRequestType {
  std::string owner_id;
...
struct EssEnableScalingGroupResponseType {
};
} // end namespace
#endif
