...
void Json2Type(const Json::Value& value, DescribeCdnMonitorDataCDNMonitorDataType* item);
void Json2Type(const Json::Value& value, DescribeCdnMonitorDataResponseType* item);
...
void Json2Type(const Json::Value& value, DescribeCdnMonitorDataResponseType* item) {
  ...
  if(value.isMember("MonitorDatas") && value["MonitorDatas"].isMember("CDNMonitorData")) {
    Json2Array<DescribeCdnMonitorDataCDNMonitorDataType>(value["MonitorDatas"]["CDNMonitorData"], &item->monitor_datas);
  }
}
}

int Cdn::DescribeCdnMonitorData(const DescribeCdnMonitorDataRequestType& req,
                      DescribeCdnMonitorDataResponseType* response,
