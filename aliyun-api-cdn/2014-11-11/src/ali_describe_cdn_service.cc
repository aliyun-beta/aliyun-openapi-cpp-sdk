...
void Json2Type(const Json::Value& value, DescribeCdnServiceLockReasonType* item);
void Json2Type(const Json::Value& value, DescribeCdnServiceResponseType* item);
...
void Json2Type(const Json::Value& value, DescribeCdnServiceResponseType* item) {
  ...
  if(value.isMember("OperationLocks") && value["OperationLocks"].isMember("LockReason")) {
    Json2Array<DescribeCdnServiceLockReasonType>(value["OperationLocks"]["LockReason"], &item->operation_locks);
  }
}
}

int Cdn::DescribeCdnService(const DescribeCdnServiceRequestType& req,
                      DescribeCdnServiceResponseType* response,
