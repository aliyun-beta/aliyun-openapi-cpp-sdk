...
void Json2Type(const Json::Value& value, DescribeRefreshTasksCDNTaskType* item);
void Json2Type(const Json::Value& value, DescribeRefreshTasksResponseType* item);
...
void Json2Type(const Json::Value& value, DescribeRefreshTasksResponseType* item) {
  ...
  if(value.isMember("Tasks") && value["Tasks"].isMember("CDNTask")) {
    Json2Array<DescribeRefreshTasksCDNTaskType>(value["Tasks"]["CDNTask"], &item->tasks);
  }
}
}

int Cdn::DescribeRefreshTasks(const DescribeRefreshTasksRequestType& req,
                      DescribeRefreshTasksResponseType* response,
