...
void Json2Type(const Json::Value& value, AddCdnDomainResponseType* item);
...
int Cdn::AddCdnDomain(const AddCdnDomainRequestType& req,
                      AddCdnDomainResponseType* response,
