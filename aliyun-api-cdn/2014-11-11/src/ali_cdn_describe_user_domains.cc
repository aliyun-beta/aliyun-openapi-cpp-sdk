...
void Json2Type(const Json::Value& value, CdnDescribeUserDomainsResponseType* item);
...
void Json2Type(const Json::Value& value, CdnDescribeUserDomainsResponseType* item) {
  ...
  if(value.isMember("Domains") && value["Domains"].isMember("PageData")) {
    Json2Array<CdnDescribeUserDomainsPageDataType>(value["Domains"]["PageData"], &item->domains);
  }
}
}

int Cdn::DescribeUserDomains(const CdnDescribeUserDomainsRequestType& req,
                      CdnDescribeUserDomainsResponseType* response,
