...
void Json2Type(const Json::Value& value, PushObjectCacheResponseType* item);
...
int Cdn::PushObjectCache(const PushObjectCacheRequestType& req,
                      PushObjectCacheResponseType* response,
