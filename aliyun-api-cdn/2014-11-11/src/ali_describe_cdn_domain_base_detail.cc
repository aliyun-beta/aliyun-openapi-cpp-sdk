...
void Json2Type(const Json::Value& value, DescribeCdnDomainBaseDetailDomainBaseDetailModelType* item);
void Json2Type(const Json::Value& value, DescribeCdnDomainBaseDetailResponseType* item);
...
int Cdn::DescribeCdnDomainBaseDetail(const DescribeCdnDomainBaseDetailRequestType& req,
                      DescribeCdnDomainBaseDetailResponseType* response,
