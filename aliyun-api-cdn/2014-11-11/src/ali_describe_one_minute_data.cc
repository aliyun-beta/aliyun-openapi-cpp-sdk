...
void Json2Type(const Json::Value& value, DescribeOneMinuteDataResponseType* item);
...
int Cdn::DescribeOneMinuteData(const DescribeOneMinuteDataRequestType& req,
                      DescribeOneMinuteDataResponseType* response,
