...
void Json2Type(const Json::Value& value, OpenCdnServiceResponseType* item);
...
int Cdn::OpenCdnService(const OpenCdnServiceRequestType& req,
                      OpenCdnServiceResponseType* response,
