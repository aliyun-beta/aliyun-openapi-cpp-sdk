...
void Json2Type(const Json::Value& value, DescribeCdnDomainDetailGetDomainDetailModelType* item);
void Json2Type(const Json::Value& value, DescribeCdnDomainDetailResponseType* item);
...
int Cdn::DescribeCdnDomainDetail(const DescribeCdnDomainDetailRequestType& req,
                      DescribeCdnDomainDetailResponseType* response,
