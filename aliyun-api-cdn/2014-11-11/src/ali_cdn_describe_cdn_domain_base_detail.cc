...
void Json2Type(const Json::Value& value, CdnDescribeCdnDomainBaseDetailDomainBaseDetailModelType* item);
void Json2Type(const Json::Value& value, CdnDescribeCdnDomainBaseDetailResponseType* item);
...
void Json2Type(const Json::Value& value, CdnDescribeCdnDomainBaseDetailResponseType* item) {
  if(value.isMember("DomainBaseDetailModel")) {
    Json2Type(value["DomainBaseDetailModel"], &item->domain_base_detail_model);
  }
}
}

int Cdn::DescribeCdnDomainBaseDetail(const CdnDescribeCdnDomainBaseDetailRequestType& req,
                      CdnDescribeCdnDomainBaseDetailResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","DescribeCdnDomainBaseDetail");
