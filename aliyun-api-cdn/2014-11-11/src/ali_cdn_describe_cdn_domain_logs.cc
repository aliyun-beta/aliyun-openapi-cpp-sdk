...
void Json2Type(const Json::Value& value, CdnDescribeCdnDomainLogsDomainLogModelType* item);
void Json2Type(const Json::Value& value, CdnDescribeCdnDomainLogsResponseType* item);
...
void Json2Type(const Json::Value& value, CdnDescribeCdnDomainLogsDomainLogModelType* item) {
  ...
  if(value.isMember("DomainLogDetails") && value["DomainLogDetails"].isMember("DomainLogDetail")) {
    Json2Array<CdnDescribeCdnDomainLogsDomainLogDetailType>(value["DomainLogDetails"]["DomainLogDetail"], &item->domain_log_details);
  }
}
void Json2Type(const Json::Value& value, CdnDescribeCdnDomainLogsResponseType* item) {
