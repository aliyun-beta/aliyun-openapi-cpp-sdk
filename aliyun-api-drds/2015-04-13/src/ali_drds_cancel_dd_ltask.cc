...
void Json2Type(const Json::Value& value, DrdsCancelDDLTaskResponseType* item);
...
int Drds::CancelDDLTask(const DrdsCancelDDLTaskRequestType& req,
                      DrdsCancelDDLTaskResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","CancelDDLTask");
