...
void Json2Type(const Json::Value& value, CreateDrdsDBResponseType* item);
...
int Drds::CreateDrdsDB(const CreateDrdsDBRequestType& req,
                      CreateDrdsDBResponseType* response,
