...
void Json2Type(const Json::Value& value, DescribeDrdsDBDataType* item);
void Json2Type(const Json::Value& value, DescribeDrdsDBResponseType* item);
...
int Drds::DescribeDrdsDB(const DescribeDrdsDBRequestType& req,
                      DescribeDrdsDBResponseType* response,
