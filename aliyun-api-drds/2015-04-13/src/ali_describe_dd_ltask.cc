...
void Json2Type(const Json::Value& value, DescribeDDLTaskDataType* item);
void Json2Type(const Json::Value& value, DescribeDDLTaskResponseType* item);
...
int Drds::DescribeDDLTask(const DescribeDDLTaskRequestType& req,
                      DescribeDDLTaskResponseType* response,
