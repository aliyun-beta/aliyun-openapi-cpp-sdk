...
void Json2Type(const Json::Value& value, ModifyDrdsIpWhiteListResponseType* item);
...
int Drds::ModifyDrdsIpWhiteList(const ModifyDrdsIpWhiteListRequestType& req,
                      ModifyDrdsIpWhiteListResponseType* response,
