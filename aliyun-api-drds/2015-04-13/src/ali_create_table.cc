...
void Json2Type(const Json::Value& value, CreateTableResponseType* item);
...
int Drds::CreateTable(const CreateTableRequestType& req,
                      CreateTableResponseType* response,
