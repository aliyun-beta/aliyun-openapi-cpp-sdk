...
void Json2Type(const Json::Value& value, DescribeDrdsDBsDbType* item);
void Json2Type(const Json::Value& value, DescribeDrdsDBsResponseType* item);
...
void Json2Type(const Json::Value& value, DescribeDrdsDBsResponseType* item) {
  ...
  if(value.isMember("Data") && value["Data"].isMember("Db")) {
    Json2Array<DescribeDrdsDBsDbType>(value["Data"]["Db"], &item->data);
  }
}
}

int Drds::DescribeDrdsDBs(const DescribeDrdsDBsRequestType& req,
                      DescribeDrdsDBsResponseType* response,
