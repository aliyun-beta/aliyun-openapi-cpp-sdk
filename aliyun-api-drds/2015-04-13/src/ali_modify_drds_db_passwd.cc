...
void Json2Type(const Json::Value& value, ModifyDrdsDBPasswdResponseType* item);
...
int Drds::ModifyDrdsDBPasswd(const ModifyDrdsDBPasswdRequestType& req,
                      ModifyDrdsDBPasswdResponseType* response,
