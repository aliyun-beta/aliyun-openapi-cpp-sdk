...
void Json2Type(const Json::Value& value, DrdsModifyDrdsDBPasswdResponseType* item);
...
int Drds::ModifyDrdsDBPasswd(const DrdsModifyDrdsDBPasswdRequestType& req,
                      DrdsModifyDrdsDBPasswdResponseType* response,
