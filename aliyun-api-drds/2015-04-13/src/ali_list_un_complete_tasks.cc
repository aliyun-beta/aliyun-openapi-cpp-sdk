...
void Json2Type(const Json::Value& value, ListUnCompleteTaskstaskType* item);
void Json2Type(const Json::Value& value, ListUnCompleteTasksResponseType* item);
...
void Json2Type(const Json::Value& value, ListUnCompleteTasksResponseType* item) {
  if(value.isMember("Data") && value["Data"].isMember("task")) {
    Json2Array<ListUnCompleteTaskstaskType>(value["Data"]["task"], &item->data);
  }
}
}

int Drds::ListUnCompleteTasks(const ListUnCompleteTasksRequestType& req,
                      ListUnCompleteTasksResponseType* response,
