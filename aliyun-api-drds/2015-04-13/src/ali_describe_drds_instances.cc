...
void Json2Type(const Json::Value& value, DescribeDrdsInstancesVipType* item);
void Json2Type(const Json::Value& value, DescribeDrdsInstancesInstanceType* item);
void Json2Type(const Json::Value& value, DescribeDrdsInstancesResponseType* item);
...
void Json2Type(const Json::Value& value, DescribeDrdsInstancesInstanceType* item) {
  ...
  if(value.isMember("Vips") && value["Vips"].isMember("Vip")) {
    Json2Array<DescribeDrdsInstancesVipType>(value["Vips"]["Vip"], &item->vips);
  }
}
void Json2Type(const Json::Value& value, DescribeDrdsInstancesResponseType* item) {
  ...
  if(value.isMember("Data") && value["Data"].isMember("Instance")) {
    Json2Array<DescribeDrdsInstancesInstanceType>(value["Data"]["Instance"], &item->data);
  }
}
}

int Drds::DescribeDrdsInstances(const DescribeDrdsInstancesRequestType& req,
                      DescribeDrdsInstancesResponseType* response,
