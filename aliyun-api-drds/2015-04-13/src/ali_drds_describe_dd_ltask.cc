...
void Json2Type(const Json::Value& value, DrdsDescribeDDLTaskDataType* item);
void Json2Type(const Json::Value& value, DrdsDescribeDDLTaskResponseType* item);
...
int Drds::DescribeDDLTask(const DrdsDescribeDDLTaskRequestType& req,
                      DrdsDescribeDDLTaskResponseType* response,
