...
void Json2Type(const Json::Value& value, DeleteDrdsDBResponseType* item);
...
int Drds::DeleteDrdsDB(const DeleteDrdsDBRequestType& req,
                      DeleteDrdsDBResponseType* response,
