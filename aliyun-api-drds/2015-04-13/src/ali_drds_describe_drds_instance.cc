...
void Json2Type(const Json::Value& value, DrdsDescribeDrdsInstanceVipType* item);
void Json2Type(const Json::Value& value, DrdsDescribeDrdsInstanceDataType* item);
void Json2Type(const Json::Value& value, DrdsDescribeDrdsInstanceResponseType* item);
...
void Json2Type(const Json::Value& value, DrdsDescribeDrdsInstanceDataType* item) {
  ...
  if(value.isMember("Vips") && value["Vips"].isMember("Vip")) {
    Json2Array<DrdsDescribeDrdsInstanceVipType>(value["Vips"]["Vip"], &item->vips);
  }
}
void Json2Type(const Json::Value& value, DrdsDescribeDrdsInstanceResponseType* item) {
