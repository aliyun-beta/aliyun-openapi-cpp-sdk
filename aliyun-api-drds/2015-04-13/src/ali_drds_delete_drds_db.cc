...
void Json2Type(const Json::Value& value, DrdsDeleteDrdsDBResponseType* item);
...
int Drds::DeleteDrdsDB(const DrdsDeleteDrdsDBRequestType& req,
                      DrdsDeleteDrdsDBResponseType* response,
