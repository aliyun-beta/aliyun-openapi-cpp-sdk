...
void Json2Type(const Json::Value& value, DrdsCreateDrdsInstanceDataType* item);
void Json2Type(const Json::Value& value, DrdsCreateDrdsInstanceResponseType* item);
...
int Drds::CreateDrdsInstance(const DrdsCreateDrdsInstanceRequestType& req,
                      DrdsCreateDrdsInstanceResponseType* response,
