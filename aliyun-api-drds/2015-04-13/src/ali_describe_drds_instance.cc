...
void Json2Type(const Json::Value& value, DescribeDrdsInstanceVipType* item);
void Json2Type(const Json::Value& value, DescribeDrdsInstanceDataType* item);
void Json2Type(const Json::Value& value, DescribeDrdsInstanceResponseType* item);
...
void Json2Type(const Json::Value& value, DescribeDrdsInstanceDataType* item) {
  ...
  if(value.isMember("Vips") && value["Vips"].isMember("Vip")) {
    Json2Array<DescribeDrdsInstanceVipType>(value["Vips"]["Vip"], &item->vips);
  }
}
void Json2Type(const Json::Value& value, DescribeDrdsInstanceResponseType* item) {
...
int Drds::DescribeDrdsInstance(const DescribeDrdsInstanceRequestType& req,
                      DescribeDrdsInstanceResponseType* response,
