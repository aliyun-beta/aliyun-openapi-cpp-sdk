...
void Json2Type(const Json::Value& value, CancelDDLTaskResponseType* item);
...
int Drds::CancelDDLTask(const CancelDDLTaskRequestType& req,
                      CancelDDLTaskResponseType* response,
