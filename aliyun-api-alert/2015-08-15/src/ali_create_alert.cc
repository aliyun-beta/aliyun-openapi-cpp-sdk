...
void Json2Type(const Json::Value& value, CreateAlertResponseType* item);
...
int Alert::CreateAlert(const CreateAlertRequestType& req,
                      CreateAlertResponseType* response,
