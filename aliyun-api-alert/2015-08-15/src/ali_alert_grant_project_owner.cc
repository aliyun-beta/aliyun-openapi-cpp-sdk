...
void Json2Type(const Json::Value& value, AlertGrantProjectOwnerResponseType* item);
...
int Alert::GrantProjectOwner(const AlertGrantProjectOwnerRequestType& req,
                      AlertGrantProjectOwnerResponseType* response,
  ...
  std::string url = secheme  + "://" + host_ + get_format_string("/projects/grantOwner");
