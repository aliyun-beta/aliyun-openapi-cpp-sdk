...
void Json2Type(const Json::Value& value, GetContactGroupResponseType* item);
...
int Alert::GetContactGroup(const GetContactGroupRequestType& req,
                      GetContactGroupResponseType* response,
