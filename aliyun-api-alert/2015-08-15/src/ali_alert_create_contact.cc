...
void Json2Type(const Json::Value& value, AlertCreateContactResponseType* item);
...
int Alert::CreateContact(const AlertCreateContactRequestType& req,
                      AlertCreateContactResponseType* response,
  ...
  std::string url = secheme  + "://" + host_ + get_format_string("/projects/%s/contacts", req.project_name.c_str());
