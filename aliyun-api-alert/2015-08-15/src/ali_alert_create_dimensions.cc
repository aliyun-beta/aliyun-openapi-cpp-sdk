...
void Json2Type(const Json::Value& value, AlertCreateDimensionsResponseType* item);
...
int Alert::CreateDimensions(const AlertCreateDimensionsRequestType& req,
                      AlertCreateDimensionsResponseType* response,
  ...
  std::string url = secheme  + "://" + host_ + get_format_string("/projects/%s/alerts/%s/dimensions", req.project_name.c_str(), req.alert_name.c_str());
