...
void Json2Type(const Json::Value& value, AlertDeleteContactGroupResponseType* item);
...
int Alert::DeleteContactGroup(const AlertDeleteContactGroupRequestType& req,
                      AlertDeleteContactGroupResponseType* response,
