...
void Json2Type(const Json::Value& value, ListDBSourceResponseType* item);
...
int Alert::ListDBSource(const ListDBSourceRequestType& req,
                      ListDBSourceResponseType* response,
