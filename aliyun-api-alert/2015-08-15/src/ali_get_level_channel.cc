...
void Json2Type(const Json::Value& value, GetLevelChannelResponseType* item);
...
int Alert::GetLevelChannel(const GetLevelChannelRequestType& req,
                      GetLevelChannelResponseType* response,
