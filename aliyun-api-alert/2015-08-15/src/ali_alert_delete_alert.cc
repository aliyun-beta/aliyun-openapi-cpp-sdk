...
void Json2Type(const Json::Value& value, AlertDeleteAlertResponseType* item);
...
int Alert::DeleteAlert(const AlertDeleteAlertRequestType& req,
                      AlertDeleteAlertResponseType* response,
