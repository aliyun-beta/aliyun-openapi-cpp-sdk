...
void Json2Type(const Json::Value& value, AlertGetDimensionsResponseType* item);
...
int Alert::GetDimensions(const AlertGetDimensionsRequestType& req,
                      AlertGetDimensionsResponseType* response,
