...
void Json2Type(const Json::Value& value, RemoveProjectOwnerResponseType* item);
...
int Alert::RemoveProjectOwner(const RemoveProjectOwnerRequestType& req,
                      RemoveProjectOwnerResponseType* response,
