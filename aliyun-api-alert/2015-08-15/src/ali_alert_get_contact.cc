...
void Json2Type(const Json::Value& value, AlertGetContactResponseType* item);
...
int Alert::GetContact(const AlertGetContactRequestType& req,
                      AlertGetContactResponseType* response,
