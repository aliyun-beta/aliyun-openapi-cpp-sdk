...
void Json2Type(const Json::Value& value, CreateLevelChannelResponseType* item);
...
int Alert::CreateLevelChannel(const CreateLevelChannelRequestType& req,
                      CreateLevelChannelResponseType* response,
