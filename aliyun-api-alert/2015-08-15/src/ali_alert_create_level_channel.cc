...
void Json2Type(const Json::Value& value, AlertCreateLevelChannelResponseType* item);
...
int Alert::CreateLevelChannel(const AlertCreateLevelChannelRequestType& req,
                      AlertCreateLevelChannelResponseType* response,
  ...
  std::string url = secheme  + "://" + host_ + get_format_string("/projects/%s/level_channels", req.project_name.c_str());
