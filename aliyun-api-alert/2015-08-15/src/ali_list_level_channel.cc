...
void Json2Type(const Json::Value& value, ListLevelChannelResponseType* item);
...
int Alert::ListLevelChannel(const ListLevelChannelRequestType& req,
                      ListLevelChannelResponseType* response,
