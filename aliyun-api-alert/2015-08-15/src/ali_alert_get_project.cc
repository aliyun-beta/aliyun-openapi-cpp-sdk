...
void Json2Type(const Json::Value& value, AlertGetProjectResponseType* item);
...
int Alert::GetProject(const AlertGetProjectRequestType& req,
                      AlertGetProjectResponseType* response,
