...
void Json2Type(const Json::Value& value, ListAlertStateResponseType* item);
...
int Alert::ListAlertState(const ListAlertStateRequestType& req,
                      ListAlertStateResponseType* response,
