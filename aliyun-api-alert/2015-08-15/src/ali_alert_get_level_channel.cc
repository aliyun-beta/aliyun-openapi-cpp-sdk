...
void Json2Type(const Json::Value& value, AlertGetLevelChannelResponseType* item);
...
int Alert::GetLevelChannel(const AlertGetLevelChannelRequestType& req,
                      AlertGetLevelChannelResponseType* response,
