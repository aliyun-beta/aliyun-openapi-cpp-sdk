...
void Json2Type(const Json::Value& value, ListContactResponseType* item);
...
int Alert::ListContact(const ListContactRequestType& req,
                      ListContactResponseType* response,
