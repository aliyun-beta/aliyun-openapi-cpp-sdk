...
void Json2Type(const Json::Value& value, AlertListAlertStateResponseType* item);
...
int Alert::ListAlertState(const AlertListAlertStateRequestType& req,
                      AlertListAlertStateResponseType* response,
  ...
  std::string url = secheme  + "://" + host_ + get_format_string("/projects/%s/alerts_state", req.project_name.c_str());
