...
void Json2Type(const Json::Value& value, ListContactGroupResponseType* item);
...
int Alert::ListContactGroup(const ListContactGroupRequestType& req,
                      ListContactGroupResponseType* response,
