...
void Json2Type(const Json::Value& value, AlertListContactResponseType* item);
...
int Alert::ListContact(const AlertListContactRequestType& req,
                      AlertListContactResponseType* response,
