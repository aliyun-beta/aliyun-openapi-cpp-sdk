...
void Json2Type(const Json::Value& value, BatchQueryProjectResponseType* item);
...
int Alert::BatchQueryProject(const BatchQueryProjectRequestType& req,
                      BatchQueryProjectResponseType* response,
