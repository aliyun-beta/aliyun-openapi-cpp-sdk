...
void Json2Type(const Json::Value& value, AlertGetDBSourceResponseType* item);
...
int Alert::GetDBSource(const AlertGetDBSourceRequestType& req,
                      AlertGetDBSourceResponseType* response,
