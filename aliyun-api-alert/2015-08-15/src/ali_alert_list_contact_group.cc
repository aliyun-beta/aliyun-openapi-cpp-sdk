...
void Json2Type(const Json::Value& value, AlertListContactGroupResponseType* item);
...
int Alert::ListContactGroup(const AlertListContactGroupRequestType& req,
                      AlertListContactGroupResponseType* response,
