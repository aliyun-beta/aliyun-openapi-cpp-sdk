...
void Json2Type(const Json::Value& value, AlertUpdateProjectResponseType* item);
...
int Alert::UpdateProject(const AlertUpdateProjectRequestType& req,
                      AlertUpdateProjectResponseType* response,
