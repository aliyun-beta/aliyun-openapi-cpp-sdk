...
void Json2Type(const Json::Value& value, GetDBSourceResponseType* item);
...
int Alert::GetDBSource(const GetDBSourceRequestType& req,
                      GetDBSourceResponseType* response,
