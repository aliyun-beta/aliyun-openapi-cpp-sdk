...
void Json2Type(const Json::Value& value, CreateDBMetricResponseType* item);
...
int Alert::CreateDBMetric(const CreateDBMetricRequestType& req,
                      CreateDBMetricResponseType* response,
