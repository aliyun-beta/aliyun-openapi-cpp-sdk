...
void Json2Type(const Json::Value& value, AlertUpdateDBSourceResponseType* item);
...
int Alert::UpdateDBSource(const AlertUpdateDBSourceRequestType& req,
                      AlertUpdateDBSourceResponseType* response,
  ...
  std::string url = secheme  + "://" + host_ + get_format_string("/projects/%s/sources/%s", req.project_name.c_str(), req.source_name.c_str());
