...
void Json2Type(const Json::Value& value, AlertDeleteContactResponseType* item);
...
int Alert::DeleteContact(const AlertDeleteContactRequestType& req,
                      AlertDeleteContactResponseType* response,
