...
void Json2Type(const Json::Value& value, GrantProjectOwnerResponseType* item);
...
int Alert::GrantProjectOwner(const GrantProjectOwnerRequestType& req,
                      GrantProjectOwnerResponseType* response,
