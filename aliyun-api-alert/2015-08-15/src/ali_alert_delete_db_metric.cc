...
void Json2Type(const Json::Value& value, AlertDeleteDBMetricResponseType* item);
...
int Alert::DeleteDBMetric(const AlertDeleteDBMetricRequestType& req,
                      AlertDeleteDBMetricResponseType* response,
