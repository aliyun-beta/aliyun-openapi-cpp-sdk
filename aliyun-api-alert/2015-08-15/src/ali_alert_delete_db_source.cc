...
void Json2Type(const Json::Value& value, AlertDeleteDBSourceResponseType* item);
...
int Alert::DeleteDBSource(const AlertDeleteDBSourceRequestType& req,
                      AlertDeleteDBSourceResponseType* response,
