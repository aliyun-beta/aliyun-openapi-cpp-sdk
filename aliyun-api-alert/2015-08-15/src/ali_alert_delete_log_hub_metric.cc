...
void Json2Type(const Json::Value& value, AlertDeleteLogHubMetricResponseType* item);
...
int Alert::DeleteLogHubMetric(const AlertDeleteLogHubMetricRequestType& req,
                      AlertDeleteLogHubMetricResponseType* response,
