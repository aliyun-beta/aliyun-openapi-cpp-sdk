...
void Json2Type(const Json::Value& value, AlertCreateProjectResponseType* item);
...
int Alert::CreateProject(const AlertCreateProjectRequestType& req,
                      AlertCreateProjectResponseType* response,
