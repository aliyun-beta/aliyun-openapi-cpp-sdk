...
void Json2Type(const Json::Value& value, CreateContactResponseType* item);
...
int Alert::CreateContact(const CreateContactRequestType& req,
                      CreateContactResponseType* response,
