...
void Json2Type(const Json::Value& value, ListLogHubMetricResponseType* item);
...
int Alert::ListLogHubMetric(const ListLogHubMetricRequestType& req,
                      ListLogHubMetricResponseType* response,
