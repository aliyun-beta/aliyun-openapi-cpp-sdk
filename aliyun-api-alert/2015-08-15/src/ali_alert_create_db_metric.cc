...
void Json2Type(const Json::Value& value, AlertCreateDBMetricResponseType* item);
...
int Alert::CreateDBMetric(const AlertCreateDBMetricRequestType& req,
                      AlertCreateDBMetricResponseType* response,
  ...
  std::string url = secheme  + "://" + host_ + get_format_string("/projects/%s/dbMetrics", req.project_name.c_str());
