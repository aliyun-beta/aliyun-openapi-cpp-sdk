...
void Json2Type(const Json::Value& value, AlertGetAlertResponseType* item);
...
int Alert::GetAlert(const AlertGetAlertRequestType& req,
                      AlertGetAlertResponseType* response,
