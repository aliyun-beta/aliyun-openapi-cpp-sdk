...
void Json2Type(const Json::Value& value, AlertCreateLogHubMetricResponseType* item);
...
int Alert::CreateLogHubMetric(const AlertCreateLogHubMetricRequestType& req,
                      AlertCreateLogHubMetricResponseType* response,
