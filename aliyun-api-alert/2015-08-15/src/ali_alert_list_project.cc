...
void Json2Type(const Json::Value& value, AlertListProjectResponseType* item);
...
int Alert::ListProject(const AlertListProjectRequestType& req,
                      AlertListProjectResponseType* response,
