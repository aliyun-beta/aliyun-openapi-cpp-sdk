...
void Json2Type(const Json::Value& value, GetDBMetricResponseType* item);
...
int Alert::GetDBMetric(const GetDBMetricRequestType& req,
                      GetDBMetricResponseType* response,
