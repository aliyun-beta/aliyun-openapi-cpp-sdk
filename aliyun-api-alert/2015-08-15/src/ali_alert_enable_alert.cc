...
void Json2Type(const Json::Value& value, AlertEnableAlertResponseType* item);
...
int Alert::EnableAlert(const AlertEnableAlertRequestType& req,
                      AlertEnableAlertResponseType* response,
  ...
  std::string url = secheme  + "://" + host_ + get_format_string("/projects/%s/alerts/%s/enable", req.project_name.c_str(), req.alert_name.c_str());
