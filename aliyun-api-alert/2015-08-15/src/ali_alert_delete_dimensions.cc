...
void Json2Type(const Json::Value& value, AlertDeleteDimensionsResponseType* item);
...
int Alert::DeleteDimensions(const AlertDeleteDimensionsRequestType& req,
                      AlertDeleteDimensionsResponseType* response,
