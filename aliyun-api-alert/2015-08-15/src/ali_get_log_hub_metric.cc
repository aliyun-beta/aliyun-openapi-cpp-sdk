...
void Json2Type(const Json::Value& value, GetLogHubMetricResponseType* item);
...
int Alert::GetLogHubMetric(const GetLogHubMetricRequestType& req,
                      GetLogHubMetricResponseType* response,
