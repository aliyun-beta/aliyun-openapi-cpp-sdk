...
void Json2Type(const Json::Value& value, ListDBMetricResponseType* item);
...
int Alert::ListDBMetric(const ListDBMetricRequestType& req,
                      ListDBMetricResponseType* response,
