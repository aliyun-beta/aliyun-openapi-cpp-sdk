...
void Json2Type(const Json::Value& value, AlertGetLogHubMetricResponseType* item);
...
int Alert::GetLogHubMetric(const AlertGetLogHubMetricRequestType& req,
                      AlertGetLogHubMetricResponseType* response,
