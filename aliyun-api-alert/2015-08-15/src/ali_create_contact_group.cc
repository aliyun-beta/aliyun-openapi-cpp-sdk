...
void Json2Type(const Json::Value& value, CreateContactGroupResponseType* item);
...
int Alert::CreateContactGroup(const CreateContactGroupRequestType& req,
                      CreateContactGroupResponseType* response,
