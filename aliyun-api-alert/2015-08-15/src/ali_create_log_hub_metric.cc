...
void Json2Type(const Json::Value& value, CreateLogHubMetricResponseType* item);
...
int Alert::CreateLogHubMetric(const CreateLogHubMetricRequestType& req,
                      CreateLogHubMetricResponseType* response,
