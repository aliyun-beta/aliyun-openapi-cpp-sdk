...
void Json2Type(const Json::Value& value, AlertListDBMetricResponseType* item);
...
int Alert::ListDBMetric(const AlertListDBMetricRequestType& req,
                      AlertListDBMetricResponseType* response,
