...
void Json2Type(const Json::Value& value, AlertDeleteProjectResponseType* item);
...
int Alert::DeleteProject(const AlertDeleteProjectRequestType& req,
                      AlertDeleteProjectResponseType* response,
  ...
  std::string url = secheme  + "://" + host_ + get_format_string("/projects/%s", req.project_name.c_str());
