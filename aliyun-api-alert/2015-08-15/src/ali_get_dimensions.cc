...
void Json2Type(const Json::Value& value, GetDimensionsResponseType* item);
...
int Alert::GetDimensions(const GetDimensionsRequestType& req,
                      GetDimensionsResponseType* response,
