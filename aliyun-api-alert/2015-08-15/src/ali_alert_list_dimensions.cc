...
void Json2Type(const Json::Value& value, AlertListDimensionsResponseType* item);
...
int Alert::ListDimensions(const AlertListDimensionsRequestType& req,
                      AlertListDimensionsResponseType* response,
