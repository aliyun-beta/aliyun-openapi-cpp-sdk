...
void Json2Type(const Json::Value& value, CreateDimensionsResponseType* item);
...
int Alert::CreateDimensions(const CreateDimensionsRequestType& req,
                      CreateDimensionsResponseType* response,
