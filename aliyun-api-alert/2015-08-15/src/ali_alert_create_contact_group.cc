...
void Json2Type(const Json::Value& value, AlertCreateContactGroupResponseType* item);
...
int Alert::CreateContactGroup(const AlertCreateContactGroupRequestType& req,
                      AlertCreateContactGroupResponseType* response,
  ...
  std::string url = secheme  + "://" + host_ + get_format_string("/projects/%s/groups", req.project_name.c_str());
