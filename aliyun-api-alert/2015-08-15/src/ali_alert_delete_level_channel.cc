...
void Json2Type(const Json::Value& value, AlertDeleteLevelChannelResponseType* item);
...
int Alert::DeleteLevelChannel(const AlertDeleteLevelChannelRequestType& req,
                      AlertDeleteLevelChannelResponseType* response,
