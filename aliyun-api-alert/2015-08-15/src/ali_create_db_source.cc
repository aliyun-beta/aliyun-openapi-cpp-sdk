...
void Json2Type(const Json::Value& value, CreateDBSourceResponseType* item);
...
int Alert::CreateDBSource(const CreateDBSourceRequestType& req,
                      CreateDBSourceResponseType* response,
