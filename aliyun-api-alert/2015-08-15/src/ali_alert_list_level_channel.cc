...
void Json2Type(const Json::Value& value, AlertListLevelChannelResponseType* item);
...
int Alert::ListLevelChannel(const AlertListLevelChannelRequestType& req,
                      AlertListLevelChannelResponseType* response,
