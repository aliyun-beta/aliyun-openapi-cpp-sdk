...
void Json2Type(const Json::Value& value, ListDimensionsResponseType* item);
...
int Alert::ListDimensions(const ListDimensionsRequestType& req,
                      ListDimensionsResponseType* response,
