...
void Json2Type(const Json::Value& value, OmsGetUserDataDataItemType* item);
void Json2Type(const Json::Value& value, OmsGetUserDataDataType* item);
void Json2Type(const Json::Value& value, OmsGetUserDataResponseType* item);
...
void Json2Type(const Json::Value& value, OmsGetUserDataDataType* item) {
  if(value.isMember("DataItems") && value["DataItems"].isMember("DataItem")) {
    Json2Array<OmsGetUserDataDataItemType>(value["DataItems"]["DataItem"], &item->data_items);
  }
}
void Json2Type(const Json::Value& value, OmsGetUserDataResponseType* item) {
  ...
  if(value.isMember("DataList") && value["DataList"].isMember("Data")) {
    Json2Array<OmsGetUserDataDataType>(value["DataList"]["Data"], &item->data_list);
  }
}
}

int Oms::GetUserData(const OmsGetUserDataRequestType& req,
                      OmsGetUserDataResponseType* response,
