...
void Json2Type(const Json::Value& value, OmsGetProductDefineTypeType* item);
void Json2Type(const Json::Value& value, OmsGetProductDefineProductType* item);
void Json2Type(const Json::Value& value, OmsGetProductDefineResponseType* item);
...
void Json2Type(const Json::Value& value, OmsGetProductDefineProductType* item) {
  ...
  if(value.isMember("TypeList") && value["TypeList"].isMember("Type")) {
    Json2Array<OmsGetProductDefineTypeType>(value["TypeList"]["Type"], &item->type_list);
  }
}
void Json2Type(const Json::Value& value, OmsGetProductDefineResponseType* item) {
  if(value.isMember("ProductName")) {
  ...
  if(value.isMember("ProductList") && value["ProductList"].isMember("Product")) {
    Json2Array<OmsGetProductDefineProductType>(value["ProductList"]["Product"], &item->product_list);
  }
}
}

int Oms::GetProductDefine(const OmsGetProductDefineRequestType& req,
                      OmsGetProductDefineResponseType* response,
