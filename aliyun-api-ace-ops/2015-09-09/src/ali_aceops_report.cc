...
void Json2Type(const Json::Value& value, AceopsreportResponseType* item);
...
int Aceops::report(const AceopsreportRequestType& req,
                      AceopsreportResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","report");
  if(!req.group.empty()) {
