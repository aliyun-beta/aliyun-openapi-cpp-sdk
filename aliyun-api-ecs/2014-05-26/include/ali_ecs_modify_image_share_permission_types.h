#ifndef ALI_ECS_MODIFY_IMAGE_SHARE_PERMISSION_TYPESH
#define ALI_ECS_MODIFY_IMAGE_SHARE_PERMISSION_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct EcsModifyImageSharePermissionRequestType {
  std::string owner_id;
...
struct EcsModifyImageSharePermissionResponseType {
};
} // end namespace
#endif
