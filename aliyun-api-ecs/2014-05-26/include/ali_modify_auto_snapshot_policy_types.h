#ifndef ALI_MODIFY_AUTO_SNAPSHOT_POLICY_TYPESH
#define ALI_MODIFY_AUTO_SNAPSHOT_POLICY_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct ModifyAutoSnapshotPolicyRequestType {
  std::string owner_id;
...
struct ModifyAutoSnapshotPolicyResponseType {
};
} // end namespace
#endif
