#ifndef ALI_ECS_DESCRIBE_INSTANCES_TYPESH
#define ALI_ECS_DESCRIBE_INSTANCES_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct EcsDescribeInstancesRequestType {
  std::string owner_id;
...
struct EcsDescribeInstancesLockReasonType {
  std::string lock_reason;
};
struct EcsDescribeInstancesTagType {
  std::string tag_key;
  std::string tag_value;
};
struct EcsDescribeInstancesVpcAttributesType {
  std::vector<std::string> private_ip_address;
  std::string vpc_id;
  std::string vswitch_id;
  std::string nat_ip_address;
};
struct EcsDescribeInstancesEipAddressType {
  std::string allocation_id;
  std::string ip_address;
  int bandwidth;
  std::string internet_charge_type;
};
struct EcsDescribeInstancesInstanceType {
  std::vector<EcsDescribeInstancesLockReasonType> operation_locks;
  std::vector<EcsDescribeInstancesTagType> tags;
  std::vector<std::string> security_group_ids;
  std::vector<std::string> public_ip_address;
  std::vector<std::string> inner_ip_address;
  EcsDescribeInstancesVpcAttributesType vpc_attributes;
  EcsDescribeInstancesEipAddressType eip_address;
...
struct EcsDescribeInstancesResponseType {
  std::vector<EcsDescribeInstancesInstanceType> instances;
  int total_count;
  int page_number;
  int page_size;
};
