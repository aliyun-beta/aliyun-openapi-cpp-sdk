...
void Json2Type(const Json::Value& value, EcsCreateSecurityGroupResponseType* item);
...
int Ecs::CreateSecurityGroup(const EcsCreateSecurityGroupRequestType& req,
                      EcsCreateSecurityGroupResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","CreateSecurityGroup");
