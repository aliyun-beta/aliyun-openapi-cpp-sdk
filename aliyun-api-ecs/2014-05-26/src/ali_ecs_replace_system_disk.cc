...
void Json2Type(const Json::Value& value, EcsReplaceSystemDiskResponseType* item);
...
int Ecs::ReplaceSystemDisk(const EcsReplaceSystemDiskRequestType& req,
                      EcsReplaceSystemDiskResponseType* response,
