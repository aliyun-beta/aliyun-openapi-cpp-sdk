...
void Json2Type(const Json::Value& value, EcsRemoveTagsResponseType* item);
...
int Ecs::RemoveTags(const EcsRemoveTagsRequestType& req,
                      EcsRemoveTagsResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","RemoveTags");
