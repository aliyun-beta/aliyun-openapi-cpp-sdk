...
void Json2Type(const Json::Value& value, EcsModifyDiskAttributeResponseType* item);
...
int Ecs::ModifyDiskAttribute(const EcsModifyDiskAttributeRequestType& req,
                      EcsModifyDiskAttributeResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","ModifyDiskAttribute");
