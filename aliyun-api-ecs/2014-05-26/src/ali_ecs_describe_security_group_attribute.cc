...
void Json2Type(const Json::Value& value, EcsDescribeSecurityGroupAttributePermissionType* item);
void Json2Type(const Json::Value& value, EcsDescribeSecurityGroupAttributeResponseType* item);
...
void Json2Type(const Json::Value& value, EcsDescribeSecurityGroupAttributeResponseType* item) {
  ...
  if(value.isMember("Permissions") && value["Permissions"].isMember("Permission")) {
    Json2Array<EcsDescribeSecurityGroupAttributePermissionType>(value["Permissions"]["Permission"], &item->permissions);
  }
}
}

int Ecs::DescribeSecurityGroupAttribute(const EcsDescribeSecurityGroupAttributeRequestType& req,
                      EcsDescribeSecurityGroupAttributeResponseType* response,
