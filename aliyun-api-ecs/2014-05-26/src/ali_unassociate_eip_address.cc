...
void Json2Type(const Json::Value& value, UnassociateEipAddressResponseType* item);
...
int Ecs::UnassociateEipAddress(const UnassociateEipAddressRequestType& req,
                      UnassociateEipAddressResponseType* response,
