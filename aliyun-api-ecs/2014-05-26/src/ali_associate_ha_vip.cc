...
void Json2Type(const Json::Value& value, AssociateHaVipResponseType* item);
...
int Ecs::AssociateHaVip(const AssociateHaVipRequestType& req,
                      AssociateHaVipResponseType* response,
