...
void Json2Type(const Json::Value& value, EcsDescribeInstanceAttributeLockReasonType* item);
void Json2Type(const Json::Value& value, EcsDescribeInstanceAttributeVpcAttributesType* item);
void Json2Type(const Json::Value& value, EcsDescribeInstanceAttributeEipAddressType* item);
void Json2Type(const Json::Value& value, EcsDescribeInstanceAttributeResponseType* item);
...
void Json2Type(const Json::Value& value, EcsDescribeInstanceAttributeResponseType* item) {
  ...
  if(value.isMember("OperationLocks") && value["OperationLocks"].isMember("LockReason")) {
    Json2Array<EcsDescribeInstanceAttributeLockReasonType>(value["OperationLocks"]["LockReason"], &item->operation_locks);
  }
...
int Ecs::DescribeInstanceAttribute(const EcsDescribeInstanceAttributeRequestType& req,
                      EcsDescribeInstanceAttributeResponseType* response,
