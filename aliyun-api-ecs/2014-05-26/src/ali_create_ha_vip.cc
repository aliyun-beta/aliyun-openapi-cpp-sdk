...
void Json2Type(const Json::Value& value, CreateHaVipResponseType* item);
...
int Ecs::CreateHaVip(const CreateHaVipRequestType& req,
                      CreateHaVipResponseType* response,
