...
void Json2Type(const Json::Value& value, DescribeResourceByTagsResourceType* item);
void Json2Type(const Json::Value& value, DescribeResourceByTagsResponseType* item);
...
void Json2Type(const Json::Value& value, DescribeResourceByTagsResponseType* item) {
  ...
  if(value.isMember("Resources") && value["Resources"].isMember("Resource")) {
    Json2Array<DescribeResourceByTagsResourceType>(value["Resources"]["Resource"], &item->resources);
  }
}
}

int Ecs::DescribeResourceByTags(const DescribeResourceByTagsRequestType& req,
                      DescribeResourceByTagsResponseType* response,
