...
void Json2Type(const Json::Value& value, EcsDescribeHaVipsHaVipType* item);
void Json2Type(const Json::Value& value, EcsDescribeHaVipsResponseType* item);
...
void Json2Type(const Json::Value& value, EcsDescribeHaVipsResponseType* item) {
  ...
  if(value.isMember("HaVips") && value["HaVips"].isMember("HaVip")) {
    Json2Array<EcsDescribeHaVipsHaVipType>(value["HaVips"]["HaVip"], &item->ha_vips);
  }
}
}
