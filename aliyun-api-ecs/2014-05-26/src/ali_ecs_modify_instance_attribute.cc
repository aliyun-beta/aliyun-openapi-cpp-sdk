...
void Json2Type(const Json::Value& value, EcsModifyInstanceAttributeResponseType* item);
...
int Ecs::ModifyInstanceAttribute(const EcsModifyInstanceAttributeRequestType& req,
                      EcsModifyInstanceAttributeResponseType* response,
