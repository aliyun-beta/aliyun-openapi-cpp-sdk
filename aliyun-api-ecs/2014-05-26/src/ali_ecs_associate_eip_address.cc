...
void Json2Type(const Json::Value& value, EcsAssociateEipAddressResponseType* item);
...
int Ecs::AssociateEipAddress(const EcsAssociateEipAddressRequestType& req,
                      EcsAssociateEipAddressResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","AssociateEipAddress");
