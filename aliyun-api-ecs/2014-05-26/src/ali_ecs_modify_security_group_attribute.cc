...
void Json2Type(const Json::Value& value, EcsModifySecurityGroupAttributeResponseType* item);
...
int Ecs::ModifySecurityGroupAttribute(const EcsModifySecurityGroupAttributeRequestType& req,
                      EcsModifySecurityGroupAttributeResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","ModifySecurityGroupAttribute");
