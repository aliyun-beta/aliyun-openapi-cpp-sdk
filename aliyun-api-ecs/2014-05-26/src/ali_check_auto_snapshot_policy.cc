...
void Json2Type(const Json::Value& value, CheckAutoSnapshotPolicyResponseType* item);
...
int Ecs::CheckAutoSnapshotPolicy(const CheckAutoSnapshotPolicyRequestType& req,
                      CheckAutoSnapshotPolicyResponseType* response,
