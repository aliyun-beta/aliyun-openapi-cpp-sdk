...
void Json2Type(const Json::Value& value, ModifyVpcAttributeResponseType* item);
...
int Ecs::ModifyVpcAttribute(const ModifyVpcAttributeRequestType& req,
                      ModifyVpcAttributeResponseType* response,
