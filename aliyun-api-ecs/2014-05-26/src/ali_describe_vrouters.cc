...
void Json2Type(const Json::Value& value, DescribeVRoutersVRouterType* item);
void Json2Type(const Json::Value& value, DescribeVRoutersResponseType* item);
...
void Json2Type(const Json::Value& value, DescribeVRoutersResponseType* item) {
  ...
  if(value.isMember("VRouters") && value["VRouters"].isMember("VRouter")) {
    Json2Array<DescribeVRoutersVRouterType>(value["VRouters"]["VRouter"], &item->vrouters);
  }
}
}

int Ecs::DescribeVRouters(const DescribeVRoutersRequestType& req,
                      DescribeVRoutersResponseType* response,
