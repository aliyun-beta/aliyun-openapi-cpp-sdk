...
void Json2Type(const Json::Value& value, EcsDescribeSecurityGroupsSecurityGroupType* item);
void Json2Type(const Json::Value& value, EcsDescribeSecurityGroupsResponseType* item);
...
void Json2Type(const Json::Value& value, EcsDescribeSecurityGroupsResponseType* item) {
  ...
  if(value.isMember("SecurityGroups") && value["SecurityGroups"].isMember("SecurityGroup")) {
    Json2Array<EcsDescribeSecurityGroupsSecurityGroupType>(value["SecurityGroups"]["SecurityGroup"], &item->security_groups);
  }
}
}

int Ecs::DescribeSecurityGroups(const EcsDescribeSecurityGroupsRequestType& req,
                      EcsDescribeSecurityGroupsResponseType* response,
