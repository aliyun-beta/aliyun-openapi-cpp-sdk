...
void Json2Type(const Json::Value& value, EcsCreateHaVipResponseType* item);
...
int Ecs::CreateHaVip(const EcsCreateHaVipRequestType& req,
                      EcsCreateHaVipResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","CreateHaVip");
