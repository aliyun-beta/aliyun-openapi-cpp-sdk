...
void Json2Type(const Json::Value& value, ReplaceSystemDiskResponseType* item);
...
int Ecs::ReplaceSystemDisk(const ReplaceSystemDiskRequestType& req,
                      ReplaceSystemDiskResponseType* response,
