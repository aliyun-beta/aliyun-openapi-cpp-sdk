...
void Json2Type(const Json::Value& value, AssociateEipAddressResponseType* item);
...
int Ecs::AssociateEipAddress(const AssociateEipAddressRequestType& req,
                      AssociateEipAddressResponseType* response,
