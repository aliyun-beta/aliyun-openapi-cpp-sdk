...
void Json2Type(const Json::Value& value, CreateImageResponseType* item);
...
int Ecs::CreateImage(const CreateImageRequestType& req,
                      CreateImageResponseType* response,
