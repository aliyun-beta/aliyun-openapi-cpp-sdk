...
void Json2Type(const Json::Value& value, DeleteHaVipResponseType* item);
...
int Ecs::DeleteHaVip(const DeleteHaVipRequestType& req,
                      DeleteHaVipResponseType* response,
