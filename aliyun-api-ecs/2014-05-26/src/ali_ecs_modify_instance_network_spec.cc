...
void Json2Type(const Json::Value& value, EcsModifyInstanceNetworkSpecResponseType* item);
...
int Ecs::ModifyInstanceNetworkSpec(const EcsModifyInstanceNetworkSpecRequestType& req,
                      EcsModifyInstanceNetworkSpecResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","ModifyInstanceNetworkSpec");
