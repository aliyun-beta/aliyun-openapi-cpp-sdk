...
void Json2Type(const Json::Value& value, EcsDeleteHaVipResponseType* item);
...
int Ecs::DeleteHaVip(const EcsDeleteHaVipRequestType& req,
                      EcsDeleteHaVipResponseType* response,
