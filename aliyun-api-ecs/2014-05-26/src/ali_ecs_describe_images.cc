...
void Json2Type(const Json::Value& value, EcsDescribeImagesDiskDeviceMappingType* item);
void Json2Type(const Json::Value& value, EcsDescribeImagesTagType* item);
void Json2Type(const Json::Value& value, EcsDescribeImagesImageType* item);
void Json2Type(const Json::Value& value, EcsDescribeImagesResponseType* item);
...
void Json2Type(const Json::Value& value, EcsDescribeImagesImageType* item) {
  ...
  if(value.isMember("DiskDeviceMappings") && value["DiskDeviceMappings"].isMember("DiskDeviceMapping")) {
    Json2Array<EcsDescribeImagesDiskDeviceMappingType>(value["DiskDeviceMappings"]["DiskDeviceMapping"], &item->disk_device_mappings);
  }
  if(value.isMember("Tags") && value["Tags"].isMember("Tag")) {
    Json2Array<EcsDescribeImagesTagType>(value["Tags"]["Tag"], &item->tags);
  }
}
void Json2Type(const Json::Value& value, EcsDescribeImagesResponseType* item) {
  ...
  if(value.isMember("Images") && value["Images"].isMember("Image")) {
    Json2Array<EcsDescribeImagesImageType>(value["Images"]["Image"], &item->images);
  }
}
}

int Ecs::DescribeImages(const EcsDescribeImagesRequestType& req,
                      EcsDescribeImagesResponseType* response,
