...
void Json2Type(const Json::Value& value, DescribeTagKeysResponseType* item);
...
int Ecs::DescribeTagKeys(const DescribeTagKeysRequestType& req,
                      DescribeTagKeysResponseType* response,
