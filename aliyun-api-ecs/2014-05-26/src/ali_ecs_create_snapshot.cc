...
void Json2Type(const Json::Value& value, EcsCreateSnapshotResponseType* item);
...
int Ecs::CreateSnapshot(const EcsCreateSnapshotRequestType& req,
                      EcsCreateSnapshotResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","CreateSnapshot");
