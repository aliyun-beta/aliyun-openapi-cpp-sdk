...
void Json2Type(const Json::Value& value, EcsDescribeSnapshotsTagType* item);
void Json2Type(const Json::Value& value, EcsDescribeSnapshotsSnapshotType* item);
void Json2Type(const Json::Value& value, EcsDescribeSnapshotsResponseType* item);
...
void Json2Type(const Json::Value& value, EcsDescribeSnapshotsSnapshotType* item) {
  ...
  if(value.isMember("Tags") && value["Tags"].isMember("Tag")) {
    Json2Array<EcsDescribeSnapshotsTagType>(value["Tags"]["Tag"], &item->tags);
  }
}
void Json2Type(const Json::Value& value, EcsDescribeSnapshotsResponseType* item) {
  ...
  if(value.isMember("Snapshots") && value["Snapshots"].isMember("Snapshot")) {
    Json2Array<EcsDescribeSnapshotsSnapshotType>(value["Snapshots"]["Snapshot"], &item->snapshots);
  }
}
}

int Ecs::DescribeSnapshots(const EcsDescribeSnapshotsRequestType& req,
                      EcsDescribeSnapshotsResponseType* response,
