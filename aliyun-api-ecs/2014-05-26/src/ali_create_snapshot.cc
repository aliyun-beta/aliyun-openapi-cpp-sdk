...
void Json2Type(const Json::Value& value, CreateSnapshotResponseType* item);
...
int Ecs::CreateSnapshot(const CreateSnapshotRequestType& req,
                      CreateSnapshotResponseType* response,
