...
void Json2Type(const Json::Value& value, ModifyInstanceNetworkSpecResponseType* item);
...
int Ecs::ModifyInstanceNetworkSpec(const ModifyInstanceNetworkSpecRequestType& req,
                      ModifyInstanceNetworkSpecResponseType* response,
