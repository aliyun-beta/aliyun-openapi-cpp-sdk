...
void Json2Type(const Json::Value& value, CreateSecurityGroupResponseType* item);
...
int Ecs::CreateSecurityGroup(const CreateSecurityGroupRequestType& req,
                      CreateSecurityGroupResponseType* response,
