...
void Json2Type(const Json::Value& value, ModifySecurityGroupAttributeResponseType* item);
...
int Ecs::ModifySecurityGroupAttribute(const ModifySecurityGroupAttributeRequestType& req,
                      ModifySecurityGroupAttributeResponseType* response,
