...
void Json2Type(const Json::Value& value, DescribeEipAddressesLockReasonType* item);
void Json2Type(const Json::Value& value, DescribeEipAddressesEipAddressType* item);
void Json2Type(const Json::Value& value, DescribeEipAddressesResponseType* item);
...
void Json2Type(const Json::Value& value, DescribeEipAddressesEipAddressType* item) {
  ...
  if(value.isMember("OperationLocks") && value["OperationLocks"].isMember("LockReason")) {
    Json2Array<DescribeEipAddressesLockReasonType>(value["OperationLocks"]["LockReason"], &item->operation_locks);
  }
}
void Json2Type(const Json::Value& value, DescribeEipAddressesResponseType* item) {
  ...
  if(value.isMember("EipAddresses") && value["EipAddresses"].isMember("EipAddress")) {
    Json2Array<DescribeEipAddressesEipAddressType>(value["EipAddresses"]["EipAddress"], &item->eip_addresses);
  }
}
}

int Ecs::DescribeEipAddresses(const DescribeEipAddressesRequestType& req,
                      DescribeEipAddressesResponseType* response,
