...
void Json2Type(const Json::Value& value, EcsAssociateHaVipResponseType* item);
...
int Ecs::AssociateHaVip(const EcsAssociateHaVipRequestType& req,
                      EcsAssociateHaVipResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","AssociateHaVip");
