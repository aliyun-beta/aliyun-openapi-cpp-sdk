...
void Json2Type(const Json::Value& value, ModifyAutoSnapshotPolicyResponseType* item);
...
int Ecs::ModifyAutoSnapshotPolicy(const ModifyAutoSnapshotPolicyRequestType& req,
                      ModifyAutoSnapshotPolicyResponseType* response,
