...
void Json2Type(const Json::Value& value, ModifyImageAttributeResponseType* item);
...
int Ecs::ModifyImageAttribute(const ModifyImageAttributeRequestType& req,
                      ModifyImageAttributeResponseType* response,
