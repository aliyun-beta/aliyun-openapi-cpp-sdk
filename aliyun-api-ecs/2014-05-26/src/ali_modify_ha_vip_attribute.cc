...
void Json2Type(const Json::Value& value, ModifyHaVipAttributeResponseType* item);
...
int Ecs::ModifyHaVipAttribute(const ModifyHaVipAttributeRequestType& req,
                      ModifyHaVipAttributeResponseType* response,
