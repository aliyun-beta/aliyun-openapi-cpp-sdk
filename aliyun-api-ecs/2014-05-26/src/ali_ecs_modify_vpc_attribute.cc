...
void Json2Type(const Json::Value& value, EcsModifyVpcAttributeResponseType* item);
...
int Ecs::ModifyVpcAttribute(const EcsModifyVpcAttributeRequestType& req,
                      EcsModifyVpcAttributeResponseType* response,
