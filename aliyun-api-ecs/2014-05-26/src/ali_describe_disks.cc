...
void Json2Type(const Json::Value& value, DescribeDisksOperationLockType* item);
void Json2Type(const Json::Value& value, DescribeDisksTagType* item);
void Json2Type(const Json::Value& value, DescribeDisksDiskType* item);
void Json2Type(const Json::Value& value, DescribeDisksResponseType* item);
...
void Json2Type(const Json::Value& value, DescribeDisksDiskType* item) {
  ...
  if(value.isMember("OperationLocks") && value["OperationLocks"].isMember("OperationLock")) {
    Json2Array<DescribeDisksOperationLockType>(value["OperationLocks"]["OperationLock"], &item->operation_locks);
  }
  if(value.isMember("Tags") && value["Tags"].isMember("Tag")) {
    Json2Array<DescribeDisksTagType>(value["Tags"]["Tag"], &item->tags);
  }
}
void Json2Type(const Json::Value& value, DescribeDisksResponseType* item) {
  ...
  if(value.isMember("Disks") && value["Disks"].isMember("Disk")) {
    Json2Array<DescribeDisksDiskType>(value["Disks"]["Disk"], &item->disks);
  }
}
}

int Ecs::DescribeDisks(const DescribeDisksRequestType& req,
                      DescribeDisksResponseType* response,
