...
void Json2Type(const Json::Value& value, EcsDescribeVSwitchesVSwitchType* item);
void Json2Type(const Json::Value& value, EcsDescribeVSwitchesResponseType* item);
...
void Json2Type(const Json::Value& value, EcsDescribeVSwitchesResponseType* item) {
  ...
  if(value.isMember("VSwitches") && value["VSwitches"].isMember("VSwitch")) {
    Json2Array<EcsDescribeVSwitchesVSwitchType>(value["VSwitches"]["VSwitch"], &item->vswitches);
  }
}
}

int Ecs::DescribeVSwitches(const EcsDescribeVSwitchesRequestType& req,
                      EcsDescribeVSwitchesResponseType* response,
