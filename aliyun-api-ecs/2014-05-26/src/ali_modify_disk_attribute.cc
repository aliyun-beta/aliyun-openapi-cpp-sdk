...
void Json2Type(const Json::Value& value, ModifyDiskAttributeResponseType* item);
...
int Ecs::ModifyDiskAttribute(const ModifyDiskAttributeRequestType& req,
                      ModifyDiskAttributeResponseType* response,
