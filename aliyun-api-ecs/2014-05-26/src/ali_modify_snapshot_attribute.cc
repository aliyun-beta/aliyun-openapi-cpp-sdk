...
void Json2Type(const Json::Value& value, ModifySnapshotAttributeResponseType* item);
...
int Ecs::ModifySnapshotAttribute(const ModifySnapshotAttributeRequestType& req,
                      ModifySnapshotAttributeResponseType* response,
