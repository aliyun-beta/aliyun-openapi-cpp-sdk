...
void Json2Type(const Json::Value& value, EcsAuthorizeSecurityGroupResponseType* item);
...
int Ecs::AuthorizeSecurityGroup(const EcsAuthorizeSecurityGroupRequestType& req,
                      EcsAuthorizeSecurityGroupResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","AuthorizeSecurityGroup");
