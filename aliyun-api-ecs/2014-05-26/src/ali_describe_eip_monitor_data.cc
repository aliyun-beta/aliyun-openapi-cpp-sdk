...
void Json2Type(const Json::Value& value, DescribeEipMonitorDataEipMonitorDataType* item);
void Json2Type(const Json::Value& value, DescribeEipMonitorDataResponseType* item);
...
void Json2Type(const Json::Value& value, DescribeEipMonitorDataResponseType* item) {
  if(value.isMember("EipMonitorDatas") && value["EipMonitorDatas"].isMember("EipMonitorData")) {
    Json2Array<DescribeEipMonitorDataEipMonitorDataType>(value["EipMonitorDatas"]["EipMonitorData"], &item->eip_monitor_datas);
  }
}
}

int Ecs::DescribeEipMonitorData(const DescribeEipMonitorDataRequestType& req,
                      DescribeEipMonitorDataResponseType* response,
