...
void Json2Type(const Json::Value& value, ModifyImageSharePermissionResponseType* item);
...
int Ecs::ModifyImageSharePermission(const ModifyImageSharePermissionRequestType& req,
                      ModifyImageSharePermissionResponseType* response,
