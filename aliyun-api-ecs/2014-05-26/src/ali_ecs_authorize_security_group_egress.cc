...
void Json2Type(const Json::Value& value, EcsAuthorizeSecurityGroupEgressResponseType* item);
...
int Ecs::AuthorizeSecurityGroupEgress(const EcsAuthorizeSecurityGroupEgressRequestType& req,
                      EcsAuthorizeSecurityGroupEgressResponseType* response,
