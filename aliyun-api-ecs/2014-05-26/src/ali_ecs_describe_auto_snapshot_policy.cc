...
void Json2Type(const Json::Value& value, EcsDescribeAutoSnapshotPolicyAutoSnapshotPolicyType* item);
void Json2Type(const Json::Value& value, EcsDescribeAutoSnapshotPolicyAutoSnapshotExcutionStatusType* item);
void Json2Type(const Json::Value& value, EcsDescribeAutoSnapshotPolicyResponseType* item);
...
int Ecs::DescribeAutoSnapshotPolicy(const EcsDescribeAutoSnapshotPolicyRequestType& req,
                      EcsDescribeAutoSnapshotPolicyResponseType* response,
