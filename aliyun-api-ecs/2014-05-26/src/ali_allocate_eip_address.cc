...
void Json2Type(const Json::Value& value, AllocateEipAddressResponseType* item);
...
int Ecs::AllocateEipAddress(const AllocateEipAddressRequestType& req,
                      AllocateEipAddressResponseType* response,
