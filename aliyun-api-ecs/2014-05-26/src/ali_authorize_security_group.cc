...
void Json2Type(const Json::Value& value, AuthorizeSecurityGroupResponseType* item);
...
int Ecs::AuthorizeSecurityGroup(const AuthorizeSecurityGroupRequestType& req,
                      AuthorizeSecurityGroupResponseType* response,
