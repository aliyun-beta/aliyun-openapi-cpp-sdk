...
void Json2Type(const Json::Value& value, EcsDescribeVpcsVpcType* item);
void Json2Type(const Json::Value& value, EcsDescribeVpcsResponseType* item);
...
void Json2Type(const Json::Value& value, EcsDescribeVpcsResponseType* item) {
  ...
  if(value.isMember("Vpcs") && value["Vpcs"].isMember("Vpc")) {
    Json2Array<EcsDescribeVpcsVpcType>(value["Vpcs"]["Vpc"], &item->vpcs);
  }
}
}

int Ecs::DescribeVpcs(const EcsDescribeVpcsRequestType& req,
                      EcsDescribeVpcsResponseType* response,
