...
void Json2Type(const Json::Value& value, DescribeInstancesLockReasonType* item);
void Json2Type(const Json::Value& value, DescribeInstancesTagType* item);
void Json2Type(const Json::Value& value, DescribeInstancesVpcAttributesType* item);
void Json2Type(const Json::Value& value, DescribeInstancesEipAddressType* item);
void Json2Type(const Json::Value& value, DescribeInstancesInstanceType* item);
...
void Json2Type(const Json::Value& value, DescribeInstancesInstanceType* item) {
  ...
  if(value.isMember("OperationLocks") && value["OperationLocks"].isMember("LockReason")) {
    Json2Array<DescribeInstancesLockReasonType>(value["OperationLocks"]["LockReason"], &item->operation_locks);
  }
  if(value.isMember("Tags") && value["Tags"].isMember("Tag")) {
    Json2Array<DescribeInstancesTagType>(value["Tags"]["Tag"], &item->tags);
  }
...
void Json2Type(const Json::Value& value, DescribeInstancesResponseType* item) {
  ...
  if(value.isMember("Instances") && value["Instances"].isMember("Instance")) {
    Json2Array<DescribeInstancesInstanceType>(value["Instances"]["Instance"], &item->instances);
  }
}
}

int Ecs::DescribeInstances(const DescribeInstancesRequestType& req,
