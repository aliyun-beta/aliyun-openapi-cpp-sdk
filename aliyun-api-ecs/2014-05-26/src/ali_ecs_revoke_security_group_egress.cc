...
void Json2Type(const Json::Value& value, EcsRevokeSecurityGroupEgressResponseType* item);
...
int Ecs::RevokeSecurityGroupEgress(const EcsRevokeSecurityGroupEgressRequestType& req,
                      EcsRevokeSecurityGroupEgressResponseType* response,
