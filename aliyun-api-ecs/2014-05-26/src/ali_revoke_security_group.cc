...
void Json2Type(const Json::Value& value, RevokeSecurityGroupResponseType* item);
...
int Ecs::RevokeSecurityGroup(const RevokeSecurityGroupRequestType& req,
                      RevokeSecurityGroupResponseType* response,
