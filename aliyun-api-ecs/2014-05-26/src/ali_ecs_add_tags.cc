...
void Json2Type(const Json::Value& value, EcsAddTagsResponseType* item);
...
int Ecs::AddTags(const EcsAddTagsRequestType& req,
                      EcsAddTagsResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","AddTags");
