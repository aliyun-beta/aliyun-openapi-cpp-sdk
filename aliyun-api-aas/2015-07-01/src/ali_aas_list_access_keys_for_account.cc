...
void Json2Type(const Json::Value& value, AasListAccessKeysForAccountAccessKeyType* item);
void Json2Type(const Json::Value& value, AasListAccessKeysForAccountResponseType* item);
...
void Json2Type(const Json::Value& value, AasListAccessKeysForAccountResponseType* item) {
  ...
  if(value.isMember("AccessKeys") && value["AccessKeys"].isMember("AccessKey")) {
    Json2Array<AasListAccessKeysForAccountAccessKeyType>(value["AccessKeys"]["AccessKey"], &item->access_keys);
  }
}
}

int Aas::ListAccessKeysForAccount(const AasListAccessKeysForAccountRequestType& req,
                      AasListAccessKeysForAccountResponseType* response,
