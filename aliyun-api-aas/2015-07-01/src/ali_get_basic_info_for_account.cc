...
void Json2Type(const Json::Value& value, GetBasicInfoForAccountResponseType* item);
...
int Aas::GetBasicInfoForAccount(const GetBasicInfoForAccountRequestType& req,
                      GetBasicInfoForAccountResponseType* response,
