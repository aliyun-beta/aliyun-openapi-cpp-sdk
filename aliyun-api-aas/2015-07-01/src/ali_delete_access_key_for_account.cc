...
void Json2Type(const Json::Value& value, DeleteAccessKeyForAccountResponseType* item);
...
int Aas::DeleteAccessKeyForAccount(const DeleteAccessKeyForAccountRequestType& req,
                      DeleteAccessKeyForAccountResponseType* response,
