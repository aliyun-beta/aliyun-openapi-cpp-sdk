...
void Json2Type(const Json::Value& value, AasGetBasicInfoForAccountResponseType* item);
...
int Aas::GetBasicInfoForAccount(const AasGetBasicInfoForAccountRequestType& req,
                      AasGetBasicInfoForAccountResponseType* response,
