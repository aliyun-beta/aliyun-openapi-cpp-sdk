...
void Json2Type(const Json::Value& value, CreateAccessKeyForAccountAccessKeyType* item);
void Json2Type(const Json::Value& value, CreateAccessKeyForAccountResponseType* item);
...
int Aas::CreateAccessKeyForAccount(const CreateAccessKeyForAccountRequestType& req,
                      CreateAccessKeyForAccountResponseType* response,
