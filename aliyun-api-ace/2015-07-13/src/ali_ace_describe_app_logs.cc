...
void Json2Type(const Json::Value& value, AceDescribeAppLogsAppLogType* item);
void Json2Type(const Json::Value& value, AceDescribeAppLogsResponseType* item);
...
void Json2Type(const Json::Value& value, AceDescribeAppLogsResponseType* item) {
  ...
  if(value.isMember("Items") && value["Items"].isMember("AppLog")) {
    Json2Array<AceDescribeAppLogsAppLogType>(value["Items"]["AppLog"], &item->items);
  }
}
}

int Ace::DescribeAppLogs(const AceDescribeAppLogsRequestType& req,
                      AceDescribeAppLogsResponseType* response,
