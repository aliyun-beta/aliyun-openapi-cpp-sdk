...
void Json2Type(const Json::Value& value, GetMonitorDataItemType* item);
void Json2Type(const Json::Value& value, GetMonitorDataResponseType* item);
...
void Json2Type(const Json::Value& value, GetMonitorDataResponseType* item) {
  ...
  if(value.isMember("Data") && value["Data"].isMember("Item")) {
    Json2Array<GetMonitorDataItemType>(value["Data"]["Item"], &item->data);
  }
}
}

int Ace::GetMonitorData(const GetMonitorDataRequestType& req,
                      GetMonitorDataResponseType* response,
