...
void Json2Type(const Json::Value& value, AssumeRoleWithServiceIdentityCredentialsType* item);
void Json2Type(const Json::Value& value, AssumeRoleWithServiceIdentityAssumedRoleUserType* item);
void Json2Type(const Json::Value& value, AssumeRoleWithServiceIdentityResponseType* item);
...
int Sts::AssumeRoleWithServiceIdentity(const AssumeRoleWithServiceIdentityRequestType& req,
                      AssumeRoleWithServiceIdentityResponseType* response,
