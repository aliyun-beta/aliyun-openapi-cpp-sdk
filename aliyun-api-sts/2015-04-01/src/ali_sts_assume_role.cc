...
void Json2Type(const Json::Value& value, StsAssumeRoleCredentialsType* item);
void Json2Type(const Json::Value& value, StsAssumeRoleAssumedRoleUserType* item);
void Json2Type(const Json::Value& value, StsAssumeRoleResponseType* item);
...
int Sts::AssumeRole(const StsAssumeRoleRequestType& req,
                      StsAssumeRoleResponseType* response,
