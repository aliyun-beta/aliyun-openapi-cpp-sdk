...
void Json2Type(const Json::Value& value, StsAssumeRoleWithServiceIdentityCredentialsType* item);
void Json2Type(const Json::Value& value, StsAssumeRoleWithServiceIdentityAssumedRoleUserType* item);
void Json2Type(const Json::Value& value, StsAssumeRoleWithServiceIdentityResponseType* item);
...
int Sts::AssumeRoleWithServiceIdentity(const StsAssumeRoleWithServiceIdentityRequestType& req,
                      StsAssumeRoleWithServiceIdentityResponseType* response,
