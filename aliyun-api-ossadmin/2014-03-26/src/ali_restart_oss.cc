...
void Json2Type(const Json::Value& value, restartOssResponseType* item);
...
int OssAdmin::restartOss(const restartOssRequestType& req,
                      restartOssResponseType* response,
