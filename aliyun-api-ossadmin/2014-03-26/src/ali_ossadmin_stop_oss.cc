...
void Json2Type(const Json::Value& value, OssAdminstopOssResponseType* item);
...
int OssAdmin::stopOss(const OssAdminstopOssRequestType& req,
                      OssAdminstopOssResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","stopOss");
