...
void Json2Type(const Json::Value& value, OssAdminrestartOssResponseType* item);
...
int OssAdmin::restartOss(const OssAdminrestartOssRequestType& req,
                      OssAdminrestartOssResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","restartOss");
