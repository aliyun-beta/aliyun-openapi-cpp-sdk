...
void Json2Type(const Json::Value& value, PutBucketLimitResponseType* item);
...
int OssAdmin::PutBucketLimit(const PutBucketLimitRequestType& req,
                      PutBucketLimitResponseType* response,
