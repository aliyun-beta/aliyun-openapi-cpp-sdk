...
void Json2Type(const Json::Value& value, OssAdminPutBucketPolicyResponseType* item);
...
int OssAdmin::PutBucketPolicy(const OssAdminPutBucketPolicyRequestType& req,
                      OssAdminPutBucketPolicyResponseType* response,
