...
void Json2Type(const Json::Value& value, createOssInstanceResponseType* item);
...
int OssAdmin::createOssInstance(const createOssInstanceRequestType& req,
                      createOssInstanceResponseType* response,
