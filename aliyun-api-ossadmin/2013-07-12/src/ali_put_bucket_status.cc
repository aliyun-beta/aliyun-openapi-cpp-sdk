...
void Json2Type(const Json::Value& value, PutBucketStatusResponseType* item);
...
int OssAdmin::PutBucketStatus(const PutBucketStatusRequestType& req,
                      PutBucketStatusResponseType* response,
