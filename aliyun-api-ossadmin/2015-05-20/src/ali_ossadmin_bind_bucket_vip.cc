...
void Json2Type(const Json::Value& value, OssAdminBindBucketVipResponseType* item);
...
int OssAdmin::BindBucketVip(const OssAdminBindBucketVipRequestType& req,
                      OssAdminBindBucketVipResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","BindBucketVip");
