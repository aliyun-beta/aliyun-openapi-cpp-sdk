...
void Json2Type(const Json::Value& value, UnBindBucketVipResponseType* item);
...
int OssAdmin::UnBindBucketVip(const UnBindBucketVipRequestType& req,
                      UnBindBucketVipResponseType* response,
