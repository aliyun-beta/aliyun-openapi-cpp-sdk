...
void Json2Type(const Json::Value& value, BindBucketVipResponseType* item);
...
int OssAdmin::BindBucketVip(const BindBucketVipRequestType& req,
                      BindBucketVipResponseType* response,
