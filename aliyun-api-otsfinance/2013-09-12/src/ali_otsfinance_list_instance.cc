...
void Json2Type(const Json::Value& value, OtsFinanceListInstanceInstanceInfoType* item);
void Json2Type(const Json::Value& value, OtsFinanceListInstanceResponseType* item);
...
void Json2Type(const Json::Value& value, OtsFinanceListInstanceResponseType* item) {
  if(value.isMember("InstanceInfos") && value["InstanceInfos"].isMember("InstanceInfo")) {
    Json2Array<OtsFinanceListInstanceInstanceInfoType>(value["InstanceInfos"]["InstanceInfo"], &item->instance_infos);
  }
}
}
