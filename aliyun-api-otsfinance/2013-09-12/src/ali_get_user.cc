...
void Json2Type(const Json::Value& value, GetUserQuotaType* item);
void Json2Type(const Json::Value& value, GetUserUserInfoType* item);
...
int OtsFinance::GetUser(const GetUserRequestType& req,
