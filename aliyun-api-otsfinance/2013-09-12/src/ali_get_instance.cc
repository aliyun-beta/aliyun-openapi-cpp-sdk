...
void Json2Type(const Json::Value& value, GetInstanceQuotaType* item);
void Json2Type(const Json::Value& value, GetInstanceInstanceInfoType* item);
void Json2Type(const Json::Value& value, GetInstanceResponseType* item);
...
int OtsFinance::GetInstance(const GetInstanceRequestType& req,
                      GetInstanceResponseType* response,
