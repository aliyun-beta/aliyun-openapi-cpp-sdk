...
void Json2Type(const Json::Value& value, OtsFinanceGetUserQuotaType* item);
void Json2Type(const Json::Value& value, OtsFinanceGetUserUserInfoType* item);
void Json2Type(const Json::Value& value, OtsFinanceGetUserResponseType* item);
