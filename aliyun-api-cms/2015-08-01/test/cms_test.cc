...
static const char* test_batch_create_metrics_response = "{"
"  \"Code\": \"Code\","
"  \"Message\": \"Message\","
"  \"Success\": \"Success\","
"  \"TraceId\": \"TraceId\","
"  \"Result\": \"Result\""
"}";
static int test_batch_create_metrics() {
  ...
  listener->SetResponseBody(test_batch_create_metrics_response);
  listener->Start();
  req.project_name = "ProjectName";
  req.metric_stream_name = "MetricStreamName";
  req.sqls = "Sqls";
  int ret = cms->BatchCreateMetrics(req, &resp, NULL);
...
static const char* test_create_metrics_response = "{"
"  \"Code\": \"Code\","
"  \"Message\": \"Message\","
"  \"Success\": \"Success\","
"  \"TraceId\": \"TraceId\","
"  \"Result\": \"Result\""
"}";
static int test_create_metrics() {
  ...
  cms->SetUseTls(false);
  HttpTestListener* listener = new HttpTestListener(12234);
  listener->SetResponseBody(test_create_metrics_response);
  listener->Start();
  req.project_name = "ProjectName";
  req.metric_stream_name = "MetricStreamName";
  req.metrics = "Metrics";
  int ret = cms->CreateMetrics(req, &resp, NULL);
  listener->WaitComplete();
  delete listener;
  delete cms;
}
...
static const char* test_create_sq_lmetrics_response = "{"
"  \"Code\": \"Code\","
"  \"Message\": \"Message\","
"  \"Success\": \"Success\","
"  \"TraceId\": \"TraceId\","
"  \"Result\": \"Result\""
"}";
static int test_create_sq_lmetrics() {
  ...
  cms->SetUseTls(false);
  HttpTestListener* listener = new HttpTestListener(12234);
  listener->SetResponseBody(test_create_sq_lmetrics_response);
  listener->Start();
  req.project_name = "ProjectName";
  req.sql = "Sql";
  req.is_public = "IsPublic";
...
static const char* test_describe_metric_list_response = "{"
"  \"Datapoints\": {"
"    \"Datapoint\": ["
"      \"Datapoint\""
"    ]"
...
"  \"TraceId\": \"TraceId\""
"}";
static int test_describe_metric_list() {
  ...
  cms->SetUseTls(false);
  HttpTestListener* listener = new HttpTestListener(12234);
  listener->SetResponseBody(test_describe_metric_list_response);
  listener->Start();
  req.project = "Project";
  req.metric = "Metric";
  req.period = "Period";
  ...
  req.page = "Page";
  req.length = "Length";
  int ret = cms->DescribeMetricList(req, &resp, NULL);
  listener->WaitComplete();
  delete listener;
  delete cms;
}
...
static const char* test_get_metrics_response = "{"
"  \"Code\": \"Code\","
"  \"Message\": \"Message\","
"  \"Success\": \"Success\","
"  \"TraceId\": \"TraceId\","
...
static int test_get_metrics() {
  ...
  cms->SetUseTls(false);
  HttpTestListener* listener = new HttpTestListener(12234);
  listener->SetResponseBody(test_get_metrics_response);
  listener->Start();
  req.project_name = "ProjectName";
  req.metric_stream_name = "MetricStreamName";
  req.metric_name = "MetricName";
  int ret = cms->GetMetrics(req, &resp, NULL);
  listener->WaitComplete();
  delete listener;
  delete cms;
}
...
static const char* test_get_metric_stream_meta_response = "{"
"  \"Datapoints\": {"
"    \"Datapoint\": ["
"      \"Datapoint\""
"    ]"
...
"  \"TraceId\": \"TraceId\""
"}";
static int test_get_metric_stream_meta() {
  ...
  cms->SetUseTls(false);
  HttpTestListener* listener = new HttpTestListener(12234);
  listener->SetResponseBody(test_get_metric_stream_meta_response);
  listener->Start();
  req.project_name = "ProjectName";
  req.metric_stream_name = "MetricStreamName";
  int ret = cms->GetMetricStreamMeta(req, &resp, NULL);
  listener->WaitComplete();
  delete listener;
  delete cms;
}
static const char* test_get_metric_stream_status_response = "{"
"  \"Code\": \"Code\","
"  \"Message\": \"Message\","
"  \"Success\": \"Success\","
"  \"TraceId\": \"TraceId\""
"}";
static int test_get_metric_stream_status() {
  ...
  cms->SetUseTls(false);
  HttpTestListener* listener = new HttpTestListener(12234);
  listener->SetResponseBody(test_get_metric_stream_status_response);
  listener->Start();
  req.project_name = "ProjectName";
  req.metric_stream_name = "MetricStreamName";
  int ret = cms->GetMetricStreamStatus(req, &resp, NULL);
  listener->WaitComplete();
  delete listener;
  delete cms;
}
...
static const char* test_get_sq_lmetrics_response = "{"
"  \"Code\": \"Code\","
"  \"Message\": \"Message\","
"  \"Success\": \"Success\","
"  \"TraceId\": \"TraceId\","
"  \"Result\": \"Result\""
"}";
static int test_get_sq_lmetrics() {
  ...
  cms->SetUseTls(false);
  HttpTestListener* listener = new HttpTestListener(12234);
  listener->SetResponseBody(test_get_sq_lmetrics_response);
  listener->Start();
  req.project_name = "ProjectName";
  req.metric_name = "MetricName";
...
static const char* test_list_dim_table_data_response = "{"
"  \"Code\": \"Code\","
"  \"Message\": \"Message\","
"  \"Success\": \"Success\","
"  \"TraceId\": \"TraceId\","
"  \"Result\": \"Result\""
"}";
static int test_list_dim_table_data() {
  ...
  cms->SetUseTls(false);
  HttpTestListener* listener = new HttpTestListener(12234);
  listener->SetResponseBody(test_list_dim_table_data_response);
  listener->Start();
  req.dim_table_name = "DimTableName";
  req.key = "Key";
  int ret = cms->ListDimTableData(req, &resp, NULL);
  listener->WaitComplete();
  delete listener;
  delete cms;
}
static const char* test_list_metrics_response = "{"
"  \"Datapoints\": {"
"    \"Datapoint\": ["
"      \"Datapoint\""
"    ]"
...
static int test_list_metrics() {
  ...
  cms->SetUseTls(false);
  HttpTestListener* listener = new HttpTestListener(12234);
  listener->SetResponseBody(test_list_metrics_response);
  listener->Start();
  req.project_name = "ProjectName";
  req.metric_stream_name = "MetricStreamName";
  req.metric_name = "MetricName";
  req.page = "Page";
  req.page_size = "PageSize";
  int ret = cms->ListMetrics(req, &resp, NULL);
  listener->WaitComplete();
  delete listener;
  delete cms;
}
static const char* test_list_metrics_plan_response = "{"
"  \"Datapoints\": {"
"    \"Datapoint\": ["
"      \"Datapoint\""
"    ]"
...
"  \"TraceId\": \"TraceId\""
"}";
static int test_list_metrics_plan() {
  ...
  cms->SetUseTls(false);
  HttpTestListener* listener = new HttpTestListener(12234);
  listener->SetResponseBody(test_list_metrics_plan_response);
  listener->Start();
  req.project_name = "ProjectName";
  req.metric_stream_name = "MetricStreamName";
  req.metric_name = "MetricName";
  req.page = "Page";
  req.page_size = "PageSize";
  int ret = cms->ListMetricsPlan(req, &resp, NULL);
  listener->WaitComplete();
  delete listener;
  delete cms;
}
...
static const char* test_list_sq_lmetrics_response = "{"
"  \"Datapoints\": {"
"    \"Datapoint\": ["
"      \"Datapoint\""
"    ]"
...
"  \"TraceId\": \"TraceId\""
"}";
static int test_list_sq_lmetrics() {
  ...
  cms->SetUseTls(false);
  HttpTestListener* listener = new HttpTestListener(12234);
  listener->SetResponseBody(test_list_sq_lmetrics_response);
  listener->Start();
  req.project_name = "ProjectName";
  req.metric_name = "MetricName";
  req.page = "Page";
...
static const char* test_start_metric_stream_response = "{"
"  \"Code\": \"Code\","
"  \"Message\": \"Message\","
"  \"Success\": \"Success\","
"  \"TraceId\": \"TraceId\""
"}";
static int test_start_metric_stream() {
  ...
  cms->SetUseTls(false);
  HttpTestListener* listener = new HttpTestListener(12234);
  listener->SetResponseBody(test_start_metric_stream_response);
  listener->Start();
  req.project_name = "ProjectName";
  req.metric_stream_name = "MetricStreamName";
  int ret = cms->StartMetricStream(req, &resp, NULL);
  listener->WaitComplete();
  delete listener;
  delete cms;
}
...
static const char* test_stop_metric_stream_response = "{"
"  \"Code\": \"Code\","
"  \"Message\": \"Message\","
"  \"Success\": \"Success\","
"  \"TraceId\": \"TraceId\""
"}";
static int test_stop_metric_stream() {
  ...
  cms->SetUseTls(false);
  HttpTestListener* listener = new HttpTestListener(12234);
  listener->SetResponseBody(test_stop_metric_stream_response);
  listener->Start();
  req.project_name = "ProjectName";
  req.metric_stream_name = "MetricStreamName";
  int ret = cms->StopMetricStream(req, &resp, NULL);
  listener->WaitComplete();
  delete listener;
  delete cms;
}
...
static const char* test_update_metrics_response = "{"
"  \"Code\": \"Code\","
"  \"Message\": \"Message\","
"  \"Success\": \"Success\","
"  \"TraceId\": \"TraceId\""
"}";
static int test_update_metrics() {
  ...
  cms->SetUseTls(false);
  HttpTestListener* listener = new HttpTestListener(12234);
  listener->SetResponseBody(test_update_metrics_response);
  listener->Start();
  req.project_name = "ProjectName";
  req.metric_stream_name = "MetricStreamName";
  req.metric_name = "MetricName";
  req.metrics = "Metrics";
  int ret = cms->UpdateMetrics(req, &resp, NULL);
  listener->WaitComplete();
  delete listener;
  delete cms;
}
...
static const char* test_update_sq_lmetrics_response = "{"
"  \"Code\": \"Code\","
"  \"Message\": \"Message\","
"  \"Success\": \"Success\","
"  \"TraceId\": \"TraceId\""
"}";
static int test_update_sq_lmetrics() {
  ...
  cms->SetUseTls(false);
  HttpTestListener* listener = new HttpTestListener(12234);
  listener->SetResponseBody(test_update_sq_lmetrics_response);
  listener->Start();
  req.project_name = "ProjectName";
  req.metric_name = "MetricName";
  req.sql = "Sql";
