...
void Json2Type(const Json::Value& value, CmsCreateSQLMetricsResponseType* item);
...
int Cms::CreateSQLMetrics(const CmsCreateSQLMetricsRequestType& req,
                      CmsCreateSQLMetricsResponseType* response,
