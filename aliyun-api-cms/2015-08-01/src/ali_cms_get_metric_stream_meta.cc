...
void Json2Type(const Json::Value& value, CmsGetMetricStreamMetaResponseType* item);
...
int Cms::GetMetricStreamMeta(const CmsGetMetricStreamMetaRequestType& req,
                      CmsGetMetricStreamMetaResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","GetMetricStreamMeta");
