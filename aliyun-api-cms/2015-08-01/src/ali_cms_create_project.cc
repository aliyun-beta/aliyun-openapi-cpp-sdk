...
void Json2Type(const Json::Value& value, CmsCreateProjectResponseType* item);
...
int Cms::CreateProject(const CmsCreateProjectRequestType& req,
                      CmsCreateProjectResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","CreateProject");
