...
void Json2Type(const Json::Value& value, CmsListMetricsPlanResponseType* item);
...
int Cms::ListMetricsPlan(const CmsListMetricsPlanRequestType& req,
                      CmsListMetricsPlanResponseType* response,
