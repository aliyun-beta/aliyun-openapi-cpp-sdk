...
void Json2Type(const Json::Value& value, QueryStatisticsResponseType* item);
...
int Cms::QueryStatistics(const QueryStatisticsRequestType& req,
                      QueryStatisticsResponseType* response,
