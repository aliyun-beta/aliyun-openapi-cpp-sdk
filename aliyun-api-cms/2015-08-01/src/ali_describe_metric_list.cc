...
void Json2Type(const Json::Value& value, DescribeMetricListResponseType* item);
...
int Cms::DescribeMetricList(const DescribeMetricListRequestType& req,
                      DescribeMetricListResponseType* response,
