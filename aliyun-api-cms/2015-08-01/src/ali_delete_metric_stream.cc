...
void Json2Type(const Json::Value& value, DeleteMetricStreamResponseType* item);
...
int Cms::DeleteMetricStream(const DeleteMetricStreamRequestType& req,
                      DeleteMetricStreamResponseType* response,
