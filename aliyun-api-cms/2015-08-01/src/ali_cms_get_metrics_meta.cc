...
void Json2Type(const Json::Value& value, CmsGetMetricsMetaResponseType* item);
...
int Cms::GetMetricsMeta(const CmsGetMetricsMetaRequestType& req,
                      CmsGetMetricsMetaResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","GetMetricsMeta");
