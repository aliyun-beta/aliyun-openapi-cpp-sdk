...
void Json2Type(const Json::Value& value, CmsDescribeMetricResponseType* item);
...
int Cms::DescribeMetric(const CmsDescribeMetricRequestType& req,
                      CmsDescribeMetricResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","DescribeMetric");
