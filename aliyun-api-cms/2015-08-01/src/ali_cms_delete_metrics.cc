...
void Json2Type(const Json::Value& value, CmsDeleteMetricsResponseType* item);
...
int Cms::DeleteMetrics(const CmsDeleteMetricsRequestType& req,
                      CmsDeleteMetricsResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","DeleteMetrics");
