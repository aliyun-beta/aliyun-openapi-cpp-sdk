...
void Json2Type(const Json::Value& value, BatchCreateMetricsResponseType* item);
...
int Cms::BatchCreateMetrics(const BatchCreateMetricsRequestType& req,
                      BatchCreateMetricsResponseType* response,
