...
void Json2Type(const Json::Value& value, DeleteProjectResponseType* item);
...
int Cms::DeleteProject(const DeleteProjectRequestType& req,
                      DeleteProjectResponseType* response,
