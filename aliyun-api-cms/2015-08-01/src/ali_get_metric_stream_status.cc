...
void Json2Type(const Json::Value& value, GetMetricStreamStatusResponseType* item);
...
int Cms::GetMetricStreamStatus(const GetMetricStreamStatusRequestType& req,
                      GetMetricStreamStatusResponseType* response,
