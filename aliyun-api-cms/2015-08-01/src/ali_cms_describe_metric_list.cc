...
void Json2Type(const Json::Value& value, CmsDescribeMetricListResponseType* item);
...
int Cms::DescribeMetricList(const CmsDescribeMetricListRequestType& req,
                      CmsDescribeMetricListResponseType* response,
