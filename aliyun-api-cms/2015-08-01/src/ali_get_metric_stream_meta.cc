...
void Json2Type(const Json::Value& value, GetMetricStreamMetaResponseType* item);
...
int Cms::GetMetricStreamMeta(const GetMetricStreamMetaRequestType& req,
                      GetMetricStreamMetaResponseType* response,
