...
void Json2Type(const Json::Value& value, CmsDeleteDimTableResponseType* item);
...
int Cms::DeleteDimTable(const CmsDeleteDimTableRequestType& req,
                      CmsDeleteDimTableResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","DeleteDimTable");
