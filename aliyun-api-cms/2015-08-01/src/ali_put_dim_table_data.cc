...
void Json2Type(const Json::Value& value, PutDimTableDataResponseType* item);
...
int Cms::PutDimTableData(const PutDimTableDataRequestType& req,
                      PutDimTableDataResponseType* response,
