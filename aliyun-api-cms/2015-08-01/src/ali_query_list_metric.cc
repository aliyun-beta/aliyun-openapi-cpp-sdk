...
void Json2Type(const Json::Value& value, QueryListMetricResponseType* item);
...
int Cms::QueryListMetric(const QueryListMetricRequestType& req,
                      QueryListMetricResponseType* response,
