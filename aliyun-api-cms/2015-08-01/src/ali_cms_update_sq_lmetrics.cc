...
void Json2Type(const Json::Value& value, CmsupdateSQLMetricsResponseType* item);
...
int Cms::updateSQLMetrics(const CmsupdateSQLMetricsRequestType& req,
                      CmsupdateSQLMetricsResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","updateSQLMetrics");
