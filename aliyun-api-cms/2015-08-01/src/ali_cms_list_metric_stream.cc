...
void Json2Type(const Json::Value& value, CmsListMetricStreamResponseType* item);
...
int Cms::ListMetricStream(const CmsListMetricStreamRequestType& req,
                      CmsListMetricStreamResponseType* response,
