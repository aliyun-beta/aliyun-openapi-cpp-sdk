...
void Json2Type(const Json::Value& value, CreateDimTableResponseType* item);
...
int Cms::CreateDimTable(const CreateDimTableRequestType& req,
                      CreateDimTableResponseType* response,
