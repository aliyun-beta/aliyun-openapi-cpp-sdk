...
void Json2Type(const Json::Value& value, CmsDeleteProjectResponseType* item);
...
int Cms::DeleteProject(const CmsDeleteProjectRequestType& req,
                      CmsDeleteProjectResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","DeleteProject");
