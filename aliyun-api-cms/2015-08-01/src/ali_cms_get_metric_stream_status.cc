...
void Json2Type(const Json::Value& value, CmsGetMetricStreamStatusResponseType* item);
...
int Cms::GetMetricStreamStatus(const CmsGetMetricStreamStatusRequestType& req,
                      CmsGetMetricStreamStatusResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","GetMetricStreamStatus");
