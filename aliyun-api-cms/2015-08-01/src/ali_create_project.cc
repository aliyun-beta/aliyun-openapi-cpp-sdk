...
void Json2Type(const Json::Value& value, CreateProjectResponseType* item);
...
int Cms::CreateProject(const CreateProjectRequestType& req,
                      CreateProjectResponseType* response,
