...
void Json2Type(const Json::Value& value, CmsBatchCreateMetricsResponseType* item);
...
int Cms::BatchCreateMetrics(const CmsBatchCreateMetricsRequestType& req,
                      CmsBatchCreateMetricsResponseType* response,
