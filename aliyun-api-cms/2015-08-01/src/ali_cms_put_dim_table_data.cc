...
void Json2Type(const Json::Value& value, CmsPutDimTableDataResponseType* item);
...
int Cms::PutDimTableData(const CmsPutDimTableDataRequestType& req,
                      CmsPutDimTableDataResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","PutDimTableData");
