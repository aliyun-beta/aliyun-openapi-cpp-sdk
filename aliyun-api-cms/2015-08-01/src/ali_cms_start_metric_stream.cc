...
void Json2Type(const Json::Value& value, CmsStartMetricStreamResponseType* item);
...
int Cms::StartMetricStream(const CmsStartMetricStreamRequestType& req,
                      CmsStartMetricStreamResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","StartMetricStream");
