...
void Json2Type(const Json::Value& value, CmsGetMetricStreamResponseType* item);
...
int Cms::GetMetricStream(const CmsGetMetricStreamRequestType& req,
                      CmsGetMetricStreamResponseType* response,
