...
void Json2Type(const Json::Value& value, QueryMetricResponseType* item);
...
int Cms::QueryMetric(const QueryMetricRequestType& req,
                      QueryMetricResponseType* response,
