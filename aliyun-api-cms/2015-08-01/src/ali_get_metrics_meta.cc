...
void Json2Type(const Json::Value& value, GetMetricsMetaResponseType* item);
...
int Cms::GetMetricsMeta(const GetMetricsMetaRequestType& req,
                      GetMetricsMetaResponseType* response,
