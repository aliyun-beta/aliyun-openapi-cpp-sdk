...
void Json2Type(const Json::Value& value, CmsCreateMetricStreamResponseType* item);
...
int Cms::CreateMetricStream(const CmsCreateMetricStreamRequestType& req,
                      CmsCreateMetricStreamResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","CreateMetricStream");
