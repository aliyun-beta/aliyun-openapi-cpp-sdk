...
void Json2Type(const Json::Value& value, BatchCreateSqlMetricsResponseType* item);
...
int Cms::BatchCreateSqlMetrics(const BatchCreateSqlMetricsRequestType& req,
                      BatchCreateSqlMetricsResponseType* response,
