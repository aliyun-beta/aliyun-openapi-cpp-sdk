...
void Json2Type(const Json::Value& value, GetMetricStreamResponseType* item);
...
int Cms::GetMetricStream(const GetMetricStreamRequestType& req,
                      GetMetricStreamResponseType* response,
