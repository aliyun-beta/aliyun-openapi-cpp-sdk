...
void Json2Type(const Json::Value& value, StartMetricStreamResponseType* item);
...
int Cms::StartMetricStream(const StartMetricStreamRequestType& req,
                      StartMetricStreamResponseType* response,
