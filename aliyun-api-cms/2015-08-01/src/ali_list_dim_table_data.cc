...
void Json2Type(const Json::Value& value, ListDimTableDataResponseType* item);
...
int Cms::ListDimTableData(const ListDimTableDataRequestType& req,
                      ListDimTableDataResponseType* response,
