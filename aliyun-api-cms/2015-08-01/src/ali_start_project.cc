...
void Json2Type(const Json::Value& value, StartProjectResponseType* item);
...
int Cms::StartProject(const StartProjectRequestType& req,
                      StartProjectResponseType* response,
