...
void Json2Type(const Json::Value& value, CmsGetSQLMetricsResponseType* item);
...
int Cms::GetSQLMetrics(const CmsGetSQLMetricsRequestType& req,
                      CmsGetSQLMetricsResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","GetSQLMetrics");
