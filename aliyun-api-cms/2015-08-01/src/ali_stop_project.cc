...
void Json2Type(const Json::Value& value, StopProjectResponseType* item);
...
int Cms::StopProject(const StopProjectRequestType& req,
                      StopProjectResponseType* response,
