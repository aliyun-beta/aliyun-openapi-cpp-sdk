...
void Json2Type(const Json::Value& value, DeleteDimTableResponseType* item);
...
int Cms::DeleteDimTable(const DeleteDimTableRequestType& req,
                      DeleteDimTableResponseType* response,
