...
void Json2Type(const Json::Value& value, CmsUpdateMetricsResponseType* item);
...
int Cms::UpdateMetrics(const CmsUpdateMetricsRequestType& req,
                      CmsUpdateMetricsResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","UpdateMetrics");
