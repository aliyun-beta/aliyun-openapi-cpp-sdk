...
void Json2Type(const Json::Value& value, CmsListMetricsResponseType* item);
...
int Cms::ListMetrics(const CmsListMetricsRequestType& req,
                      CmsListMetricsResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","ListMetrics");
