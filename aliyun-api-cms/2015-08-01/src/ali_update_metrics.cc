...
void Json2Type(const Json::Value& value, UpdateMetricsResponseType* item);
...
int Cms::UpdateMetrics(const UpdateMetricsRequestType& req,
                      UpdateMetricsResponseType* response,
