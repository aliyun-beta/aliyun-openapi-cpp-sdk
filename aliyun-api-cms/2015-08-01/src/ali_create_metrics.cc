...
void Json2Type(const Json::Value& value, CreateMetricsResponseType* item);
...
int Cms::CreateMetrics(const CreateMetricsRequestType& req,
                      CreateMetricsResponseType* response,
