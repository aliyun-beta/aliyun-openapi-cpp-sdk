...
void Json2Type(const Json::Value& value, CmsDeleteMetricStreamResponseType* item);
...
int Cms::DeleteMetricStream(const CmsDeleteMetricStreamRequestType& req,
                      CmsDeleteMetricStreamResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","DeleteMetricStream");
