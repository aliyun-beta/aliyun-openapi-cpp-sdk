...
void Json2Type(const Json::Value& value, CmsGetMetricsResponseType* item);
...
int Cms::GetMetrics(const CmsGetMetricsRequestType& req,
                      CmsGetMetricsResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","GetMetrics");
