...
void Json2Type(const Json::Value& value, ListProjectResponseType* item);
...
int Cms::ListProject(const ListProjectRequestType& req,
                      ListProjectResponseType* response,
