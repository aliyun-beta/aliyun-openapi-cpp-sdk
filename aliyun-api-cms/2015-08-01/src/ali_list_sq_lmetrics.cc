...
void Json2Type(const Json::Value& value, ListSQLMetricsResponseType* item);
...
int Cms::ListSQLMetrics(const ListSQLMetricsRequestType& req,
                      ListSQLMetricsResponseType* response,
