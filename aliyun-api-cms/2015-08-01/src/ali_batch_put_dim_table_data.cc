...
void Json2Type(const Json::Value& value, BatchPutDimTableDataResponseType* item);
...
int Cms::BatchPutDimTableData(const BatchPutDimTableDataRequestType& req,
                      BatchPutDimTableDataResponseType* response,
