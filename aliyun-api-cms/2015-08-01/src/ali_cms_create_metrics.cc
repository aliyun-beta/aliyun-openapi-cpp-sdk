...
void Json2Type(const Json::Value& value, CmsCreateMetricsResponseType* item);
...
int Cms::CreateMetrics(const CmsCreateMetricsRequestType& req,
                      CmsCreateMetricsResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","CreateMetrics");
