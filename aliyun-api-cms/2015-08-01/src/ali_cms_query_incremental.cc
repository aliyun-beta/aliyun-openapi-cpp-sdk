...
void Json2Type(const Json::Value& value, CmsQueryIncrementalResponseType* item);
...
int Cms::QueryIncremental(const CmsQueryIncrementalRequestType& req,
                      CmsQueryIncrementalResponseType* response,
