...
void Json2Type(const Json::Value& value, CmsStopMetricStreamResponseType* item);
...
int Cms::StopMetricStream(const CmsStopMetricStreamRequestType& req,
                      CmsStopMetricStreamResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","StopMetricStream");
