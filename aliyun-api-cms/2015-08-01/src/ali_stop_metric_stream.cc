...
void Json2Type(const Json::Value& value, StopMetricStreamResponseType* item);
...
int Cms::StopMetricStream(const StopMetricStreamRequestType& req,
                      StopMetricStreamResponseType* response,
