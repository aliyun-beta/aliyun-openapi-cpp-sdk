...
void Json2Type(const Json::Value& value, ListMetricsResponseType* item);
...
int Cms::ListMetrics(const ListMetricsRequestType& req,
                      ListMetricsResponseType* response,
