...
void Json2Type(const Json::Value& value, CmsUpdateDimTableResponseType* item);
...
int Cms::UpdateDimTable(const CmsUpdateDimTableRequestType& req,
                      CmsUpdateDimTableResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","UpdateDimTable");
