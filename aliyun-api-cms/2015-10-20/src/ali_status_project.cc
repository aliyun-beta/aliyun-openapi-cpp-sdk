...
void Json2Type(const Json::Value& value, StatusProjectResponseType* item);
...
int Cms::StatusProject(const StatusProjectRequestType& req,
                      StatusProjectResponseType* response,
