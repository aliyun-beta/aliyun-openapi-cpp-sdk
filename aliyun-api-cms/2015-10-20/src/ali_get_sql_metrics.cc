...
void Json2Type(const Json::Value& value, GetSqlMetricsResponseType* item);
...
int Cms::GetSqlMetrics(const GetSqlMetricsRequestType& req,
                      GetSqlMetricsResponseType* response,
