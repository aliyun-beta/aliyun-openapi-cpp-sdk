...
void Json2Type(const Json::Value& value, CmsBatchCreateSqlMetricsResponseType* item);
...
int Cms::BatchCreateSqlMetrics(const CmsBatchCreateSqlMetricsRequestType& req,
                      CmsBatchCreateSqlMetricsResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","BatchCreateSqlMetrics");
