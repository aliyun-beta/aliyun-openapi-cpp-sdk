...
void Json2Type(const Json::Value& value, CmsListDimTableResponseType* item);
...
int Cms::ListDimTable(const CmsListDimTableRequestType& req,
                      CmsListDimTableResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","ListDimTable");
