...
void Json2Type(const Json::Value& value, DeleteDimTableDataResponseType* item);
...
int Cms::DeleteDimTableData(const DeleteDimTableDataRequestType& req,
                      DeleteDimTableDataResponseType* response,
