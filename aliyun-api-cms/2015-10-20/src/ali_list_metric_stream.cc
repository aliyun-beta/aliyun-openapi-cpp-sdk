...
void Json2Type(const Json::Value& value, ListMetricStreamResponseType* item);
...
int Cms::ListMetricStream(const ListMetricStreamRequestType& req,
                      ListMetricStreamResponseType* response,
