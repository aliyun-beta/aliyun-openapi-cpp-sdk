...
void Json2Type(const Json::Value& value, UpdateDimTableResponseType* item);
...
int Cms::UpdateDimTable(const UpdateDimTableRequestType& req,
                      UpdateDimTableResponseType* response,
