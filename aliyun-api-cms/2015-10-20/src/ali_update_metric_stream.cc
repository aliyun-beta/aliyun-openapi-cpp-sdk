...
void Json2Type(const Json::Value& value, UpdateMetricStreamResponseType* item);
...
int Cms::UpdateMetricStream(const UpdateMetricStreamRequestType& req,
                      UpdateMetricStreamResponseType* response,
