...
void Json2Type(const Json::Value& value, ListDimTableResponseType* item);
...
int Cms::ListDimTable(const ListDimTableRequestType& req,
                      ListDimTableResponseType* response,
