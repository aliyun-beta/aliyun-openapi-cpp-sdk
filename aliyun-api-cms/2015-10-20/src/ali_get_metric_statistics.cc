...
void Json2Type(const Json::Value& value, GetMetricStatisticsResponseType* item);
...
int Cms::GetMetricStatistics(const GetMetricStatisticsRequestType& req,
                      GetMetricStatisticsResponseType* response,
