...
void Json2Type(const Json::Value& value, DeleteMetricsResponseType* item);
...
int Cms::DeleteMetrics(const DeleteMetricsRequestType& req,
                      DeleteMetricsResponseType* response,
