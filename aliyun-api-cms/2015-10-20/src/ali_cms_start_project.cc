...
void Json2Type(const Json::Value& value, CmsStartProjectResponseType* item);
...
int Cms::StartProject(const CmsStartProjectRequestType& req,
                      CmsStartProjectResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","StartProject");
