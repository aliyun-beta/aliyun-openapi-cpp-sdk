...
void Json2Type(const Json::Value& value, CmsGetDimTableResponseType* item);
...
int Cms::GetDimTable(const CmsGetDimTableRequestType& req,
                      CmsGetDimTableResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","GetDimTable");
