...
void Json2Type(const Json::Value& value, BatchQueryMetricResponseType* item);
...
int Cms::BatchQueryMetric(const BatchQueryMetricRequestType& req,
                      BatchQueryMetricResponseType* response,
