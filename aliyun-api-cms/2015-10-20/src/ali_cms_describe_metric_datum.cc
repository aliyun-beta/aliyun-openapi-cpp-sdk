...
void Json2Type(const Json::Value& value, CmsDescribeMetricDatumResponseType* item);
...
int Cms::DescribeMetricDatum(const CmsDescribeMetricDatumRequestType& req,
                      CmsDescribeMetricDatumResponseType* response,
