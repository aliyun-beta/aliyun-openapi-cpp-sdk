...
void Json2Type(const Json::Value& value, CmsGetProjectResponseType* item);
...
int Cms::GetProject(const CmsGetProjectRequestType& req,
                      CmsGetProjectResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","GetProject");
