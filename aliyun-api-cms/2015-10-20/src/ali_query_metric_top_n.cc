...
void Json2Type(const Json::Value& value, QueryMetricTopNResponseType* item);
...
int Cms::QueryMetricTopN(const QueryMetricTopNRequestType& req,
                      QueryMetricTopNResponseType* response,
