...
void Json2Type(const Json::Value& value, DescribeMetricResponseType* item);
...
int Cms::DescribeMetric(const DescribeMetricRequestType& req,
                      DescribeMetricResponseType* response,
