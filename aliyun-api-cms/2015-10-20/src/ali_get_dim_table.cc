...
void Json2Type(const Json::Value& value, GetDimTableResponseType* item);
...
int Cms::GetDimTable(const GetDimTableRequestType& req,
                      GetDimTableResponseType* response,
