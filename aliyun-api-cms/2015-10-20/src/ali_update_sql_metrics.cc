...
void Json2Type(const Json::Value& value, UpdateSqlMetricsResponseType* item);
...
int Cms::UpdateSqlMetrics(const UpdateSqlMetricsRequestType& req,
                      UpdateSqlMetricsResponseType* response,
