...
void Json2Type(const Json::Value& value, UpdateProjectResponseType* item);
...
int Cms::UpdateProject(const UpdateProjectRequestType& req,
                      UpdateProjectResponseType* response,
