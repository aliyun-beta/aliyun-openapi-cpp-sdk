...
void Json2Type(const Json::Value& value, CmsUpdateProjectResponseType* item);
...
int Cms::UpdateProject(const CmsUpdateProjectRequestType& req,
                      CmsUpdateProjectResponseType* response,
