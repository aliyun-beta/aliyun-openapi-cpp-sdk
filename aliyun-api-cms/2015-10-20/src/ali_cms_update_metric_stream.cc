...
void Json2Type(const Json::Value& value, CmsUpdateMetricStreamResponseType* item);
...
int Cms::UpdateMetricStream(const CmsUpdateMetricStreamRequestType& req,
                      CmsUpdateMetricStreamResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","UpdateMetricStream");
  ...
  if(!req.metric_stream.empty()) {
    req_rpc->AddRequestQuery("MetricStream", req.metric_stream);
  }
