...
void Json2Type(const Json::Value& value, CmsListSqlMetricsResponseType* item);
...
int Cms::ListSqlMetrics(const CmsListSqlMetricsRequestType& req,
                      CmsListSqlMetricsResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","ListSqlMetrics");
