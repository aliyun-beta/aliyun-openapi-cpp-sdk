...
void Json2Type(const Json::Value& value, CmsStatusProjectResponseType* item);
...
int Cms::StatusProject(const CmsStatusProjectRequestType& req,
                      CmsStatusProjectResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","StatusProject");
