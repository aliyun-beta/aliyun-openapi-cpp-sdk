...
void Json2Type(const Json::Value& value, CreateMetricStreamResponseType* item);
...
int Cms::CreateMetricStream(const CreateMetricStreamRequestType& req,
                      CreateMetricStreamResponseType* response,
