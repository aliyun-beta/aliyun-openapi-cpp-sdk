...
void Json2Type(const Json::Value& value, EmrJobResourceJobResourceInfoType* item);
void Json2Type(const Json::Value& value, EmrJobResourceResponseType* item);
...
void Json2Type(const Json::Value& value, EmrJobResourceResponseType* item) {
  if(value.isMember("JobResourceInfoList") && value["JobResourceInfoList"].isMember("JobResourceInfo")) {
    Json2Array<EmrJobResourceJobResourceInfoType>(value["JobResourceInfoList"]["JobResourceInfo"], &item->job_resource_info_list);
  }
}
}
