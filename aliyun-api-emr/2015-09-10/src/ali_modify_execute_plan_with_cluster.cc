...
void Json2Type(const Json::Value& value, ModifyExecutePlanWithClusterResponseType* item);
...
int Emr::ModifyExecutePlanWithCluster(const ModifyExecutePlanWithClusterRequestType& req,
                      ModifyExecutePlanWithClusterResponseType* response,
