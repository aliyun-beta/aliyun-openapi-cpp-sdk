...
void Json2Type(const Json::Value& value, EmrCreateClusterResponseType* item);
...
int Emr::CreateCluster(const EmrCreateClusterRequestType& req,
                      EmrCreateClusterResponseType* response,
