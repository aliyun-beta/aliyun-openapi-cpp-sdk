...
void Json2Type(const Json::Value& value, EmrListClustersClusterInfoType* item);
void Json2Type(const Json::Value& value, EmrListClustersResponseType* item);
...
void Json2Type(const Json::Value& value, EmrListClustersResponseType* item) {
  ...
  if(value.isMember("Clusters") && value["Clusters"].isMember("ClusterInfo")) {
    Json2Array<EmrListClustersClusterInfoType>(value["Clusters"]["ClusterInfo"], &item->clusters);
  }
}
}

int Emr::ListClusters(const EmrListClustersRequestType& req,
                      EmrListClustersResponseType* response,
