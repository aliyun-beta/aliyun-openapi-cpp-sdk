...
void Json2Type(const Json::Value& value, EmrCreateExecutePlanWithClusterResponseType* item);
...
int Emr::CreateExecutePlanWithCluster(const EmrCreateExecutePlanWithClusterRequestType& req,
                      EmrCreateExecutePlanWithClusterResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","CreateExecutePlanWithCluster");
