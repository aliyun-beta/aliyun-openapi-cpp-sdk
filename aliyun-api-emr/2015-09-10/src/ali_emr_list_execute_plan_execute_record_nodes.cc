...
void Json2Type(const Json::Value& value, EmrListExecutePlanExecuteRecordNodesExecutePlanNodeInfoType* item);
void Json2Type(const Json::Value& value, EmrListExecutePlanExecuteRecordNodesResponseType* item);
...
void Json2Type(const Json::Value& value, EmrListExecutePlanExecuteRecordNodesResponseType* item) {
  ...
  if(value.isMember("executePlanNode") && value["executePlanNode"].isMember("ExecutePlanNodeInfo")) {
    Json2Array<EmrListExecutePlanExecuteRecordNodesExecutePlanNodeInfoType>(value["executePlanNode"]["ExecutePlanNodeInfo"], &item->execute_plan_node);
  }
}
}

int Emr::ListExecutePlanExecuteRecordNodes(const EmrListExecutePlanExecuteRecordNodesRequestType& req,
                      EmrListExecutePlanExecuteRecordNodesResponseType* response,
