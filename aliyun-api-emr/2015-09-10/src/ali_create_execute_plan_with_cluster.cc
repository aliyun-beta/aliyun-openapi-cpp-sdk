...
void Json2Type(const Json::Value& value, CreateExecutePlanWithClusterResponseType* item);
...
int Emr::CreateExecutePlanWithCluster(const CreateExecutePlanWithClusterRequestType& req,
                      CreateExecutePlanWithClusterResponseType* response,
