...
void Json2Type(const Json::Value& value, ListExecutePlanJobsExecutePlanJobInfoType* item);
void Json2Type(const Json::Value& value, ListExecutePlanJobsResponseType* item);
...
void Json2Type(const Json::Value& value, ListExecutePlanJobsResponseType* item) {
  ...
  if(value.isMember("ExecutePlanJobs") && value["ExecutePlanJobs"].isMember("ExecutePlanJobInfo")) {
    Json2Array<ListExecutePlanJobsExecutePlanJobInfoType>(value["ExecutePlanJobs"]["ExecutePlanJobInfo"], &item->execute_plan_jobs);
  }
}
}

int Emr::ListExecutePlanJobs(const ListExecutePlanJobsRequestType& req,
                      ListExecutePlanJobsResponseType* response,
