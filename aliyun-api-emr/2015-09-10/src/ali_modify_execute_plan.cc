...
void Json2Type(const Json::Value& value, ModifyExecutePlanResponseType* item);
...
int Emr::ModifyExecutePlan(const ModifyExecutePlanRequestType& req,
                      ModifyExecutePlanResponseType* response,
