...
void Json2Type(const Json::Value& value, EmrDescribeClusterClusterInfoType* item);
void Json2Type(const Json::Value& value, EmrDescribeClusterSoftwareInfoType* item);
void Json2Type(const Json::Value& value, EmrDescribeClusterNodeType* item);
void Json2Type(const Json::Value& value, EmrDescribeClusterEcsRoleType* item);
void Json2Type(const Json::Value& value, EmrDescribeClusterEcsInfoType* item);
void Json2Type(const Json::Value& value, EmrDescribeClusterResponseType* item);
...
void Json2Type(const Json::Value& value, EmrDescribeClusterEcsRoleType* item) {
  ...
  if(value.isMember("Nodes") && value["Nodes"].isMember("Node")) {
    Json2Array<EmrDescribeClusterNodeType>(value["Nodes"]["Node"], &item->nodes);
  }
}
void Json2Type(const Json::Value& value, EmrDescribeClusterEcsInfoType* item) {
  ...
  if(value.isMember("EcsRoles") && value["EcsRoles"].isMember("EcsRole")) {
    Json2Array<EmrDescribeClusterEcsRoleType>(value["EcsRoles"]["EcsRole"], &item->ecs_roles);
  }
}
void Json2Type(const Json::Value& value, EmrDescribeClusterResponseType* item) {
...
int Emr::DescribeCluster(const EmrDescribeClusterRequestType& req,
                      EmrDescribeClusterResponseType* response,
