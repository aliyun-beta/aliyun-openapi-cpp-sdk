...
void Json2Type(const Json::Value& value, EmrListJobsJobInfoType* item);
void Json2Type(const Json::Value& value, EmrListJobsResponseType* item);
...
void Json2Type(const Json::Value& value, EmrListJobsResponseType* item) {
  ...
  if(value.isMember("Jobs") && value["Jobs"].isMember("JobInfo")) {
    Json2Array<EmrListJobsJobInfoType>(value["Jobs"]["JobInfo"], &item->jobs);
  }
}
}
