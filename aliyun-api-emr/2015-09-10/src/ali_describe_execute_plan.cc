...
void Json2Type(const Json::Value& value, DescribeExecutePlanJobInfoType* item);
void Json2Type(const Json::Value& value, DescribeExecutePlanClusterInfoType* item);
void Json2Type(const Json::Value& value, DescribeExecutePlanSoftwareInfoType* item);
void Json2Type(const Json::Value& value, DescribeExecutePlanNodeType* item);
void Json2Type(const Json::Value& value, DescribeExecutePlanEcsRoleType* item);
void Json2Type(const Json::Value& value, DescribeExecutePlanEcsInfoType* item);
void Json2Type(const Json::Value& value, DescribeExecutePlanResponseType* item);
...
void Json2Type(const Json::Value& value, DescribeExecutePlanEcsRoleType* item) {
  ...
  if(value.isMember("Nodes") && value["Nodes"].isMember("Node")) {
    Json2Array<DescribeExecutePlanNodeType>(value["Nodes"]["Node"], &item->nodes);
  }
}
void Json2Type(const Json::Value& value, DescribeExecutePlanEcsInfoType* item) {
  ...
  if(value.isMember("EcsRoles") && value["EcsRoles"].isMember("EcsRole")) {
    Json2Array<DescribeExecutePlanEcsRoleType>(value["EcsRoles"]["EcsRole"], &item->ecs_roles);
  }
}
void Json2Type(const Json::Value& value, DescribeExecutePlanResponseType* item) {
  if(value.isMember("Id")) {
  ...
  if(value.isMember("JobInfos") && value["JobInfos"].isMember("JobInfo")) {
    Json2Array<DescribeExecutePlanJobInfoType>(value["JobInfos"]["JobInfo"], &item->job_infos);
  }
...
int Emr::DescribeExecutePlan(const DescribeExecutePlanRequestType& req,
                      DescribeExecutePlanResponseType* response,
