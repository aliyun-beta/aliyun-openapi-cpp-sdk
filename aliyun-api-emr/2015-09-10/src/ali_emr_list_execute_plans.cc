...
void Json2Type(const Json::Value& value, EmrListExecutePlansExecutePlanInfoType* item);
void Json2Type(const Json::Value& value, EmrListExecutePlansResponseType* item);
...
void Json2Type(const Json::Value& value, EmrListExecutePlansResponseType* item) {
  ...
  if(value.isMember("ExecutePlans") && value["ExecutePlans"].isMember("ExecutePlanInfo")) {
    Json2Array<EmrListExecutePlansExecutePlanInfoType>(value["ExecutePlans"]["ExecutePlanInfo"], &item->execute_plans);
  }
}
}
