...
void Json2Type(const Json::Value& value, EmrCreateExecutePlanResponseType* item);
...
int Emr::CreateExecutePlan(const EmrCreateExecutePlanRequestType& req,
                      EmrCreateExecutePlanResponseType* response,
  ...
  Json::Value val;
  Json::Reader reader;
  req_rpc->AddRequestQuery("Action","CreateExecutePlan");
