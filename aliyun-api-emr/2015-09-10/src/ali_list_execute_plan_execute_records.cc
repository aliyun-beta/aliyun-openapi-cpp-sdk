...
void Json2Type(const Json::Value& value, ListExecutePlanExecuteRecordsExecutePlanRecordInfoType* item);
void Json2Type(const Json::Value& value, ListExecutePlanExecuteRecordsResponseType* item);
...
void Json2Type(const Json::Value& value, ListExecutePlanExecuteRecordsResponseType* item) {
  ...
  if(value.isMember("ExecutePlanExecRecord") && value["ExecutePlanExecRecord"].isMember("ExecutePlanRecordInfo")) {
    Json2Array<ListExecutePlanExecuteRecordsExecutePlanRecordInfoType>(value["ExecutePlanExecRecord"]["ExecutePlanRecordInfo"], &item->execute_plan_exec_record);
  }
}
}

int Emr::ListExecutePlanExecuteRecords(const ListExecutePlanExecuteRecordsRequestType& req,
                      ListExecutePlanExecuteRecordsResponseType* response,
