...
void Json2Type(const Json::Value& value, CreateExecutePlanResponseType* item);
...
int Emr::CreateExecutePlan(const CreateExecutePlanRequestType& req,
                      CreateExecutePlanResponseType* response,
