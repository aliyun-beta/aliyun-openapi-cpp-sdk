#ifndef ALI_EMR_MODIFY_EXECUTE_PLAN_WITH_CLUSTER_TYPESH
#define ALI_EMR_MODIFY_EXECUTE_PLAN_WITH_CLUSTER_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct EmrModifyExecutePlanWithClusterRequestType {
...
struct EmrModifyExecutePlanWithClusterResponseType {
};
} // end namespace
#endif
