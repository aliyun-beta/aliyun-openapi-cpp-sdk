#ifndef ALI_MODIFY_EXECUTE_PLAN_WITH_CLUSTER_TYPESH
#define ALI_MODIFY_EXECUTE_PLAN_WITH_CLUSTER_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct ModifyExecutePlanWithClusterRequestType {
...
struct ModifyExecutePlanWithClusterResponseType {
};
} // end namespace
#endif
