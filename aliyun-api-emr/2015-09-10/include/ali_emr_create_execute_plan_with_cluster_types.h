#ifndef ALI_EMR_CREATE_EXECUTE_PLAN_WITH_CLUSTER_TYPESH
#define ALI_EMR_CREATE_EXECUTE_PLAN_WITH_CLUSTER_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct EmrCreateExecutePlanWithClusterRequestType {
...
struct EmrCreateExecutePlanWithClusterResponseType {
};
} // end namespace
#endif
