...
void Json2Type(const Json::Value& value, RdsDescribeBackupsBackupType* item);
void Json2Type(const Json::Value& value, RdsDescribeBackupsResponseType* item);
...
void Json2Type(const Json::Value& value, RdsDescribeBackupsResponseType* item) {
  ...
  if(value.isMember("Items") && value["Items"].isMember("Backup")) {
    Json2Array<RdsDescribeBackupsBackupType>(value["Items"]["Backup"], &item->items);
  }
}
}

int Rds::DescribeBackups(const RdsDescribeBackupsRequestType& req,
                      RdsDescribeBackupsResponseType* response,
