...
void Json2Type(const Json::Value& value, RdsModifyDBInstanceNetworkTypeResponseType* item);
...
int Rds::ModifyDBInstanceNetworkType(const RdsModifyDBInstanceNetworkTypeRequestType& req,
                      RdsModifyDBInstanceNetworkTypeResponseType* response,
