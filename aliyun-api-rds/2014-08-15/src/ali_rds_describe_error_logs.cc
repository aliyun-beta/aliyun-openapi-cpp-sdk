...
void Json2Type(const Json::Value& value, RdsDescribeErrorLogsErrorLogType* item);
void Json2Type(const Json::Value& value, RdsDescribeErrorLogsResponseType* item);
...
void Json2Type(const Json::Value& value, RdsDescribeErrorLogsResponseType* item) {
  ...
  if(value.isMember("Items") && value["Items"].isMember("ErrorLog")) {
    Json2Array<RdsDescribeErrorLogsErrorLogType>(value["Items"]["ErrorLog"], &item->items);
  }
}
}

int Rds::DescribeErrorLogs(const RdsDescribeErrorLogsRequestType& req,
                      RdsDescribeErrorLogsResponseType* response,
