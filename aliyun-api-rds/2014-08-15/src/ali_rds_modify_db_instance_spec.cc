...
void Json2Type(const Json::Value& value, RdsModifyDBInstanceSpecResponseType* item);
...
int Rds::ModifyDBInstanceSpec(const RdsModifyDBInstanceSpecRequestType& req,
                      RdsModifyDBInstanceSpecResponseType* response,
