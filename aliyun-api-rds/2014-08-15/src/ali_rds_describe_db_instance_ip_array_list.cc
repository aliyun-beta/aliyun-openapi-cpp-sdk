...
void Json2Type(const Json::Value& value, RdsDescribeDBInstanceIPArrayListResponseType* item);
...
void Json2Type(const Json::Value& value, RdsDescribeDBInstanceIPArrayListResponseType* item) {
  if(value.isMember("Items") && value["Items"].isMember("DBInstanceIPArray")) {
    Json2Array<RdsDescribeDBInstanceIPArrayListDBInstanceIPArrayType>(value["Items"]["DBInstanceIPArray"], &item->items);
  }
}
}

int Rds::DescribeDBInstanceIPArrayList(const RdsDescribeDBInstanceIPArrayListRequestType& req,
                      RdsDescribeDBInstanceIPArrayListResponseType* response,
