...
void Json2Type(const Json::Value& value, RdsAddTagsToResourceResponseType* item);
...
int Rds::AddTagsToResource(const RdsAddTagsToResourceRequestType& req,
                      RdsAddTagsToResourceResponseType* response,
