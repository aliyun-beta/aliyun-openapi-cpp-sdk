...
void Json2Type(const Json::Value& value, RdsCreateDBInstanceforFirstPayResponseType* item);
...
int Rds::CreateDBInstanceforFirstPay(const RdsCreateDBInstanceforFirstPayRequestType& req,
                      RdsCreateDBInstanceforFirstPayResponseType* response,
