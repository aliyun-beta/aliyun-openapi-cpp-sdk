...
void Json2Type(const Json::Value& value, RdsModifyDBInstanceDescriptionResponseType* item);
...
int Rds::ModifyDBInstanceDescription(const RdsModifyDBInstanceDescriptionRequestType& req,
                      RdsModifyDBInstanceDescriptionResponseType* response,
