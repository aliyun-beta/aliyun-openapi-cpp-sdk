...
void Json2Type(const Json::Value& value, RdsDescribeSQLLogRecordsSQLRecordType* item);
void Json2Type(const Json::Value& value, RdsDescribeSQLLogRecordsResponseType* item);
...
void Json2Type(const Json::Value& value, RdsDescribeSQLLogRecordsResponseType* item) {
  ...
  if(value.isMember("Items") && value["Items"].isMember("SQLRecord")) {
    Json2Array<RdsDescribeSQLLogRecordsSQLRecordType>(value["Items"]["SQLRecord"], &item->items);
  }
}
}

int Rds::DescribeSQLLogRecords(const RdsDescribeSQLLogRecordsRequestType& req,
                      RdsDescribeSQLLogRecordsResponseType* response,
