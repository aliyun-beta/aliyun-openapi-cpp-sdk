...
void Json2Type(const Json::Value& value, RdsResetAccountPasswordResponseType* item);
...
int Rds::ResetAccountPassword(const RdsResetAccountPasswordRequestType& req,
                      RdsResetAccountPasswordResponseType* response,
