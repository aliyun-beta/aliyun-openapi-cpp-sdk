...
void Json2Type(const Json::Value& value, RdsDescribeAbnormalDBInstancesAbnormalItemType* item);
void Json2Type(const Json::Value& value, RdsDescribeAbnormalDBInstancesInstanceResultType* item);
void Json2Type(const Json::Value& value, RdsDescribeAbnormalDBInstancesResponseType* item);
...
void Json2Type(const Json::Value& value, RdsDescribeAbnormalDBInstancesInstanceResultType* item) {
  ...
  if(value.isMember("AbnormalItems") && value["AbnormalItems"].isMember("AbnormalItem")) {
    Json2Array<RdsDescribeAbnormalDBInstancesAbnormalItemType>(value["AbnormalItems"]["AbnormalItem"], &item->abnormal_items);
  }
}
void Json2Type(const Json::Value& value, RdsDescribeAbnormalDBInstancesResponseType* item) {
  ...
  if(value.isMember("Items") && value["Items"].isMember("InstanceResult")) {
    Json2Array<RdsDescribeAbnormalDBInstancesInstanceResultType>(value["Items"]["InstanceResult"], &item->items);
  }
}
}

int Rds::DescribeAbnormalDBInstances(const RdsDescribeAbnormalDBInstancesRequestType& req,
                      RdsDescribeAbnormalDBInstancesResponseType* response,
