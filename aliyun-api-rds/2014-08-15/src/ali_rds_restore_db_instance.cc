...
void Json2Type(const Json::Value& value, RdsRestoreDBInstanceResponseType* item);
...
int Rds::RestoreDBInstance(const RdsRestoreDBInstanceRequestType& req,
                      RdsRestoreDBInstanceResponseType* response,
