...
void Json2Type(const Json::Value& value, RdsCreatePostpaidDBInstanceForChannelResponseType* item);
...
int Rds::CreatePostpaidDBInstanceForChannel(const RdsCreatePostpaidDBInstanceForChannelRequestType& req,
                      RdsCreatePostpaidDBInstanceForChannelResponseType* response,
