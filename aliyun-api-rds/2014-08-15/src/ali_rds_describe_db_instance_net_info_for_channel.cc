...
void Json2Type(const Json::Value& value, RdsDescribeDBInstanceNetInfoForChannelsecurityIPGroupsType* item);
void Json2Type(const Json::Value& value, RdsDescribeDBInstanceNetInfoForChannelDBInstanceNetInfoType* item);
void Json2Type(const Json::Value& value, RdsDescribeDBInstanceNetInfoForChannelResponseType* item);
...
void Json2Type(const Json::Value& value, RdsDescribeDBInstanceNetInfoForChannelDBInstanceNetInfoType* item) {
  ...
  if(value.isMember("SecurityIPGroups") && value["SecurityIPGroups"].isMember("securityIPGroups")) {
    Json2Array<RdsDescribeDBInstanceNetInfoForChannelsecurityIPGroupsType>(value["SecurityIPGroups"]["securityIPGroups"], &item->security_ip_groups);
  }
}
void Json2Type(const Json::Value& value, RdsDescribeDBInstanceNetInfoForChannelResponseType* item) {
  ...
  if(value.isMember("DBInstanceNetInfos") && value["DBInstanceNetInfos"].isMember("DBInstanceNetInfo")) {
    Json2Array<RdsDescribeDBInstanceNetInfoForChannelDBInstanceNetInfoType>(value["DBInstanceNetInfos"]["DBInstanceNetInfo"], &item->db_instance_net_infos);
  }
}
}

int Rds::DescribeDBInstanceNetInfoForChannel(const RdsDescribeDBInstanceNetInfoForChannelRequestType& req,
                      RdsDescribeDBInstanceNetInfoForChannelResponseType* response,
