...
void Json2Type(const Json::Value& value, RdsDescribeDBInstancesByPerformanceDBInstancePerformanceType* item);
void Json2Type(const Json::Value& value, RdsDescribeDBInstancesByPerformanceResponseType* item);
...
void Json2Type(const Json::Value& value, RdsDescribeDBInstancesByPerformanceResponseType* item) {
  ...
  if(value.isMember("Items") && value["Items"].isMember("DBInstancePerformance")) {
    Json2Array<RdsDescribeDBInstancesByPerformanceDBInstancePerformanceType>(value["Items"]["DBInstancePerformance"], &item->items);
  }
}
}

int Rds::DescribeDBInstancesByPerformance(const RdsDescribeDBInstancesByPerformanceRequestType& req,
                      RdsDescribeDBInstancesByPerformanceResponseType* response,
