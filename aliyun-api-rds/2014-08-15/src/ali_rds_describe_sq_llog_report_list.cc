...
void Json2Type(const Json::Value& value, RdsDescribeSQLLogReportListLatencyTopNItemType* item);
void Json2Type(const Json::Value& value, RdsDescribeSQLLogReportListQPSTopNItemType* item);
void Json2Type(const Json::Value& value, RdsDescribeSQLLogReportListItemType* item);
void Json2Type(const Json::Value& value, RdsDescribeSQLLogReportListResponseType* item);
...
void Json2Type(const Json::Value& value, RdsDescribeSQLLogReportListItemType* item) {
  ...
  if(value.isMember("LatencyTopNItems") && value["LatencyTopNItems"].isMember("LatencyTopNItem")) {
    Json2Array<RdsDescribeSQLLogReportListLatencyTopNItemType>(value["LatencyTopNItems"]["LatencyTopNItem"], &item->latency_top_nitems);
  }
  if(value.isMember("QPSTopNItems") && value["QPSTopNItems"].isMember("QPSTopNItem")) {
    Json2Array<RdsDescribeSQLLogReportListQPSTopNItemType>(value["QPSTopNItems"]["QPSTopNItem"], &item->qp_stop_nitems);
  }
}
void Json2Type(const Json::Value& value, RdsDescribeSQLLogReportListResponseType* item) {
  ...
  if(value.isMember("Items") && value["Items"].isMember("Item")) {
    Json2Array<RdsDescribeSQLLogReportListItemType>(value["Items"]["Item"], &item->items);
  }
}
}

int Rds::DescribeSQLLogReportList(const RdsDescribeSQLLogReportListRequestType& req,
                      RdsDescribeSQLLogReportListResponseType* response,
