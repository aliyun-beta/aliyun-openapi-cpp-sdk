...
void Json2Type(const Json::Value& value, RdsModifyPostpaidDBInstanceSpecResponseType* item);
...
int Rds::ModifyPostpaidDBInstanceSpec(const RdsModifyPostpaidDBInstanceSpecRequestType& req,
                      RdsModifyPostpaidDBInstanceSpecResponseType* response,
