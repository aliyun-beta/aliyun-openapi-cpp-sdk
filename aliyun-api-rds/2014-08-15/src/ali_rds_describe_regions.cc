...
void Json2Type(const Json::Value& value, RdsDescribeRegionsRDSRegionType* item);
void Json2Type(const Json::Value& value, RdsDescribeRegionsResponseType* item);
...
void Json2Type(const Json::Value& value, RdsDescribeRegionsResponseType* item) {
  if(value.isMember("Regions") && value["Regions"].isMember("RDSRegion")) {
    Json2Array<RdsDescribeRegionsRDSRegionType>(value["Regions"]["RDSRegion"], &item->regions);
  }
}
}
