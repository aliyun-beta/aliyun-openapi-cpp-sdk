...
void Json2Type(const Json::Value& value, RdsDescribeDBInstancePerformancePerformanceValueType* item);
void Json2Type(const Json::Value& value, RdsDescribeDBInstancePerformancePerformanceKeyType* item);
void Json2Type(const Json::Value& value, RdsDescribeDBInstancePerformanceResponseType* item);
...
void Json2Type(const Json::Value& value, RdsDescribeDBInstancePerformancePerformanceKeyType* item) {
  ...
  if(value.isMember("Values") && value["Values"].isMember("PerformanceValue")) {
    Json2Array<RdsDescribeDBInstancePerformancePerformanceValueType>(value["Values"]["PerformanceValue"], &item->values);
  }
}
void Json2Type(const Json::Value& value, RdsDescribeDBInstancePerformanceResponseType* item) {
  ...
  if(value.isMember("PerformanceKeys") && value["PerformanceKeys"].isMember("PerformanceKey")) {
    Json2Array<RdsDescribeDBInstancePerformancePerformanceKeyType>(value["PerformanceKeys"]["PerformanceKey"], &item->performance_keys);
  }
}
}

int Rds::DescribeDBInstancePerformance(const RdsDescribeDBInstancePerformanceRequestType& req,
                      RdsDescribeDBInstancePerformanceResponseType* response,
