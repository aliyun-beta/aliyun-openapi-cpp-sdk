...
void Json2Type(const Json::Value& value, RdsDescribeBinlogFilesBinLogFileType* item);
void Json2Type(const Json::Value& value, RdsDescribeBinlogFilesResponseType* item);
...
void Json2Type(const Json::Value& value, RdsDescribeBinlogFilesResponseType* item) {
  ...
  if(value.isMember("Items") && value["Items"].isMember("BinLogFile")) {
    Json2Array<RdsDescribeBinlogFilesBinLogFileType>(value["Items"]["BinLogFile"], &item->items);
  }
}
}

int Rds::DescribeBinlogFiles(const RdsDescribeBinlogFilesRequestType& req,
                      RdsDescribeBinlogFilesResponseType* response,
