...
void Json2Type(const Json::Value& value, RdsDescribeParameterTemplatesTemplateRecordType* item);
...
int Rds::DescribeParameterTemplates(const RdsDescribeParameterTemplatesRequestType& req,
                      RdsDescribeParameterTemplatesResponseType* response,
