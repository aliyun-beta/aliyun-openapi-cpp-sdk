...
void Json2Type(const Json::Value& value, RdsDescribeSQLInjectionInfosSQLInjectionInfoType* item);
void Json2Type(const Json::Value& value, RdsDescribeSQLInjectionInfosResponseType* item);
...
void Json2Type(const Json::Value& value, RdsDescribeSQLInjectionInfosResponseType* item) {
  ...
  if(value.isMember("Items") && value["Items"].isMember("SQLInjectionInfo")) {
    Json2Array<RdsDescribeSQLInjectionInfosSQLInjectionInfoType>(value["Items"]["SQLInjectionInfo"], &item->items);
  }
}
}

int Rds::DescribeSQLInjectionInfos(const RdsDescribeSQLInjectionInfosRequestType& req,
                      RdsDescribeSQLInjectionInfosResponseType* response,
