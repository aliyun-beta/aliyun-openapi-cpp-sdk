...
void Json2Type(const Json::Value& value, RdsDescribeSQLLogReportsSQLReportType* item);
void Json2Type(const Json::Value& value, RdsDescribeSQLLogReportsResponseType* item);
...
void Json2Type(const Json::Value& value, RdsDescribeSQLLogReportsResponseType* item) {
  ...
  if(value.isMember("Items") && value["Items"].isMember("SQLReport")) {
    Json2Array<RdsDescribeSQLLogReportsSQLReportType>(value["Items"]["SQLReport"], &item->items);
  }
}
}

int Rds::DescribeSQLLogReports(const RdsDescribeSQLLogReportsRequestType& req,
                      RdsDescribeSQLLogReportsResponseType* response,
