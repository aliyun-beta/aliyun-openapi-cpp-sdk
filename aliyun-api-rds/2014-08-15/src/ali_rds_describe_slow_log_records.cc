...
void Json2Type(const Json::Value& value, RdsDescribeSlowLogRecordsSQLSlowRecordType* item);
void Json2Type(const Json::Value& value, RdsDescribeSlowLogRecordsResponseType* item);
...
void Json2Type(const Json::Value& value, RdsDescribeSlowLogRecordsResponseType* item) {
  ...
  if(value.isMember("Items") && value["Items"].isMember("SQLSlowRecord")) {
    Json2Array<RdsDescribeSlowLogRecordsSQLSlowRecordType>(value["Items"]["SQLSlowRecord"], &item->items);
  }
}
}

int Rds::DescribeSlowLogRecords(const RdsDescribeSlowLogRecordsRequestType& req,
                      RdsDescribeSlowLogRecordsResponseType* response,
