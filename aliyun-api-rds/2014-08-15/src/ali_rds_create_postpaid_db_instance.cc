...
void Json2Type(const Json::Value& value, RdsCreatePostpaidDBInstanceResponseType* item);
...
int Rds::CreatePostpaidDBInstance(const RdsCreatePostpaidDBInstanceRequestType& req,
                      RdsCreatePostpaidDBInstanceResponseType* response,
