...
void Json2Type(const Json::Value& value, RdsUpgradeDBInstanceEngineVersionResponseType* item);
...
int Rds::UpgradeDBInstanceEngineVersion(const RdsUpgradeDBInstanceEngineVersionRequestType& req,
                      RdsUpgradeDBInstanceEngineVersionResponseType* response,
