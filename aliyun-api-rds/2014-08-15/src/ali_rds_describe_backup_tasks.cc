...
void Json2Type(const Json::Value& value, RdsDescribeBackupTasksBackupJobType* item);
void Json2Type(const Json::Value& value, RdsDescribeBackupTasksResponseType* item);
...
void Json2Type(const Json::Value& value, RdsDescribeBackupTasksResponseType* item) {
  if(value.isMember("Items") && value["Items"].isMember("BackupJob")) {
    Json2Array<RdsDescribeBackupTasksBackupJobType>(value["Items"]["BackupJob"], &item->items);
  }
}
}

int Rds::DescribeBackupTasks(const RdsDescribeBackupTasksRequestType& req,
                      RdsDescribeBackupTasksResponseType* response,
