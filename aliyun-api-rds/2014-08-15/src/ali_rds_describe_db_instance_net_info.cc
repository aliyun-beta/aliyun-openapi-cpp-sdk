...
void Json2Type(const Json::Value& value, RdsDescribeDBInstanceNetInfosecurityIPGroupsType* item);
void Json2Type(const Json::Value& value, RdsDescribeDBInstanceNetInfoDBInstanceNetInfoType* item);
void Json2Type(const Json::Value& value, RdsDescribeDBInstanceNetInfoResponseType* item);
...
void Json2Type(const Json::Value& value, RdsDescribeDBInstanceNetInfoDBInstanceNetInfoType* item) {
  ...
  if(value.isMember("SecurityIPGroups") && value["SecurityIPGroups"].isMember("securityIPGroups")) {
    Json2Array<RdsDescribeDBInstanceNetInfosecurityIPGroupsType>(value["SecurityIPGroups"]["securityIPGroups"], &item->security_ip_groups);
  }
}
void Json2Type(const Json::Value& value, RdsDescribeDBInstanceNetInfoResponseType* item) {
  ...
  if(value.isMember("DBInstanceNetInfos") && value["DBInstanceNetInfos"].isMember("DBInstanceNetInfo")) {
    Json2Array<RdsDescribeDBInstanceNetInfoDBInstanceNetInfoType>(value["DBInstanceNetInfos"]["DBInstanceNetInfo"], &item->db_instance_net_infos);
  }
}
}
