...
void Json2Type(const Json::Value& value, RdsRemoveTagsFromResourceResponseType* item);
...
int Rds::RemoveTagsFromResource(const RdsRemoveTagsFromResourceRequestType& req,
                      RdsRemoveTagsFromResourceResponseType* response,
