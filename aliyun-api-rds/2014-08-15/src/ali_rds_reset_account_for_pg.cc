...
void Json2Type(const Json::Value& value, RdsResetAccountForPGResponseType* item);
...
int Rds::ResetAccountForPG(const RdsResetAccountForPGRequestType& req,
                      RdsResetAccountForPGResponseType* response,
