...
void Json2Type(const Json::Value& value, RdsDescribeSlowLogsSQLSlowLogType* item);
void Json2Type(const Json::Value& value, RdsDescribeSlowLogsResponseType* item);
...
void Json2Type(const Json::Value& value, RdsDescribeSlowLogsResponseType* item) {
  ...
  if(value.isMember("Items") && value["Items"].isMember("SQLSlowLog")) {
    Json2Array<RdsDescribeSlowLogsSQLSlowLogType>(value["Items"]["SQLSlowLog"], &item->items);
  }
}
}

int Rds::DescribeSlowLogs(const RdsDescribeSlowLogsRequestType& req,
                      RdsDescribeSlowLogsResponseType* response,
