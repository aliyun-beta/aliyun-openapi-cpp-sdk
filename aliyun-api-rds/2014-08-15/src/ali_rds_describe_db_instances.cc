...
void Json2Type(const Json::Value& value, RdsDescribeDBInstancesReadOnlyDBInstanceIdType* item);
void Json2Type(const Json::Value& value, RdsDescribeDBInstancesDBInstanceType* item);
void Json2Type(const Json::Value& value, RdsDescribeDBInstancesResponseType* item);
...
void Json2Type(const Json::Value& value, RdsDescribeDBInstancesDBInstanceType* item) {
  ...
  if(value.isMember("ReadOnlyDBInstanceIds") && value["ReadOnlyDBInstanceIds"].isMember("ReadOnlyDBInstanceId")) {
    Json2Array<RdsDescribeDBInstancesReadOnlyDBInstanceIdType>(value["ReadOnlyDBInstanceIds"]["ReadOnlyDBInstanceId"], &item->read_only_db_instance_ids);
  }
}
void Json2Type(const Json::Value& value, RdsDescribeDBInstancesResponseType* item) {
  ...
  if(value.isMember("Items") && value["Items"].isMember("DBInstance")) {
    Json2Array<RdsDescribeDBInstancesDBInstanceType>(value["Items"]["DBInstance"], &item->items);
  }
}
}

int Rds::DescribeDBInstances(const RdsDescribeDBInstancesRequestType& req,
                      RdsDescribeDBInstancesResponseType* response,
