...
void Json2Type(const Json::Value& value, RdsCreateUploadPathForSQLServerResponseType* item);
...
int Rds::CreateUploadPathForSQLServer(const RdsCreateUploadPathForSQLServerRequestType& req,
                      RdsCreateUploadPathForSQLServerResponseType* response,
