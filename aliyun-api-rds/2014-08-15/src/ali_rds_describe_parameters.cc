...
void Json2Type(const Json::Value& value, RdsDescribeParametersDBInstanceParameterType* item);
void Json2Type(const Json::Value& value, RdsDescribeParametersResponseType* item);
...
void Json2Type(const Json::Value& value, RdsDescribeParametersResponseType* item) {
  ...
  if(value.isMember("ConfigParameters") && value["ConfigParameters"].isMember("DBInstanceParameter")) {
    Json2Array<RdsDescribeParametersDBInstanceParameterType>(value["ConfigParameters"]["DBInstanceParameter"], &item->config_parameters);
  }
  if(value.isMember("RunningParameters") && value["RunningParameters"].isMember("DBInstanceParameter")) {
    Json2Array<RdsDescribeParametersDBInstanceParameterType>(value["RunningParameters"]["DBInstanceParameter"], &item->running_parameters);
  }
}
}

int Rds::DescribeParameters(const RdsDescribeParametersRequestType& req,
                      RdsDescribeParametersResponseType* response,
