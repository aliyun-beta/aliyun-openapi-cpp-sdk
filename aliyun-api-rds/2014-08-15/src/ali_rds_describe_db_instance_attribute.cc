...
void Json2Type(const Json::Value& value, RdsDescribeDBInstanceAttributeReadOnlyDBInstanceIdType* item);
void Json2Type(const Json::Value& value, RdsDescribeDBInstanceAttributeDBInstanceAttributeType* item);
void Json2Type(const Json::Value& value, RdsDescribeDBInstanceAttributeResponseType* item);
...
void Json2Type(const Json::Value& value, RdsDescribeDBInstanceAttributeResponseType* item) {
  if(value.isMember("Items") && value["Items"].isMember("DBInstanceAttribute")) {
    Json2Array<RdsDescribeDBInstanceAttributeDBInstanceAttributeType>(value["Items"]["DBInstanceAttribute"], &item->items);
  }
}
}
