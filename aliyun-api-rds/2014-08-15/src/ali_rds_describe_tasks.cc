...
void Json2Type(const Json::Value& value, RdsDescribeTasksTaskProgressInfoType* item);
void Json2Type(const Json::Value& value, RdsDescribeTasksResponseType* item);
...
void Json2Type(const Json::Value& value, RdsDescribeTasksTaskProgressInfoType* item) {
  ...
  if(value.isMember("TaskErrorCode")) {
    item->task_error_code = value["TaskErrorCode"].asString();
  }
  if(value.isMember("TaskErrorMessage")) {
    item->task_error_message = value["TaskErrorMessage"].asString();
  }
}
void Json2Type(const Json::Value& value, RdsDescribeTasksResponseType* item) {
  ...
  if(value.isMember("Items") && value["Items"].isMember("TaskProgressInfo")) {
    Json2Array<RdsDescribeTasksTaskProgressInfoType>(value["Items"]["TaskProgressInfo"], &item->items);
  }
}
}

int Rds::DescribeTasks(const RdsDescribeTasksRequestType& req,
                      RdsDescribeTasksResponseType* response,
