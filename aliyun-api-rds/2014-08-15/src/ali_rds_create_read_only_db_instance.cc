...
void Json2Type(const Json::Value& value, RdsCreateReadOnlyDBInstanceResponseType* item);
...
int Rds::CreateReadOnlyDBInstance(const RdsCreateReadOnlyDBInstanceRequestType& req,
                      RdsCreateReadOnlyDBInstanceResponseType* response,
