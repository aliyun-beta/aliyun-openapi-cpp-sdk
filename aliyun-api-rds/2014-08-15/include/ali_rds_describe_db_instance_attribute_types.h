#ifndef ALI_RDS_DESCRIBE_DB_INSTANCE_ATTRIBUTE_TYPESH
#define ALI_RDS_DESCRIBE_DB_INSTANCE_ATTRIBUTE_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct RdsDescribeDBInstanceAttributeRequestType {
  std::string owner_id;
...
struct RdsDescribeDBInstanceAttributeReadOnlyDBInstanceIdType {
  std::string db_instance_id;
};
struct RdsDescribeDBInstanceAttributeDBInstanceAttributeType {
  std::vector<RdsDescribeDBInstanceAttributeReadOnlyDBInstanceIdType> read_only_db_instance_ids;
  int ins_id;
  std::string db_instance_id;
  std::string pay_type;
...
struct RdsDescribeDBInstanceAttributeResponseType {
  std::vector<RdsDescribeDBInstanceAttributeDBInstanceAttributeType> items;
};
} // end namespace
#endif
