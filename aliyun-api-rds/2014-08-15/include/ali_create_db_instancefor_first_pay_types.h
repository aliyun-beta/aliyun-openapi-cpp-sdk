#ifndef ALI_CREATE_DB_INSTANCEFOR_FIRST_PAY_TYPESH
#define ALI_CREATE_DB_INSTANCEFOR_FIRST_PAY_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct CreateDBInstanceforFirstPayRequestType {
  std::string uid;
  std::string bid;
...
struct CreateDBInstanceforFirstPayResponseType {
