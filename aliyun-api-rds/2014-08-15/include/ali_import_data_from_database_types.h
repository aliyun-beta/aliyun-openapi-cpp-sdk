#ifndef ALI_IMPORT_DATA_FROM_DATABASE_TYPESH
#define ALI_IMPORT_DATA_FROM_DATABASE_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct ImportDataFromDatabaseRequestType {
  std::string owner_id;
...
struct ImportDataFromDatabaseResponseType {
  int import_id;
};
} // end namespace
#endif
