#ifndef ALI_DESCRIBE_BACKUPS_TYPESH
#define ALI_DESCRIBE_BACKUPS_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct DescribeBackupsRequestType {
  std::string owner_id;
...
struct DescribeBackupsBackupType {
  std::string backup_id;
  std::string db_instance_id;
  std::string backup_status;
...
struct DescribeBackupsResponseType {
  std::vector<DescribeBackupsBackupType> items;
