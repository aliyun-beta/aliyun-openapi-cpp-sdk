#ifndef ALI_DESCRIBE_DB_INSTANCE_ATTRIBUTE_TYPESH
#define ALI_DESCRIBE_DB_INSTANCE_ATTRIBUTE_TYPESH
#include <stdio.h>
#include <string>
#include <vector>
namespace aliyun {
struct DescribeDBInstanceAttributeRequestType {
  std::string owner_id;
...
struct DescribeDBInstanceAttributeReadOnlyDBInstanceIdType {
  std::string db_instance_id;
};
struct DescribeDBInstanceAttributeDBInstanceAttributeType {
  std::vector<DescribeDBInstanceAttributeReadOnlyDBInstanceIdType> read_only_db_instance_ids;
  int ins_id;
  std::string db_instance_id;
  std::string pay_type;
...
struct DescribeDBInstanceAttributeResponseType {
  std::vector<DescribeDBInstanceAttributeDBInstanceAttributeType> items;
};
} // end namespace
#endif
