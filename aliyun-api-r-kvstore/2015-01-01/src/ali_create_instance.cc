...
void Json2Type(const Json::Value& value, CreateInstanceResponseType* item);
...
int Rkvstore::CreateInstance(const CreateInstanceRequestType& req,
                      CreateInstanceResponseType* response,
