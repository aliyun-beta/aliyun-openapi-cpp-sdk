...
void Json2Type(const Json::Value& value, RkvstoreDescribeInstancesKVStoreInstanceType* item);
void Json2Type(const Json::Value& value, RkvstoreDescribeInstancesResponseType* item);
...
void Json2Type(const Json::Value& value, RkvstoreDescribeInstancesResponseType* item) {
  ...
  if(value.isMember("Instances") && value["Instances"].isMember("KVStoreInstance")) {
    Json2Array<RkvstoreDescribeInstancesKVStoreInstanceType>(value["Instances"]["KVStoreInstance"], &item->instances);
  }
}
}

int Rkvstore::DescribeInstances(const RkvstoreDescribeInstancesRequestType& req,
                      RkvstoreDescribeInstancesResponseType* response,
