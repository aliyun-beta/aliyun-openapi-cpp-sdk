...
void Json2Type(const Json::Value& value, ModifyInstanceCapacityResponseType* item);
...
int Rkvstore::ModifyInstanceCapacity(const ModifyInstanceCapacityRequestType& req,
                      ModifyInstanceCapacityResponseType* response,
