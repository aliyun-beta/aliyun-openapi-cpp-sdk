...
void Json2Type(const Json::Value& value, RkvstoreDescribeHistoryMonitorValuesResponseType* item);
...
int Rkvstore::DescribeHistoryMonitorValues(const RkvstoreDescribeHistoryMonitorValuesRequestType& req,
                      RkvstoreDescribeHistoryMonitorValuesResponseType* response,
