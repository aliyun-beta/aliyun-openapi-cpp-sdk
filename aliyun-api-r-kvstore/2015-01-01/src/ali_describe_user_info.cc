...
void Json2Type(const Json::Value& value, DescribeUserInfoAlreadyHasResourceNumType* item);
void Json2Type(const Json::Value& value, DescribeUserInfoResponseType* item);
...
int Rkvstore::DescribeUserInfo(const DescribeUserInfoRequestType& req,
                      DescribeUserInfoResponseType* response,
