...
void Json2Type(const Json::Value& value, DescribeMonitorValuesKVStoreMonitorKeyType* item);
void Json2Type(const Json::Value& value, DescribeMonitorValuesKVStoreInstanceMonitorType* item);
...
void Json2Type(const Json::Value& value, DescribeMonitorValuesKVStoreInstanceMonitorType* item) {
  ...
  if(value.isMember("MonitorKeys") && value["MonitorKeys"].isMember("KVStoreMonitorKey")) {
    Json2Array<DescribeMonitorValuesKVStoreMonitorKeyType>(value["MonitorKeys"]["KVStoreMonitorKey"], &item->monitor_keys);
  }
}
void Json2Type(const Json::Value& value, DescribeMonitorValuesResponseType* item) {
  ...
  if(value.isMember("InstanceIds") && value["InstanceIds"].isMember("KVStoreInstanceMonitor")) {
    Json2Array<DescribeMonitorValuesKVStoreInstanceMonitorType>(value["InstanceIds"]["KVStoreInstanceMonitor"], &item->instance_ids);
  }
}
}

int Rkvstore::DescribeMonitorValues(const DescribeMonitorValuesRequestType& req,
