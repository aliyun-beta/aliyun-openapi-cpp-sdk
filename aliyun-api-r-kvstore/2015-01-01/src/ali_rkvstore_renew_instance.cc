...
void Json2Type(const Json::Value& value, RkvstoreRenewInstanceResponseType* item);
...
int Rkvstore::RenewInstance(const RkvstoreRenewInstanceRequestType& req,
                      RkvstoreRenewInstanceResponseType* response,
