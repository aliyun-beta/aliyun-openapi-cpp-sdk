...
void Json2Type(const Json::Value& value, TransformToPrePaidResponseType* item);
...
int Rkvstore::TransformToPrePaid(const TransformToPrePaidRequestType& req,
                      TransformToPrePaidResponseType* response,
