...
void Json2Type(const Json::Value& value, OtsListInstanceInstanceInfoType* item);
void Json2Type(const Json::Value& value, OtsListInstanceResponseType* item);
...
void Json2Type(const Json::Value& value, OtsListInstanceResponseType* item) {
  if(value.isMember("InstanceInfos") && value["InstanceInfos"].isMember("InstanceInfo")) {
    Json2Array<OtsListInstanceInstanceInfoType>(value["InstanceInfos"]["InstanceInfo"], &item->instance_infos);
  }
}
}
