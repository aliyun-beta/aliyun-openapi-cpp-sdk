...
void Json2Type(const Json::Value& value, OtsShihuaInsertInstanceResponseType* item);
...
int OtsShihua::InsertInstance(const OtsShihuaInsertInstanceRequestType& req,
                      OtsShihuaInsertInstanceResponseType* response,
